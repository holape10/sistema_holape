 ...
 <table style=" border-bottom: 0px;">
      ...
      @foreach($detalle as $det)
        <tr>
         ...
         <td class="cantidad"><center>{{$det->ped_det_can}}</center></td>
         <td class="cantidad"><center>{{$det->ped_det_pre}}</center></td>
         <td class="precio"><center>{{number_format($det->ped_det_can*$det->ped_det_pre,'2',',','')}}</center></td>
       ...
       @endforeach
        <tr id="table">
          ...
          <td class="precio" id="table" style="text-align:right;"><center>{{$cab_pedido->ped_tot}}</center></td>
        </tr>
     </tbody>
  </table>
