	...
	<body style="font-family:sans-serif">
		...
		<div class="cabecera">
			...
			<div class="panel-logo">
					<br><STRONG><font style="font-family:sans-serif;font-size:12;">SERVICIOS GENERALES </font> <font style="font-family:sans-serif;font-size:12;"> "MANUELA" </font></STRONG><br>
				<p style="font-family:sans-serif;font-size:8;font-style: oblique;">De: MANUELA SUNCION DE RUIZ</p>
				<p style="font-family:sans-serif;font-size:8;font-style: oblique;">VENTA DE ABARROTES EN GENERAL, PASAMANERIA, UTILES DE OFICINA, MATERIALES PARA PESCA, ACCESORIOS PARA TODA OCASION Y SERVICIOS EN GENERAL<br>Calle Tacna S/N<br>Loreto - Putumayo - Putumayo</p>
							 	...
							 	<table style="width:100%">
							 		...
							 		<tbody>
							 		 ...
							 		 <!--  <td></td>-->
							 		   ...
							 		   <td valign="top" style="width:25%;"><font size="2" style="font-family:sans-serif;"> {{$cabpdf->direccionpartida}} {{$cabpdf->ubipartida}}
							 		   <td valign="top" style="width:75%;"><font size="2" style="font-family:sans-serif;"> {{$cabpdf->direccionllegada}} {{$cabpdf->ubillegada}}</font></td>
							...
							<table class="table-detalle" style="width:100%">
										<thead >
											...
											<th style="width:43%;font-size:8;font-family:sans-serif;"><center><font size='1' color="white">DESCRIPCIÓN</font></center></th>
												<th style="border-color:black;"><center><font color="white" size='1'>U.D.M</font></center></th>
			...
			<div class="totales">
				<div class="div-observacion" >			
						<div class="letras">
							...
							<font style="font-size:9"><strong>DNI del Conductor:</strong> {{$cabpdf->rucconductor}}</font><BR></BR><BR>
						</div>
					</div>
