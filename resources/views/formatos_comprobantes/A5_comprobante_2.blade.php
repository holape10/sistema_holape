	...
	<body style="font-family:sans-serif">
		...
		<div class="cabecera">
			...
			<p style="font-family:sans-serif;font-size:6;font-style: oblique;">VENTA DE PARLANTES, USB, CARGADORES, COCINAS, PLATOS, PARAGUAS, PATINES, BICICLETAS, CORREAS, ARTICULOS DIVERSOS Y FERRETERIA EN GENERAL AL POR MAYOR Y MENOR.</p>
				<p style="font-family:sans-serif;font-size:6;font-style: oblique;">CALLE JOSE OLAYA 389<br>948132987 - 910789349<br>Iquitos - Maynas - Loreto</p>
							 	...
							 	<table style="width:100%">
							 		<thead>
							 			<tr style="font-size:10;" >
							 				<th style="font-family:sans-serif;font-size: 8pt;">Vendedor</th>
							 				<th style="font-family:sans-serif;font-size: 8pt;">Doc. Ref.</th>
							 				<th style="font-family:sans-serif;font-size: 8pt;">Fec. Emisión</th>
							 				<th style="font-family:sans-serif;font-size: 8pt;">Fec. Venc.</th>
							 				<th style="font-family:sans-serif;font-size: 8pt;">Condición Pago</th>
							 				<th style="font-family:sans-serif;font-size: 8pt;">Número Guía</th>
							 			</tr>
							 		</thead>

							 		<tbody>
							 			<tr style="text-align:center;">
							 			<td style="font-family:sans-serif;font-size: 8pt;" valign="top" style="width:25%;"><font  style="font-family:sans-serif;"> {{$cabpdf->vendedor}}</font></td>
							 		    <td style="font-family:sans-serif;font-size: 8pt;"><font  style="font-family:sans-serif;"> @if(!empty($doc_ref)) {{$doc_ref->serdoc}}-{{$doc_ref->numdoc}} @endif</font></td>
							 		   ...
							 		   <td style="font-family:sans-serif;font-size: 8pt;" valign="top" style="width:25%;"><font  style="font-family:sans-serif;"> @if(!empty($cabpdf->ccafve)) {{date('d-m-Y',strtotime($cabpdf->ccafve))}} @endif</font></td>
							 		   ...
							 		   @endif
							 		   <td style="font-family:sans-serif;font-size: 8pt;">{{$cabpdf->guia_remision}}</td>
			...
			<div class="totales">
				<div class="div-observacion">
								...
								<div class="letras">
									<font style="font-size:7pt;">SON: {{$totalletras}} {{$cabpdf->monnom}}</font><br>
								</div>
								@endif
					...
					<div class="div-aceptacion">
								...
								<!--<div class="letras">
									...
									<center><font style="font-size:9">Iquitos,____de_________________del 202___</font></center><br>
					...
					<div class="div-totales">
								...
								<table  class="table-total" style="width:90%;">
									...
									<tr>	
										...
										<td style="font-size:8;text-align:right;width:10%;">@if($cabpdf->moncod=='USD') $ @else S/ @endif</td>
										<td class="width-table" style="font-size:8;text-align: right;">{{number_format($cabpdf->ccaigv,'2','.',',')}}</td>
									</tr>
									<!--<tr>	
