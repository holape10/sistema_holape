...
<html lang="es">
	...
	<body style="width:100%;">
		...
		<div class="cabecera">
			...
			<div class="logo">
				<img src="{{$sucursal->logosuc}}"  style="padding-left:0px;" width="180px" height="150px"><br>
			</div>
			...
			<div class="panel-logo">
				...
				<!--<br><font style="font-family:Helvética;font-size:7;">De: {{$empresa->NomEmpresa}}</font><br>-->
				...
				<p style="font-family:Helvética;font-size:9;">
				CÓDIGO DE ESTABLECIMIENTO SUNAT: {{$sucursal->codigofiscal}}<BR> 
				</p>
