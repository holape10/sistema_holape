  ...
  <div class="ticket">
    ...
    <div style="border: 2px 2px 2px 2px solid  black;border-style: solid;">
        <div style="margin-top:10px;margin-bottom:10px;">
          <font  style="font-size:12pt;font-weight:bold;"><center>  @if($cabecera->tdocod!='13') R.U.C: {{$empresa->IdEmpresa}}<BR>@endif{{ $tdodes_display ?? 'DOCUMENTO' }}<br>{{$cabecera->serdoc}}-{{$cabecera->numdoc}}</center></font>
        </div>
     ...
     <table id="table">
      ...
      <tr id="table">
        ...
        <td colspan="3" id="table"><font style="font-size:12pt;"> {{$cabecera->ccanom}}</font></td>
      </tr>
      <tr id="table">
        <td id="table"><font style="font-size:12pt;font-weight:bold;">RUC:</font></td>

        <td id="table"><font style="font-size:12pt;">{{$cabecera->ccandi}}</font></td>
      </tr>

      <tr id="table">
        <td id="table"><font style="font-size:12pt;font-weight:bold;">Dirección:</font></td>
        <td colspan="3" id="table"><font style="font-size:12pt;"> {{$cabecera->direccion}}</font></td>
      </tr>
      <tr id="table">
...
<p class="centrado" style="margin-top:20px;font-size:12pt;font-weight:bold;">  @if($cabecera->tdocod!='13') Representaci&oacute;n Impresa de la {{ $tdodes_display ?? 'DOCUMENTO' }} @endif
  <center>  @if($cabecera->tdocod!='13')<!--<img src="{{ asset($imgqr) }}" width="80px" height="80px">--> <br>@endif 
   <p class="centrado" style="margin-top:20px;font-size:8pt;">@if($sucursal->serv_selv=='1')"BIENES  Y/O SERVICIOS TRANSFERIDOS EN LA AMAZONIA PARA SER CONSUMIDOS EN LA MISMA" @endif
  </div>
