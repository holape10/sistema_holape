...
<html lang="es">
	...
	<body style="width:100%;">
		...
		<div class="cabecera">
			...
			<div class="logo">
				<img src="{{$sucursal->logosuc}}"  style="padding-left:0px;" width="490px" height="120px"><br>
			</div>
			...
			<div class="panel-cliente">
				<table style="width:100%;">
					<tr style="font-family:Helvética;font-size:8;">
						<td style="width:10%;">F. EMISION</td>
						<td style="width:60%;">: {{$cabpdf->ccafem}}</td>
						<td style="width:10%;">F. VENC.</td>
					...
					<tr style="font-family:Helvética;font-size:8;">
						...
						<td style="width:60%;">: {{$cabpdf->placa}}</td>
						<td style="width:10%;">MONTO A PAGAR</td>
						...
						<td style="width:10%;">G. REMISION</td>
