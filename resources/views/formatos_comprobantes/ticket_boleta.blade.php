...
<?php       $fecha=now();
  ...
  <div style="margin-top:-45px" class="ticket">
      <br><p class="centrado"><font size="3"><strong>{{$empresa->NomEmpresa}}</strong></font><br><font size="2"><strong>{{$sucursal->direccion}}</strong></font><font size="2"><BR>R.U.C: {{$empresa->IdEmpresa}}<BR>Boleta de Venta Electrónica<br>{{$cabecera->serdoc}}-{{$cabecera->numdoc}}<br></p>
  ...
  <p><font size="2">{{$totalletras}}</p></font><br> 
      <p class="centrado" style="margin-top:20px;">Representaci&oacute;n Impresa de la BOLETA ELECTR&Oacute;NICA<br>
  </p><br>
