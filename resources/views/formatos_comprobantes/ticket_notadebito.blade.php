...
<body>
  <div class="ticket">
	...
	<table style=" border-bottom: 0px;">
      ...
      <p class="centrado" style="margin-top:160px;">Representación Impresa de la NOTA DE DÉBITO ELECTRÓNICA<br>
