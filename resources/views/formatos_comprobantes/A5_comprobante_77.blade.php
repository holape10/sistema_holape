...
<html lang="es">
	...
	<body style="width:100%;">
		...
		<div class="cabecera">
			...
			<div class="logo">
				<img src="{{$sucursal->logosuc}}"  style="padding-left:0px;" width="160px" height="100px"><br>
			</div>
										...
										<tbody>
											...
											<tr>
												<td style="border-color:black;width:10%" ><center><font size='1'>{{$det->cdecan}}</font></center></td>
													...
													<td style="border-color:black;width:10%" ><center><font size='1'>{{$det->procod}}</font></center></td>
