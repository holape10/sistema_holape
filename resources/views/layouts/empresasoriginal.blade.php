...
<head>
  ...
  <link rel="apple-touch-icon" href="{{ asset('img/icono_hp.ico') }}">
  <link rel="apple-touch-startup-image" href="{{ asset('images/splash_screens/splash-screen.png') }}" media="(device-width: 375px) and (device-height: 812px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)">-->
