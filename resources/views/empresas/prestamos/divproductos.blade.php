    ...
    @foreach($productos as $producto)
      <?php $i=$i+1; ?>
          ...
          <tr>
             ...
             <td style="background-color:green;" ><font color="white" size='2'><strong>P. PUBLICO   {{$producto->precio}}</strong></font></td>
            ...
            @if($producto->precio2 > 0)
               ...
               <td style="background-color:orange;"><font color="white" size='2'
                ><strong>P. MAYOR  {{$producto->precio}}</strong></font></td>
               <td>{{$producto->stock}}</td>
          ...
          <input type="hidden" name="pro<?php echo $producto->IdProducto;?>unidad" id='pro<?php echo $producto->IdProducto;?>unidad' value='{{$producto->umecod}}'>
            ...
            @if($producto->precio3 > 0)
               <td><BUTTON id='pro<?php echo $producto->IdProducto; ?>' onclick="ingresar_cantidad_precio_presentacion(this)" value='{{$producto->precio2}}'     class="btn btnpresentaciones btn-block btn-success">AGREGAR</BUTTON></td>
               <td>{{$producto->pronom}}</td>
                 <td>{{$producto->factor}}</td>
               <td style="background-color:red;"><font color="white" size="2"><strong>P. ESPECIAL  {{$producto->precio}}</strong></font></td>
               <td>{{$producto->stock}}</td>
