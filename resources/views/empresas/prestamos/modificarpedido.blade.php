  ...
  <div class="box">
   <div class="box-header with-border">
    ...
    {{Form::token()}}
      ...
      <td >
        <input type='number' step="any" min='0' class='form-control input-sm' name='propun[]' onChange='Calcular(this);'  value='{{$pedido->propunitem}}' onkeyup='Calcular(this);' style='width:70px' >
      </td>
      <td hidden="hidden">
