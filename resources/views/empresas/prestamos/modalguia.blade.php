                        ...
                        <div class="row">
                           <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                              <div class="form-group form-group-sm">
                                  ...
                                  <input type="text" readonly="readonly"  name="ubigeopartida" id="ubigeopartida"  class="form-control">
                               
                              </div>
                          </div>
                          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                              <div class="form-group form-group-sm">
                                  <label for="desubigeopartida">Descripción Ubigeo</label>
                                  <input type="text"  name="desubigeopartida" id="desubigeopartida"   placeholder="Departamento - Provincia - Distrito" class="form-control">
                        ...
                        <div class="row">
                          <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                              <div class="form-group form-group-sm">
                                  ...
                                  <input type="text" readonly="readonly"  name="ubigeollegada" id="ubigeollegada"   class="form-control">
                                
                              </div>
                          </div>
                          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                              <div class="form-group form-group-sm">
                                  <label for="desubigeollegada">Descripcion Ubigeo</label>
                                  <input type="text"  name="desubigeollegada" id="desubigeollegada"   placeholder="Departamento - Provincia - Distrito" class="form-control">
