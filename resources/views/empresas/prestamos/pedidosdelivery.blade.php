...
<script>
   ...
   function refrescar(){
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        ...
        <form class="form-horizontal" autocomplete="off"  method="POST" action="/programarenvio">
        {{ csrf_field() }}
	    	<div class="row">
	        	<div class="col-xs-12">
	          		<div class="box">
											...
											<div class="form-group form-group-sm">
												<select class="form-control" name="repartidor">
													@foreach($repartidores as $repartidor)
														<option value="{{$repartidor->IdUsuario}}">{{$repartidor->name}} {{$repartidor->apeusu}}</option>
													@endforeach
