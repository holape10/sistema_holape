  ...
  <div class="row">
    <div class="col-lg-12">
       ...
       <div class="box-header with-border" style="background:gray">
        <font size="2" color="white"><strong><center>EDITAR ORDEN PEDIDO</center></strong></font>
      </div>
       <div class="box-body">
    <div class="row">
       <div class="col-lg-2">
    ...
    <div class="box-body">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
       ...
       <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="form-group form-group-sm">
          ...
          <input name="telefono" id="telefono" value="{{$cotizacion->clitel}}" class="form-control">
      ...
      <div class="box">
        ...
        <span id="btnRegComp" type="button" class="btn btn-success btn-sm">ACTUALIZAR</span>
        ...
        <div class="box-body">
          ...
          <div class="col-lg-6">
           <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" name="buscarproducto" id="buscarproducto" placeholder="buscarproducto">
            ...
            <option  data-precio="{{$prod->propun}}" data-producto="{{$prod->IdProducto}}" data-unidad="{{$prod->umenom}}" data-detalle="{{$prod->pronom}}" value="{{$prod->IdProducto}}">{{$prod->pronom}}</option>
            @endforeach
          </select>
        </div>
        <div class="col-lg-3">
  ...
  <div class="box-body">
    <div class="row">
      ...
      <tr>
      	...
      	<td width='60'>
      		<input type='text' class='form-control input-sm' name='totalitem[]'  value='{{$detalle->cdepve}}' readonly='readonly' style='width:130px' >
      	</td>
      	<td width='60'>
      		<input  type='number' step='any' class='form-control input-sm' name='descuento[]' onkeyup='Calcular(this);'  value='{{$detalle->por_des}}'  style='width:130px' >
      	</td>
      	<td>
