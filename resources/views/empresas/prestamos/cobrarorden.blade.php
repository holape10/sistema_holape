...
<div class="container-fluid">
   ...
   {!!Form::open(array('url'=>'/registrarpagoorden','autocomplete'=>'off','method'=>'POST','name'=>'formfact','id'=>'formfact','role'=>'form','files'=>'true'))!!}
            {{Form::token()}}
      ...
      <div class="col-lg-5">
      	<div class="row">
                ...
                <tr>
                  ...
                  <td> 
                    <input type='text' value='1' name='cant[]' readonly="readonly" onkeyup='Calcular(this);' onChange='Calcular(this);' value="{{$det->cdecan}}" class='form-control input-sm ' id='font-size' style='width:60px'> 
                  </td>
                  <td hidden='hidden'>
                  ...
                  <td hidden='hidden'>
                    <input type='text' class='form-control' name='provun[]'  readonly="readonly" value='{{$det->provun}}' readonly='readonly' style='width:130px' >
                  </td>
                  <td>
                    <input type='text' class='form-control' name='propun[]' readonly="readonly"  value='{{$det->propun}}'  style='width:130px' >
                  </td>
                  <td>
