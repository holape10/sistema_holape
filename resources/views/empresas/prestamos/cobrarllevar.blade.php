  ...
  $("#btnRegComp").on("click", function() {
        ...
        if ($('#grdet >tbody >tr').length == 0){
          ...
          $.ajax({
            ...
            window.location.href = "/listallevar/"+respuesta.id_ped+"/cobrar";
...
<div class="container-fluid">
 ...
 <div class="row">
  ...
  <div class="box">
   ...
   <h2 class="box-title">Pedido Llevar</h2><BR>

    <div class="box-body">
    {!!Form::open(array('url'=>'/regcobrollevar','autocomplete'=>'off','method'=>'POST','name'=>'formfact','id'=>'formfact','role'=>'form','files'=>'true'))!!}
    {{Form::token()}}
        <input type="hidden" name="opcion" id="opcion" value="0">
        
      <input type="hidden" readonly="readonly" value="{{$pedido_id}}" name="pedido" id="pedido">
      <div class="row">
           ...
           <input type="date" name="fecVen" value="{{Carbon::now()->format('Y-m-d')}}" style="display:none;" class="form-control">
            ...
            <div class="col-lg-3 col-md-2 col-sm-12 col-xs-12">
                <div class="form-group form-group-sm">
                    <label for="clinum">N° Doc</label><img style="display:none;" width="50px" height="50px" src="/img/load.gif" name="imgloadcli" id="imgloadcli">
                    <input type="text" required="required" onKeypress="if(event.keyCode == 13) buscarcliente();"  name="clinum" id="clinum" value="{{old('clinum')}}"  placeholder="" class="form-control" >
            ...
            <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                <div class="form-group form-group-sm">
                    ...
                    <input type="text" name="clinom" id="clinom" required="required" value="@if(empty($pedido->cliente)) Varios @else {{$pedido->cliente}} @endif" class="form-control">
      ...
      <td>
        <input type='number' step="any" min='0' value='{{$pedido->cantidad}}' name='cant[]' onkeyup="Calcular(this);"  class='form-control input-sm keyboard' id='font-size' style='width:60px'>
      </td>
      <td hidden="hidden">
      ...
      <td>
        <input type='number' step="any" min='0' class='form-control input-sm' name='propun[]' onkeyup="Calcular(this);"   value='{{$pedido->propunitem}}'  style='width:130px' >
      </td>
      <td>
     ...
     <BR> <table class="table ">
      ...
      <tr >
       ...
       <tr>
        ...
        <td colspan="2"><a href="/imprimircuentaweb/{{$pedido_id}}" target="_blank"><button type="button"  class=" btn btn-block btn-default btn-lg botones">PRE CUENTA</button></a></td>
     </tr>
