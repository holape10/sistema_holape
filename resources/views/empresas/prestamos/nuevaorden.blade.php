         	...
         	<div class="col-lg-12">
    			...
    			<div class="box-body">
    				<div class="col-lg-6">
    					<div class="form-group-sm">
	    					<label>IMEI</label>
	    					<input type="text" class="form-control input-sm" name="imei">
	    				</div>	
    				</div>
    				<div class="col-lg-6">
    					<div class="form-group-sm">
    				...
    				<div class="col-lg-6">
    					<div class="form-group-sm">
	    					<label>MODELO</label>
	    					<input type="text" class="form-control input-sm" name="modelo">
	    				</div>	
    				</div>
    				<div class="col-lg-6">
    					<div class="form-group-sm">
    				...
    				<div class="col-lg-12">
    					<div class="form-group-sm">
    						...
    						<input type="text" class="form-control input-sm" name="patron" placeholder="Patron ó contraseña">
    					</div>
    				</div>
    				<div class="col-xs-12">
    					<div class="form-group-sm">
    						<label>Especifique la falla de equipo</label>
    						<textarea class="form-control" rows="6" maxlength="1000" name="fallas" placeholder="Describa fallas del equipo"></textarea>
    					</div>
    				</div>
    				<div class="col-xs-12">
    					<div class="form-group-sm">
    						<label>Observaciones</label>
    						<textarea class="form-control" rows="6" maxlength="1000" name="observaciones" placeholder="Detalle de Reparación"></textarea>
    					</div>
    				</div>
