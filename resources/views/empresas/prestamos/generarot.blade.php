  ...
  <div class="row">
    <div class="col-lg-12">
       ...
       <div class="box-header with-border" style="background:gray">
        <font size="2" color="white"><strong><center>GENERAR ORDEN TRABAJO</center></strong></font>
      </div>
      <div class="box-body">
    <div class="row">
      <div class="col-lg-2">
    ...
    <div class="box-body">
      ...
      <div class="box">
        ...
        <span id="btnRegComp" type="button" class="btn btn-success btn-sm">GENERAR OT</span>
