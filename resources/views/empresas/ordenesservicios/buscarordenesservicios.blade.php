...
{!! Form::model(Request::all(),['Route'=>'/ordenesservicios','method'=>'GET','autocomplete'=>'off'])!!}
...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="btn-group" >
			<a href="/ordeneservicio/crear"><button type="button"  class=" btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Nueva O.S</button></a>
		</div>
