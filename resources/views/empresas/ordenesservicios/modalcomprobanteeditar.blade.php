				...
				<div class="modal-body">
					<div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                <label>Serie</label>                                 
                                <input name="serdoc"  id="serdoc" value="{{$cabecera->com_doc_ser}}" class="form-control" >  
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                <label>N Doc.</label>
                              	<input type="number"  id="numdoc" name="numdoc" value="{{$cabecera->com_doc_num}}"  class="form-control" >
                            </div>
                        </div>
