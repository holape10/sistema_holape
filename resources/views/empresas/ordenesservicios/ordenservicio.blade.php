...
function Calcular(ele) {
  ...
  $(tr).each(function() {
      var total=0;
        ...
        total = $(this).find("td:eq(0) > input").val() * $(this).find("td:eq(2) > input").val();
 

        $(this).find("td:eq(3) > input").val(total.toFixed(2));
...
function CalcularItem(ele) {
  ...
  $(tr).each(function() {
    ...
    totitemgrav = $(this).find("td:eq(3) > input").val() / $(this).find("td:eq(0) > input").val();

    $(this).find("td:eq(2) > input").val(totitemgrav.toFixed(2));
...
function calculartotal(){
   ...
   var $svalor=0;
    ...
    $("#detFact tbody tr").each(function(){
        ...
        totgrav = totgrav + parseFloat($(this).find("td:eq(3)  > input").val());
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group form-group-sm">
                    ...
                    REGISTRANDO ORDEN DE SERVICIO.....</center>
                </div>
            </div>
          </div>
             ...
             <div class="col-lg-12">
                 <div class="box box-info">
                    <div class="box-header" style="background-color:blue;">
                        <font color="white" ><center><strong>REGISTRAR ORDEN DE SERVICIO</strong></center></font>
                         <div class="box-tools pull-right">
                            <div class="btn-group" >
                              <button type="button" id="btnRegistrar" name="btnRegistrar"  class="btn btn-success btn-sm"><strong>REGISTRAR</strong></button>
                            </div>
                            <div class="btn-group" >
                                <a href="/ordenesservicios"><button type="button" class="btn btn-danger btn-sm"><strong>CANCELAR</strong></button></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div  class="panel-body">
                       ...
                       <div hidden="" class="col-lg-2">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                         ...
                         <div  class="col-lg-2 col-md-2 col-sm-12 col-xs-12" >
                            <div class="form-group form-group-sm">
                              <label>SERIE ORDEN</label>
                              <input type="text" name="serdoc"  class="form-control"> 
                            </div>
                        </div>
                         <div  class="col-lg-2 col-md-2 col-sm-12 col-xs-12" >
                            <div class="form-group form-group-sm">
