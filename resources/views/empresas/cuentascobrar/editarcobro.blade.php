...
<script type="text/javascript">
   ...
   {!!Form::open(array('url'=>'/cuentascobrar/registrar','autocomplete'=>'off','method'=>'POST','name'=>'formfact','id'=>'formfact','role'=>'form','files'=>'true'))!!}
	...
	<section class="content">
      	...
      	<input type="hidden" name="cue_cob_det_id" value="{{$cuentas->cue_cob_det_id}}">

        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                	<div class="box-header" style="background:blue;">
                		<font size="3" color="white"><center><strong>CUENTAS POR COBRAR - EDITAR COBRANZA</strong></center></font>
                	</div>
                    <div class="box-body">
        ...
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
         ...
         <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            <div class="form-group form-group-sm">
                ...
                <input type="text" readonly="readonly" name="clinum"  value="{{$cabecera->ccandi}}" class="form-control">
           </div>
        </div>
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="form-group form-group-sm">
                <label for="">RAZON SOCIAL</label>
                <input type="text" name="clinom" readonly="readonly"  value="{{$cabecera->ccanom}}" class="form-control">
           </div>
        </div>
          ...
          <div hidden="hidden" class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="form-group form-group-sm">
                ...
                <input type="text" name="clidir"   value="{{$cabecera->direccion}}" class="form-control">
           </div>
        </div>
    ...
    <div class="row">
         ...
         <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            <div class="form-group form-group-sm">
                ...
                <input type="text"   name="numero_recibo" value="{{$cuentas->numero_recibo}}" class="form-control" >
                 ...
                 <LABEL>Vendedor</LABEL>
                    <select name="vendedor" id="vendedor" class="form-control">
                              ...
                              @foreach($vendedores as $ven)
                                ...
                                @if($ven->IdUsuario == $cuentas->vendedor)
