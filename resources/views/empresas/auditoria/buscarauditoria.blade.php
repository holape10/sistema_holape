...
{!! Form::open(['route'=>'Reportes.ReporteAuditoria'])!!}
...
<div class="row">
    ...
    <div class="col-lg-2">
		<div class="form-group form-group-sm">
			...
			{!! Form::select('docomp',['1'=>'REPORTE MODIFICACIONES','2'=>'REPORTE ELIMINADOS'],null,['class'=>'docomp form-control input-sm','id'=>'docomp']); !!}
