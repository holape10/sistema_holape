...
{!! Form::open(array('url'=>'/movimientoscaja','method'=>'POST','autocomplete'=>'off','role'=>'buscar'))!!}
...
<div class="row">
	...
	<div class="col-lg-12">
		...
		<div class="btn-group" >
				...
				<a href="/movimientoscaja/crear"><button type="button"  class=" btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Nuevo Movimiento Caja</button></a>
		</div>
