...
@section ('contenido')
    ...
    {!!Form::model($serie,['method'=>'PATCH','route'=>['series.update',$serie->IdSerie],'files'=>'true'])!!}
    {{Form::token()}}
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="form-group">
                <label for="tdocod">Tipo Documento</label>
                <select class="form-control" disabled="disabled" name="tdocod" id="tdocod">
                    @foreach($tipo_doc as $doc)
                      	@if($doc->tdocod==$serie->tdocod)
                        	<option value="{{$doc->tdocod}}" selected >{{$doc->tdodes}}</option>
                        @else
    	...
    	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
    		<div class="form-group">
		        ...
		        <input type="text" name="serie" readonly="readonly" min="0" value="{{$serie->Numero_Serie}}" class="form-control" placeholder="Número de Serie...">
                  @if ($errors->has('serie'))
    ...
    <div class="row">
    	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
    		<div class="form-group">
		        ...
		        <input type="number" name="numcor" min="1" value="{{$serie->Num_Correlativo}}" class="form-control" placeholder="Número Correlativo..">
