...
function Calcular(ele) {
  ...
  $(tr).each(function() {
      var total=0;
        ...
        total = $(this).find("td:eq(2) > input").val() * $(this).find("td:eq(5) > input").val();
 

        $(this).find("td:eq(6) > input").val(total.toFixed(2));
...
function CalcularItem(ele) {
  ...
  $(tr).each(function() {
    ...
    totitemgrav = $(this).find("td:eq(6) > input").val() / $(this).find("td:eq(2) > input").val();
                    ...
                    <div class="box-header" style="background-color:blue;">
                        <font color="white" ><center><strong>GENERAR COMPRA</strong></center></font>
                         <div class="box-tools pull-right">
                            <div class="btn-group" >
                              <button type="button" id="btnRegistrar" name="btnRegistrar"  class="btn btn-success btn-sm"><strong>ACTUALIZAR</strong></button>
                            </div>
                            <div class="btn-group" >
                    ...
                    <div  class="panel-body">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                              ...
                              <input type="text"  id="orden_compra" name="orden_compra" readonly="readonly" value="{{$cabecera->com_doc_ser}}-{{$cabecera->com_doc_num}}" class="form-control" >      
                            </div>
                        </div>
                      ...
                      <div class="row">
                         <table id="detFact" class="table">
                            <thead>
                                ...
                                <th >Lote</th>
                                <th >Vencimiento</th>
                                <th hidden="hidden">Laboratorio</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <input  type='number' step='any' min='0' class='form-control input-sm' name='preuni[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='{{$det->pre_uni}}' style='width:80px'>
                                </td>
                                <td>
                                  <input type='text' class='form-control input-sm' name='vtot[]'  value='{{$det->total}}' onkeyup='CalcularItem(this);' style='width:80px'>
                                </td>
                                <td hidden='hidden'>
                                ...
                                <td hidden="hidden"><select class='form-control input-sm' name='laboratorio[]'>
                                  <option></option>
