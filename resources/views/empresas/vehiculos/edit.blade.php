...
<div class="container-fluid mt-4">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white border-0 mt-2">
            <h4 class="text-dark">Editar Vehículo: {{ $vehiculo->placa }}</h4>
        </div>
        <div class="card-body">
            <form action="{{ route('vehiculos.update', $vehiculo->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="number" step="0.01" name="capacidad_carga" class="form-control" value="{{ $vehiculo->capacidad_carga }}" required>
                    </div>
                </div>
                <div class="row mt-2">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="date" name="fecha_vencimiento_soat" class="form-control" value="{{ $vehiculo->fecha_vencimiento_soat }}" required>
                    </div>
                    <div class="col-md-4 form-group">
                        <label for="fecha_vencimiento_rt" class="font-weight-bold">Vencimiento Rev. Técnica</label>
                        <input type="date" name="fecha_vencimiento_rt" class="form-control" value="{{ $vehiculo->fecha_vencimiento_rt }}" required>
                    </div>
                </div>
                
                <div class="row mt-2">
                    <div class="col-md-4 form-group">
                        <label for="estado" class="font-weight-bold">Estado Operativo</label>
                ...
                <div class="row mt-3">
                    <div class="col-md-12 text-right">
                        ...
                        <button type="submit" class="btn btn-primary shadow-sm">Actualizar Vehículo</button>
                    </div>
                </div>
            </form>
        </div>
