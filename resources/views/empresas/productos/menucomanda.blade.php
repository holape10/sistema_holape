  ...
  <div class="row">
   ...
   <div class="col-lg-3 col-md-3 col-sm-2 col-xs-4">
        <button type="button" id='pro<?php echo $i; ?>' onclick="agregaritem(this)" value='{{$producto->propun}}' style="background:{{$producto->color}};width: 120px; height: 120px; border-radius:10px">
