    	...
    	<div class="box">
    		...
    		<div class="box-header" style="background-color:blue;">
          	...
          	<div class="box-body">
	       	...
	       	{!!Form::open(array('url'=>'actualizarinventario','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
    		{{Form::token()}}  
    		<input type="hidden" name="suc_id" value="{{$sucursal}}">
    		<input type="hidden" name="alm_id" value="{{$almacen}}">
    		<input type="hidden" name="inv_fec" value="{{$fecha}}">
    		<input type="hidden" name="inv_cab_id" value="{{$id}}">
    		@if($tipo=='1')
