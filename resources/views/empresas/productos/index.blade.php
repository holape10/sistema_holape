...
function abrirModalReceta(idProducto) {
    // Mostramos un loader mientras se trae la info del controlador
    $('#contenidoModalReceta').html('<div class="modal-body"><center><img src="/img/load.gif" width="80px" height="80px"><br><strong>Cargando receta...</strong></center></div>');
    $('#modalRecetaGlobal').modal('show');

    // Llamamos a tu ruta existente
    $.ajax({
        type: "GET",
        url: "/asignarreceta/" + idProducto,
        success: function(data) {
            // Metemos la vista recetas.blade.php dentro del modal
            $('#contenidoModalReceta').html(data);
        },
        error: function() {
            $('#contenidoModalReceta').html('<div class="modal-body"><div class="alert alert-danger">Error al cargar la receta. Intente nuevamente.</div></div>');
        }
    });
}
</script>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header" style="background-color:blue;">
                        <font color="white"><center><strong>CONSULTAR PRODUCTOS</strong></center></font>
                        <div class="box-tools pull-right">
                            <a href="{{ url('insumos') }}"><button class="btn btn-info btn-sm">Ver Insumos</button></a>
                            <a href="productos/create"><button class="btn btn-success btn-sm">Nuevo</button></a>
                            <a href="/exportar-productos-excel"><button class="btn btn-primary btn-sm">Exportar Excel</button></a>
                            <a href="/exportar-recetas-excel"><button class="btn btn-sm" style="background-color:#8e44ad; color:white;"><i class="fa fa-download"></i> Exportar Recetas</button></a>
                    ...
                    <div class="box-body">
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        @include('empresas.productos.search')
                    </div>
                    </div>
                </div>
            </div>
        ...
        <div class="box">
            ...
            <table class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tr>
                    ...
                    <td class="col-receta">
                        @if($pro->promocion =='2')
                            <a href="javascript:void(0);" onclick="abrirModalReceta('{{$pro->IdProducto}}')"><img src="/icon/receta.png" title="RECETA" height="30px" width="40px"></a>
                        @else
                            <img src="/icon/receta.png" title="RECETA" height="30px" width="40px" style="opacity:0.5">
                        @endif
                    </td>
...
<div class="modal fade" id="modalRecetaGlobal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document" style="width: 90%;">
        <div class="modal-content" id="contenidoModalReceta">
            </div>
    </div>
</div>
@endsection