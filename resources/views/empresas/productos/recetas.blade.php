...
<div class="modal-header" style="background-color:#0040FF;">
    ...
    <h4 class="modal-title" style="color:white;"><center><strong>REGISTRAR INSUMOS Y PRECIO - {{$producto->pronom}}</strong></center></h4>
</div>
...
<div class="modal-footer">
    ...
    <button class="btn btn-success" type="submit" id="btnRegComp" name="btnRegComp"><strong>Registrar Todo</strong></button>
</div>
{!!Form::close()!!}
...
<script>
    ...
    // Buscador rápido 
    $("#buscador_insumos").off("keyup").on("keyup", function() {
    ...
    // Ejecuta el cálculo al abrir el modal
    calcularCostos();
</script>