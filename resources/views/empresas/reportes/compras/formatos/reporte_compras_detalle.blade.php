						...
						<table id="dtHorizontalExample"  class="table table-responsive table-bordered table-sm">
							<thead>
								<tr>
									<th colspan="16" style="font-size:10pt;font-weight:bold;background:#E8E8E8;"><center><strong>REPORTE DE COMPRAS DESDE: {{$fec_ini}} HASTA {{$fec_fin}}</strong></center>
							...
							<tbody>
								...
								@endforeach
									<tr>
										...
										<th style="padding:5px 5px 5px 5px;text-align:right;font-weight:bold;vertical-align:middle;">{{number_format($total_compras,'2','.',',')}}</th>
									</tr>
							</tbody>
						</table><br>
