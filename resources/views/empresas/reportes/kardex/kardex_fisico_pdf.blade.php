<table id="dtHorizontalExample"  class="table table-responsive table-bordered table-sm" style="font-size:8pt;width:100%;">
								...
								<tr >
									<td  colspan="9" style="text-align:center;color:#fff;font-weight:bold;background:#337ab7;">REGISTRO DE INVENTARIO PERMANENTE VALORIZADO</td>
								</tr>
							...
							@foreach($productos->chunk(10) as $chunk)
								...
								<tr>
									<td  colspan="4" style="font-weight:bold;">PERIODO: </td>
									<td colspan="5">De {{Carbon::parse($fecin)->format('d-m-Y')}}  HASTA {{Carbon::parse($fecfin)->format('d-m-Y')}}</td>
								</tr>
								<tr>
									<td  colspan="4" style="font-weight:bold;">RUC: </td>
									<td colspan="5">{{$dat_suc->IdEmpresa}}</td>
								</tr>
								<tr>
									<td  colspan="4" style="font-weight:bold;">NOMBRE Y/O RAZON SOCIAL: </td>
									<td colspan="5">{{$dat_emp->NomEmpresa}}</td>
								</tr>
								<tr>
									<td  colspan="4" style="font-weight:bold;">ESTABLECIMIENTO: </td>
									<td colspan="5">@if(!empty($dat_alm)) {{$dat_alm->descripcion}} @else Todos @endif</td>
								</tr>
								<tr>
									<td colspan="4" style="font-weight:bold;">METODO DE VALUACION: </td>
									<td colspan="5"></td>
								</tr>
								<tr>
									<td colspan="4" style="font-weight:bold;"><strong>CODIGO </strong></td>
									<td colspan="5" style="text-align:left;" ><strong>{{$pro->procod}}</strong></td>
								</tr>
								<tr>
									<td colspan="4" style="font-weight:bold;"><strong>DESCRIPCION</strong></td>
									<td colspan="5" ><strong>{{$pro->pronom}}</strong></td>
								</tr>
								<tr>
									<td colspan="4" style="font-weight:bold;"><strong>U.M</strong></td>
									<td colspan="5" ><strong>{{$pro->umecod}}</strong></td>
								</tr>
								<tr >
								...
								<tr style="color:#fff;">
									...
									<td  style="background-color:#9B9B9B;color:#fff;font-weight:bold;text-align:center;" >ENTRADAS</td>
									<td style="background-color:#9B9B9B;color:#fff;font-weight:bold;text-align:center;" >SALIDAS</td>
									<td style="background-color:#9B9B9B;color:#fff;font-weight:bold;text-align:center;" >SALDOS</td>
										...
										@foreach($movimientos->chunk(10) as $chunk1)
											@foreach ($chunk1 as $mov)
												<tr>
													...
													<td style="text-align:center;width:20">{{$mov->cod_tip_ope}}</td>
													@if($mov->mov_tip =='E')
