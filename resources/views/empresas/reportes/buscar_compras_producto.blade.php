...
<div class="box-header box-success" style="background-color:blue;">
	<font color="white" size="3"><center><strong>REPORTE COMPRAS POR PRODUCTOS</strong></center></font>
</div>
<div class="box-body">
		...
		<div class="col-lg-2">
			<div class="form-group form-group-sm">
				...
				<select name="tip_rep" class="form-control">
					<option value="13">COMPRAS POR PRODUCTO</option>
					<option value="55">COMPRAS POR PRODUCTO - FECHA VENCIMIENTO</option>
	...
	<div class="row">
		<div class="col-lg-6">
			...
			<div class="btn-group">
				...
				<button type="button" id="btnGenPdf" dir="/generarreportepdf" class="btn btn-primary btn-sm">GENERAR REPORTE</button>		</div>
