        			...
        			<font color="white" size="3"><center><strong>REPORTE COMPRAS PROVEEDOR</strong></center></font>
        		</div>
	           	<div class="box-body">
  ...
  <div class="col-lg-2">
	...
	<div class="col-lg-2">
		<div class="form-group form-group-sm">
			...
			<select name="prov_id" class="form-control selectpicker input-sm" data-show-subtext="true" data-live-search="true">
...
<div class="row">
	<div class="col-lg-6">
		...
		<div class="btn-group">
				...
				<button type="button" id="btnGenPdf" dir="/generarpdfcompras" class="btn btn-primary btn-sm">GENERAR REPORTE</button>
			</div>
