        		...
        		<div class="box-header box-success" style="background-color:blue;">
        			<font color="white" size="3"><center><strong>REPORTE DE GASTOS</strong></center></font>
        		</div>
	           	<div class="box-body">
    ...
    <div class="col-lg-2">
		<div class="form-group form-group-sm">
			...
			<select name="tip_rep" class="form-control">
				...
				<option value="2">GASTOS DETALLADO</option>
			</select>
		</div>
	</div>
...
<div class="row">
	<div class="col-lg-6">
		<div class="btn-group" >
				<button type="button" id="btnBuscarGastos"   class=" btn btn-primary btn-sm">BUSCAR</button>
	
		</div>
		<div class="btn-group">
			
		
				<button type="button" id="btnExportar" dir="/generarexcelgastos" class="btn btn-primary btn-sm">Exportar Excel</button>
		</div>
		<div class="btn-group">
			
		
				<button type="button" id="btnGenPdf" dir="/generarpdfgastos" class="btn btn-primary btn-sm">GENERAR REPORTE</button>		</div>
