								...
								@foreach($ventas as $cab)
										...
										@endphp
									 	<tr>
									 		...
									 		<td style="width:15;text-align:center;">{{$configuracion->provision}}</td>
											...
											<td style="width:15;text-align:center;">VENTAS {{$cab->des_doc}} {{$cab->serie}}-{{$cab->numero_inicial}}</td>
											<td style="width:15;text-align:right;">{{$cab->tipo_cambio}}</td>
											<td style="width:30;text-align:right;">V</td>
											<td style="width:70">S</td>
											<td style="width:20;text-align:center;">{{$cab->fecha_emision}}</td>
											@if($cab->tipo_doc=='07')
												<td style="width:30;text-align:right;">{{$configuracion->cod_h_prov_fac}}</td>
											@else
												<td style="width:30;text-align:right;">{{$configuracion->cod_d_prov_fac}}</td>
											@endif
											...
											<td style="width:30;text-align:right;"></td>
											<td style="width:30;text-align:left;">VENTAS {{$cab->des_doc}} {{$cab->serie}}-{{$cab->numero_inicial}}</td>
											<td style="width:30;text-align:right;"></td>
											<td style="width:30;text-align:right;"></td>
											<td style="width:30;text-align:right;">
										...
										@if($cab->tipo_doc=='03' || $cab->tipo_doc=='01' )
										<tr>
									 		<td style="width:15;text-align:center;"></td>
											...
											<td style="width:20;text-align:center;">{{$cab->fecha_emision}}</td>
											<td style="width:30;text-align:center;">@if($cab->moneda=='PEN') MN @else US @endif</td> 
											<td style="width:15;text-align:center;">COBRANZA CLIENTE</td>
											<td style="width:15;text-align:right;">{{$cab->tipo_cambio}}</td>
											<td style="width:30;text-align:right;">V</td>
											<td style="width:70">S</td>
											<td style="width:20;text-align:center;">{{$cab->fecha_emision}}</td>
											<td style="width:30;text-align:right;">104101</td>
											@if($cab->tipo_doc=='03')
												<td style="width:30;text-align:right;">011</td>
											@else
												<td style="width:30;text-align:right;">011</td>
											@endif
											...
											<td style="width:30;text-align:right;">{{$cab->fecha_vencimiento}}</td>
											<td style="width:30;text-align:right;"></td>
											<td style="width:30;text-align:left;">COBRANZA {{$cab->des_doc}} {{$cab->serie}}-{{$cab->numero_inicial}}</td>
											<td style="width:30;text-align:right;"></td>
											<td style="width:30;text-align:right;"></td>
											<td style="width:30;text-align:right;">
											@if($cab->tipo_cp_mod=='01')
										...
										<tr>
											...
											<td style="width:70">S</td>
											<td style="width:20;text-align:center;">{{$cab->fecha_emision}}</td>
											<td style="width:30;text-align:right;">121201</td>
