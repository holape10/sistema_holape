			...
			<table id="dtHorizontalExample"  class="table table-responsive  table-bordered table-sm" style="width:100%;font-size:8pt;">
							<thead>
								<tr>
									<th colspan="10"  style="background-color:#337ab7;color:#fff;text-align:center;"><strong>REPORTE DE VENTAS ANULADAS DETALLADO DESDE: {{$fec_ini}} HASTA {{$fec_fin}}</strong></th>
								</tr>
