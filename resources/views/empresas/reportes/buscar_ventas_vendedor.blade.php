        			...
        			<font color="white" size="3"><center><strong>REPORTE DE VENTAS POR VENDEDOR / MOZO</strong></center></font>
        		</div>
	           	<div class="box-body">

  {!!Form::open(array('url'=>'/generarreporteventasvendedor','autocomplete'=>'off','method'=>'POST','id'=>'frmReporte','role'=>'form','files'=>'true'))!!}
    {{Form::token()}}
<style>
...
<div class="row">
    ...
    <div class="col-lg-2">
		<div class="form-group form-group-sm">
			...
			<select name="tip_rep" class="form-control">
				...
				<option value="5">RESUMEN VENTAS</option>
			</select>
	...
	<div class="col-lg-2">
		<div class="form-group form-group-sm">
			...
			<select name="ven_id" class="form-control">
				<option value="">Todos</option>
