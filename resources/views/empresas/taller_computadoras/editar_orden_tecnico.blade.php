          ...
          $('#grdet').append("<tr>"+
           ...
           "<td hidden='hidden' ><input type='text' class='form-control' name='id_almacen_pro[]'  value='"+id_almacen_pro+"' readonly='readonly' ></td>"+
            "<td> <input type='number' step='any' min='0' value='0' name='cant_dev[]'  class='form-control input-sm ' id='font-size' style='width:60px'></td>"+
             "<td hidden='hidden'> <input type='number' step='any' min='0' value='0' name='cant_dev_alm[]'  class='form-control input-sm ' id='font-size' style='width:60px'></td>"+
      		...
      		<table class="table table-hover table-striped">
                ...
                @endforeach
      			  ...
      			  <tr>
      			 	...
      			 	<td> <textarea type="text" name="obs_diag"  class="form-control" rows="4">{{$cotizacion->obs_diag}}</textarea> </td>
      			 	
      			 </tr>
      			   <tr>
      			 	<td><strong>Observacion Actividad:</strong></td>
      			 	<td> <textarea type="text" name="obs_act"  class="form-control" rows="4">{{$cotizacion->obs_act}}</textarea> </td>
        ...
        <tbody>
            @foreach($lis_tip_equi as $lte)
              <tr>
                ...
                <td hidden="hidden"><button type='button' onClick='deleteRow(this);' class='btn btn-danger btn-sm remove'><span class='glyphicon glyphicon-minus'></span></button></td>
              </tr>
            @endforeach
         </tbody>
        </table>
...
<div class="box">
 <div class="box-header" style="background-color:blue;">
   <font color="white"><strong>AGREGAR REPUESTOS</strong></font>
  ...
  <div class="box-body">
    <div class="row">
        ...
        <tbody>
           ...
           <td> <input type='number' step='any' min='0' name='cant_dev[]' value="{{$repuesto->cant_dev}}" class='form-control input-sm ' id='font-size' style='width:60px'></td>
           <td hidden="hidden"> <input type='number' step='any' min='0' name='cant_dev_alm[]' value="{{$repuesto->cant_dev_alm}}" class='form-control input-sm ' id='font-size' style='width:60px'></td>
           <td><button type='button' onClick='deleteRow(this);' class='btn btn-danger btn-sm remove'><span class='glyphicon glyphicon-minus'></span></button></td></tr>
           @endforeach
         </tbody>
        </table>
...
<div class="box">
 <div class="box-header" style="background-color:blue;">
   <font color="white"><strong>AGREGAR SERVICIOS</strong></font>
  ...
  <div class="box-body">
    ...
    <div class="col-lg-12">
      <div class="form-group form-group-sm">
        ...
        <textarea type="text" name="obs_tec"  class="form-control" rows="4">{{$cotizacion->obs_tec}}</textarea> 
      </div>
    </div>
   ...
   <div class="row">
    <div class="col-lg-12">
      <div class="form-group form-group-sm">
        ...
        <textarea type="text" name="obs_cli"  class="form-control" rows="4">{{$cotizacion->obs_cli}}</textarea> 
      </div>
    </div>
...
<div class="row">
    ...
    <div class="row">
        ...
        @else
         	  <div class="col-lg-3">
              <button type="button" id="btnRegComp" class=" btn btn-block btn-primary btn-sm botones">ACTUALIZAR</button><br>
            </div>
              <div class="col-lg-3">
              <button type="button" id="btnRegFin" class=" btn btn-block btn-success btn-sm botones">FINALIZAR</button><br>
            </div>
             <div class="col-lg-3">
              <a href="/indexcotizaciones"><button type="button" class=" btn btn-block btn-danger btn-sm botones">SALIR</button></a><br>
            </div>
