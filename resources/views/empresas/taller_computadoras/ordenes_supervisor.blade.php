        ...
        data: formulario,
 	    ...
 	    if(respuesta.estado =='error'){
            ...
            $(".botones").show();
        	  ...
        	  window.location.href = "/ordenessuper";
        }
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="box">
				...
				<div class="box-header" style="background-color:blue;">
					<font color="white"><center><strong>RECEPCIONAR SUPERVISOR</strong></center></font>
				...
				<div hidden="hidden" class="box-body">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group form-group-sm">
								...
								<select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" name="coordinador" id="coordinador" >
									<option value=""></option>
									@foreach($coordinadores as $coor)
									<option  value="{{$coor->IdUsuario}}">{{$coor->name}} {{$coor->apeusu}}</option>
									@endforeach
								</select>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-2">
							<button type="button" class="btn btn-primary btn-sm" id="btnAsigCoor">Asignar</button>
						</div>
			...
			<div class="box">
				<div class="box-body table-responsive">
					<table id=""  class="table table-bordered table-hover" style="font-size:8pt;">
						<thead>
							<tr>
								<th colspan="14"><button type="button" class="btn btn-primary btn-sm" id="btnRecep">Recepcionar</button></th>
							</tr>
						</thead>
						<thead style="background-color:blue;color:white;">
							...
							<tr >
								...
								<th style="vertical-align:middle;text-align:center;" style="width:210px;">Nombre o Razón Social</th>
						...
						<tbody>
							...
							<tr>
								...
								<!--	<td style="vertical-align:middle;">
									...
									<span class=" btn-primary btn-sm btn-block" style="text-align:center;">{{$comp->estado}}</span>
									@elseif($comp->estado =='COBRADO')
									<span class=" btn-success btn-sm btn-block" style="text-align:center;">{{$comp->estado}}</span>
									@elseif($comp->estado =='ELIMINADO')
									<span class=" btn-danger btn-sm btn-block" style="text-align:center;">{{$comp->estado}}</span>
							...
							<td style="vertical-align:middle;"><a href="/editarot/{{$comp->IdCpe_cabecera}}"><button type="button" class="btn btn-sm btn-warning btn-block">Editar</button></a></td>-->
