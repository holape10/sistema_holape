...
<div class="row">
    ...
    <div class="row">
        ...
        @if(Auth::user()->hasRole('calidad') || Auth::user()->hasRole('administrador') || Auth::user()->hasRole('supervisor'))
         	<div class="col-lg-3">
              <button type="button" id="btnRegAcep" class=" btn btn-block btn-primary btn-sm botones">ACEPTAR</button><br>
            </div>
            <div class="col-lg-3">
              <button type="button" id="btnRegRech" class=" btn btn-block btn-warning btn-sm botones">OBSERVAR</button><br>
            </div>
              <div class="col-lg-3">
