	...
	<div class="row">
		...
		<div class="col-lg-12">
			<div class="box">
				...
				<div class="box-header" style="background-color:blue;">
					<font color="white"><center><strong>ASIGNAR TECNICO</strong></center></font>
				...
				<div class="box-body">
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group form-group-sm">
								<label>T&eacute;cnicos</label>
								<select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" name="tecnico" id="tecnico" >
									<option value=""></option>
									@foreach($tecnicos as $tec)
									<option  value="{{$tec->IdUsuario}}">{{$tec->name}} {{$tec->apeusu}}</option>
									@endforeach
								</select>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-2">
							<button type="button" class="btn btn-primary" id="btnAsigTec">Asignar</button>
						</div>
					</div>
