					...
					<table id=""  class="table table-bordered table-hover" style="font-size:8pt;">
						...
						<tbody>
							...
							<tr>
								...
								<td style="vertical-align:middle;"><a href="/visualizarorden/{{$comp->IdCpe_cabecera}}"><button type="button" class="btn btn-sm btn-warning btn-block">VISUALIZAR</button></a></td>
