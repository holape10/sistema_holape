        	...
        	<div class="col-xs-12">
          		<div class="box">
          			<div class="box-header" style="background-color:blue;">
          				<font color="white"><center><strong>REGISTRO DE GASTOS</strong></center></font>
          			</div>
	            	<div class="box-body">
	            		@include('empresas.gastos.buscarcomprobantes')
	            	</div>
	            </div>
	        </div>
	</div>            
								...
								<tr>
									...
									<td>
										...
										@if(Auth::user()->hasRole('admin'))
												<a href="{{URL::action('GastosController@edit',$comp->gast_cab_id)}}"><button class="btn btn-info">Editar</button></a>
