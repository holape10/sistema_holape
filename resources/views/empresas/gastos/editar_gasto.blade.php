        ...
        <div class="container-fluid detalle">
                <div class="box">
                    <div class="box-header" style="background:blue;">
                        <center><strong><font color="white" size="2">ACTUALIZAR GASTO</font></strong></center>
                        
                    </div>
                    
                    <input type="hidden" name="id" readonly="readonly" value="{{$gasto_cab->gast_cab_id}}">
                    <div class="box-body">
                        <div class="col-lg-2">
                            ...
                            <div class="form-group form-group-sm">
                                ...
                                <select name="cmbTdo" id="cmbTdo" class="form-control">
                                    ...
                                    @foreach($doccomprobante as $doc)
                                        ...
                                        @if($doc->tdocod == $gasto_cab->tdocod)
                                        	  <option selected="selected" value='{{$doc->tdocod}}' @if(old('tdocod') == $doc->tdocod) {{ 'selected' }} @endif >{{$doc->tdodes}}</option>
                                        @else
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                ...
                                <input name="serdoc"  id="serdoc" value="{{$gasto_cab->gast_doc_ser}}" class="form-control" >
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                ...
                                <input type="number"  id="numdoc" name="numdoc" value="{{$gasto_cab->gast_doc_num}}" class="form-control" >
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                ...
                                <input type="date" id="fecEmi" name="fecEmi" value="{{$gasto_cab->gast_fec}}" class="form-control">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                ...
                                <input type="date" name="fecVen" value="{{$gasto_cab->gast_fec_ven}}"  class="form-control">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group form-group-sm">
                                ...
                                <select name="cmbTdi" id="cmbTdi" class="form-control">
                                    ...
                                    @foreach($docidentidad as $doc)
                                        @if($doc->tdicod == $gasto_cab->tdicod)
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                ...
                                <input type="text" id='clinum' name="txtProvNum" id="txtProvNum" value="{{$gasto_cab->prov_ruc}}"  placeholder="" class="form-control clinum">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                ...
                                <input type="text" name="txtProvRaz" id="clinom" value="{{$gasto_cab->prov_raz}}" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                ...
                                <input name="txtProvDir" id="clidir" value="{{$gasto_cab->prov_dir}}" class="form-control">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                ...
                                <input name="txtProvCor" id="clicor" value="{{$gasto_cab->prov_cor}}" class="form-control">
                ...
                <div class="box">
                    ...
                    <div  class="box-body">
                       <table id="detgasto" class="table table-border table-striped">
                            ...
                            <tbody id="">
                             		@foreach($gasto_det as $gd)
                             			<tr>
                             				<td>
                             					<select class="form-control input-sm" name="tip_gas[]">
	                             					@foreach($gastos as $gas) 
		                             					@if($gas->tip_gas_id == $gd->tip_gas_id)
		                             						<option selected="selected" value="{{$gas->tip_gas_id}}">{{$gas->tip_gas_nom}}</option>  
		                             					@else
		                             						<option value="{{$gas->tip_gas_id}}">{{$gas->tip_gas_nom}}</option>  
		                             					@endif
		                             							
	                             					@endforeach
                             					</select>
                             					</td>
                             				<td><input onkeypress="if (event.keyCode == 13) enviar_formulario(); if(event.keyCode == 45) deleteRow(this);" class="detpro form-control input-sm" name="detpro[]" id="detpro" size="100" value="{{$gd->det_gasto}}" ></td>
                             				<td ><input type="number" step="any" class="form-control input-sm preuni" size="20px" id="preuni" name="preuni[]" value="{{$gd->pre_uni}}" onChange="Calculargasto();"   OnKeyUp="Calculargasto();" onKeypress="if(event.keyCode == 45) deleteRow(this);"  style="text-align:right;" name="preuni[]"/></td>
                             ...
                             <div class="form-group form-group-sm">
                              <label>TOTAL</label>
                        <input class="form-control" type="number" min="0"  step="any" style="text-align:right;" id="total_gasto" name="total_gasto" value='{{$gasto_cab->total_gast}}' readonly="readonly">
                        </div>
                    ...
                    <div class="box">
                        ...
                        <div  class="box-body">
                            <div class="form-group">
                                <textarea class="form-control" id="obser" name="obser" rows="3">{{$gasto_cab->gast_obs}}</textarea>
                             </div>
                        </div>
                    </div>
                    <button type="button" id="btngasto" name="btngasto"  class="btn btn-sm btn-primary"><strong>ACTUALIZAR</strong></button>
