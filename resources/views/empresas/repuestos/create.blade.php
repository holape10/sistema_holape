        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border" style="background-color:blue;">
                    <center><font color="white"><strong>REGISTRAR REPUESTO</strong></font></center>
                </div>
                <div class="box-body">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                ...
                                <select class="form-control"  name="promocion" id="promocion">
                                    <option value="7">Repuesto</option>
                                </select>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="form-group form-group-sm">
                        <label for="txt_pronom">Nombre de Repuesto</label>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-6">
                   <div class="form-group form-group-sm">
                       ...
                       <a href="/repuestos"><button class="btn btn-danger btn-close botones" type="button">Cancelar</button></a>
                   </div>
               </div>
           </div>
