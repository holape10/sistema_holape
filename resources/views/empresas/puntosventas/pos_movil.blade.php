      ...
      $.ajax({
        ...
        if(respuesta.estado =='error'){
            ...
            if(respuesta.tdocod=='15'){
                ...
                window.location.href = "/posmv";
            }else{
                window.location.href = "/posmv/"+respuesta.codfact;
            }
    ...
    /* if($('#tdicod').val() =='6' ){
      ...
      if($('#tdicod').val() =='1' ){
       ...
       if($('#tdicod').val() =='6' ){
          ...
          if($('#tdocod').val()!='13' && $('#tdocod').val()!='15'){
...
if(pago=='0.00' || pago=='0' || pago==''){
 ...
 function agregarnota(button){
  ...
  $('#grdet').append("<tr>"+
     "<td width=200px' hidden='hidden'><input type='text'  readonly='readonly'  class='form-control input-sm'  value=''></td>"+
    "<td width='300px'><input style='width:300px;height:50px;' type='text' class='form-control input-sm btn-block' name='pronom[]' value='' ></td>"+
    "<td> <input type='number' step='any' min='0' value='1'  name='cant[]' onkeyup='Calcular(this);' onchange='Calcular(this);' class='cant form-control input-sm ' id='font-size' style='width:60px;height:50px;'> </td>"+
    ...
    "<td><input  type='number' step='any' min='0' class='form-control input-sm' name='propun[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='0.00' style='width:80px;height:50px;' ></td>"+
    ...
    "<td><input  type='text' class='form-control input-sm' name='itemtotal[]'  value='0.00' onkeyup='CalcularItem(this);' style='width:80px;height:50px;' ></td>"+
  ...
  if(precio_ref===undefined){
      $('#grdet').append("<tr>"+
         "<td hidden='hidden' width='200px'><input type='hidden' readonly='readonly' class='form-control input-sm'  value='"+codigo+"'>"+codigo+"</td>"+
  ...
  <div class="col-lg-12">
        <div class="box">
         ...
         <div class="box-header" style="background-color:blue;">
              <font color="white"><strong>DATOS DEL COMPROBANTE</strong></font>
         </div>
         <div class="box-body">
              ...
              <div class="col-lg-3">
                ...
                <div class="form-group form-group-sm">
                    ...
                    <select name="tdocod" id="tdocod" class="form-control">
                      @foreach($comprobante as $cp)
                        <option value="{{$cp->tdocod}}">{{$cp->tdodes}}</option>
                      @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="col-lg-3">
                <div class="form-group form-group-sm">
                    <LABEL>MONEDA</LABEL>
                    <select name="moncod" id="moncod" class="form-control">
         ...
         <div class="box-body" id="divcliente">
            ...
            <div class="box-header" style="background-color:blue;">
                   <font color="white"><strong>PRODUCTOS</strong></font>
        ...
        <div class="box-header" style="background-color:blue;">
            <font color="white"><strong>MONTO A PAGAR</strong></font>
         </div>
          <div class="box-body">
        ...
        <div class="box-header" style="background-color:blue;">
            <font color="white"><strong>MEDIOS PAGO</strong></font>
         </div>
