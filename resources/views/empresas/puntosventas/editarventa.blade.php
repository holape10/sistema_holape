        ...
        $.ajax({
          ...
          $('#grdet').append("<tr>"+
           ...
           "<td hidden='hidden' ><input type='text' class='form-control' name='mon_icbper[]'  value='"+data[0].mon_icbper+"' readonly='readonly' ></td>"+
            "<td hidden='hidden'><input  type='number' readonly='readonly' step='any' min='0' class='form-control input-sm' name='propunref[]'  value='"+data[0].propun+"' style='width:80px' ></td>"+
...
if(pago=='0.00' || pago=='0' || pago==''){
 ...
 function presentaciones(id){
   ...
   function agregaritem_pre(button){
    ...
    $('#grdet').append('<tr><td width="900px" hidden="hidden"><input type="text" class="form-control" name="pronom[]" value="'+productonom+'"></td>'+
        ...
        <div class="box-header" style="background-color:#337ab7;">
          ...
          <div class="row">
             ...
             @if($cabecera->tdocod =='01' || $cabecera->tdocod =='03'  || $cabecera->tdocod =='13' || $cabecera->tdocod =='07' || $cabecera->tdocod =='15')
                 ...
                 <button type="button" id="btnRegCompAct" class=" btn btn-block btn-primary btn-lg botones">ACTUALIZAR</button>
                  <br>
