        ...
        <div class="box">
          <div class="box-body" style="background-color:#3c8dbc;">
           ...
           @endif
            ...
            <div class="col-lg-12" >
                   <font style="color:white;font-weight:bold;"><center>COMPROBANTE DE PAGO {{$bus_comp->serdoc}}-{{$bus_comp->numdoc}}</center></font>
            </div>
  ...
  <div class="col-lg-12">
        <div class="box">
         ...
         <div class="box-body">
          ...
          <input type="hidden" readonly="readonly" name="cab_id" value="{{$bus_comp->IdCpe_cabecera}}">
