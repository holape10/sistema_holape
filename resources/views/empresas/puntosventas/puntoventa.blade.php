...
function agregaritem(button){
  ...
  $('#grdet').append("<tr><td width='1300px'><input type='text' class='form-control btn-block' name='pronom[]' value=''></td><td> <input type='number' step='any' min='0' value='1' name='cant[]' onkeyup='Calcular(this);' onchange='Calcular(this);' class='form-control input-sm ' id='font-size' style='width:60px'> </td><td><select style='width:100px' name='unid[]'  class='form-control input-sm'> @foreach($unidades as $und) @if($und->umecod == 'UNI') <option  selected='selected' value='{{$und->umecod}}'>{{$und->umenom}}</option> @else <option  value='{{$und->umecod}}'>{{$und->umenom}}</option> @endif @endforeach </select></td><td hidden='hidden'><input type='text' class='form-control' name='provun[]'  value='' readonly='readonly' style='width:130px' ></td><td><input  type='number' step='any' min='0' class='form-control input-sm' name='propun[]'   value='0' style='width:80px'onkeyup='Calcular(this);' onchange='Calcular(this);' ></td><td><input  type='text' class='form-control' name='itemtotal[]'  value='0' onkeyup='CalcularItem(this);' style='width:80px' ></td><td hidden='hidden'><input type='text' class='form-control' name='proid[]'  value='' readonly='readonly' ></td><td><button type='button' onClick='deleteRow(this);' class='btn btn-danger btn-sm remove'><span class='glyphicon glyphicon-minus'></span></button></td></tr>");
     ...
     <div class="box-header" style="background-color:blue;">
       <font color="white"><strong><center>{{$datos->tipo_negocio}}</center></strong></font>
                    ...
                    <div class="box-tools pull-right">
                     <!-- <a  data-target="#modal-guia" data-toggle="modal"><button type="button" class="btn btn-success btn-sm">GUIA - REMISION</button></a>-->
     ...
     <div class="box-body">
       <table class="table table-hover" id="grdet">
        <thead>
          ...
          <th>PU</th>
          <th>Total</th>
         <th><button type="button" onClick="agregaritem();" name="add" id="add" class="btn btn-success btn-sm add"><span class="glyphicon glyphicon-plus"></span></button></th>
        </thead>
