            ...
            <div class="form-group form-group-sm">
              ...
              <select name="combustible" class="form-control">
                ...
                @foreach($combustible as $comb)
                 @if($comb->comb_id == $cotizacion->comb_id)
         ...
         <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
          ...
          <div class="row">
            ...
            <div class="form-group form-group-sm">
             ...
             <textarea type="text" name="observaciones"  class="form-control" rows="4">{{$cotizacion->observaciones}}</textarea> 
            </div>
          </div>
    ...
    <div class="row">
        ...
        <tbody>
           @foreach($detalles as $detalle)
            <tr>
           <td width='200px'><input type='text' readonly='readonly' class='form-control input-sm'  value='{{$detalle->procod}}'></td>
           <td width='900px'><input type='text' class='form-control input-sm' name='pronom[]' value='{{$detalle->cdedes}}'></td>
           <td> <input type='number' step='any' min='0' value='{{$detalle->cdecan}}' name='cant[]' onkeyup='Calcular(this);' onchange='Calcular(this);' class='form-control input-sm ' id='font-size' style='width:60px'></td>
           <td width='80px' ><input readonly='readonly'  value='{{$detalle->cdecan}}'  name='unid[]'  class='form-control input-sm'></td>
           <td><input  type='number' step='any' min='0' class='form-control input-sm' readonly='readonly' name='propun[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='{{$detalle->cdepuni}}'  style='width:80px' ></td>
           <td  ><input  type='number' step='any' min='0' class='form-control input-sm' name='desc[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='0.00' style='width:80px' ></td>
           <td><input  type='text' class='form-control input-sm' name='itemtotal[]' readonly='readonly'  value='{{$detalle->cdevve}}' onkeyup='CalcularItem(this);' style='width:80px' ></td>
           <td hidden='hidden'><input  type='number' readonly='readonly' step='any' min='0' class='form-control input-sm' name='precio[]'  value='{{$detalle->valor_unitario}}' style='width:80px' ></td>
           <td hidden='hidden'><input type='text' class='form-control' name='proid[]'  value='{{$detalle->IdProducto}}' readonly='readonly' ></td>
           <td hidden='hidden' ><input type='text' class='form-control' name='id_almacen_pro[]'  value='{{$detalle->id_almacen_pro}}' readonly='readonly' ></td>
           <td><button type='button' onClick='deleteRow(this);' class='btn btn-danger btn-sm remove'><span class='glyphicon glyphicon-minus'></span></button></td></tr>
           @endforeach
        </tbody>
      </table>
