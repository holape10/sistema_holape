...
function calculartotal(){
 ...
 $("#grdet tbody tr").each(function(){
  ...
  tot_icbper =  parseFloat(tot_icbper) + parseFloat($(this).find("td:eq(2)  > input").val()*$(this).find("td:eq(11)  > input").val());
  ...
  <div class="col-lg-12">
    ...
    <div class="box-body">
     <div class="row">
      ...
      <div class="col-lg-3" id="div_almacen">
        <div class="form-group form-group-sm">
    ...
    <div class="col-lg-5" style="display:none;">
     <div class="form-group form-group-sm">
      ...
      <select class="form-control" name="tdocod___" id="tdocod___">
 ...
 <div class="row form-group form-group-sm">
  ...
  <div class="col-lg-6">
    <div class="form-group">
      ...
      <div class="input-group input-group-sm">
        <input name="clinom" id="clinom" value="Varios" class=" form-control input-xs" onkeypress="if(event.keyCode == 13) buscarclientenombre();">
        <span class="input-group-btn">
  ...
  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
    <div class="form-group form-group-sm">
      <label>Correo</label>
      <input name="clicor" id="clicor" value="" class="form-control">
    </div>
  </div>
  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
