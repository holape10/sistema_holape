 ...
 function agregarnota(button){
  ...
  /*if(contar>0){
      ...
      $('#grdet').append("<tr>"+
        ...
        "<td><input  type='number' step='any' min='0' class='form-control input-sm' name='propun[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' readonly='readonly' value='"+precio+"' style='width:80px' ></td>"+
        ...
        <div class="box">
          <div class="box-body" style="background-color:#dd4b39;">
           ...
           @endif
            ...
            <div class="col-lg-12" >
                   <font style="color:white;font-weight:bold;"><center>EN ESTA OPCIÓN SE CAMBIARÁ EL COMPROBANTE DE PAGO {{$cabecera->serdoc}}-{{$cabecera->numdoc}}</center></font>
            </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                      <textarea class="form-control" rows="3" readonly="readonly" maxlength="250" name="observaciones"></textarea>
                  </td>
                </tr>
              </tbody>
            </table>
  ...
  <div class="col-lg-12">
        <div class="box">
         ...
         <div class="box-body">
          ...
          <input type="hidden" readonly="readonly" name="cab_id" value="{{$cabecera->IdCpe_cabecera}}">
           <input type="hidden" readonly="readonly" name="ped_id" value="{{$cabecera->ped_ref}}">
            ...
            <div class="col-lg-3">
              ...
              @if(!empty($cabecera->tdocod_fac))
                                <label >
                            @if($cabecera->tdocod_fac =='03')
                  ...
                  @endif
                     ...
                     <label >
                   @if($cabecera->tdocod_fac =='15')
                         <input type="radio" name="tdocod" id="proforma" value="15" checked="checked" > PROF
        ...
        <div class="box-header" style="background-color:blue;">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
               ...
               <button type="button" id="btnRegComp" class=" btn btn-block btn-success btn-lg botones">REGISTRAR</button>
       ...
       <br>
         ...
         @endif
             ...
             @if($cabecera->tdocod =='01' || $cabecera->tdocod =='03'  || $cabecera->tdocod =='13' || $cabecera->tdocod =='15')
                 ...
                 <button type="button" id="btnRegComp" class=" btn btn-block btn-success btn-lg botones">CAMBIAR</button>
