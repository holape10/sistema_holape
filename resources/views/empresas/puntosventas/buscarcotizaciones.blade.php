...
{!! Form::model(Request::all(),['Route'=>'/SisFact','method'=>'GET','autocomplete'=>'off','name'=>'formfact'])!!}
...
<div class="row">
	...
	<div hidden="hidden" class="col-lg-2">
	   ...
	   <div class="col-lg-6">
             ...
             <select class="form-control selectpicker" data-show-subtext="true" data-live-search="true" name="placa" id="placa" >
            <option value="0">Todos</option>
            @foreach($vehiculos as $vehiculo)
            <option  value="{{$vehiculo->id_tipo_vehiculo}}">Placa: {{$vehiculo->placa}} | Cliente: {{$vehiculo->clinom}}</option>
            @endforeach
          </select>
          </div>
