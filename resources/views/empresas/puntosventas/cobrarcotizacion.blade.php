      ...
      if(code==13){
        ...
        $.ajax({
          ...
          $('#grdet').append("<tr>"+
            ...
            "<td width='80px' ><input readonly='readonly'  value='"+data[0].unidad+"'  name='unid[]'  class='form-control input-sm'></td>"+
            "<td><input  type='number' step='any' min='0' class='form-control input-sm' readonly='readonly' name='propun[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='"+data[0].propun+"'  style='width:80px' ></td>"+
            ...
            "<td hidden='hidden'><input  type='number' readonly='readonly' step='any' min='0' class='form-control input-sm' name='precio[]'  value='"+data[0].propun+"' style='width:80px' ></td>"+
...
<div class="col-lg-5">
  <div class="col-lg-12">
        ...
        <input type="hidden" readonly="readonly" name="cot_id" value="{{$cabecera->IdCpe_cabecera}}">
             <div class="row">
                <div class="col-lg-3">
           ...
           <div class="row">
            <div class="col-lg-4">
               <div class="form-group form-group-sm">
                ...
                <input type="text" name="guia_remision" id="guia_remision" value="{{$cabecera->guia_remision}}" class="form-control">
                <input type="hidden" name="IdCpe_guia" id="IdCpe_guia" value="{{$cabecera->IdCpe_guia_ref}}" class="form-control">
             </div>
            </div>
