      ...
      <div class="col-lg-6">
        <div class="box">
         <div class="box-header with-border  form-group form-group-sm">
          ...
          <div class="box-body">
            ...
            <div class="row form-group form-group-sm">
              ...
              <div class="col-lg-6">
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                  <label  >
                    <input type="radio" name="options" id="boleta" value="03" autocomplete="off" checked="checked"> BO
                  </label>
                  <label  >
                    <input type="radio" name="options" id="factura" value="01" autocomplete="off"> FA
                  </label>
                  <label >
                    <input type="radio" name="options" id="nota" value="13" autocomplete="off" > NV
                  </label>
                    <label >
                    <input type="radio" name="options" id="proforma" value="15" autocomplete="off" > PROF
                  </label>
                </div>
              </div>
            ...
            <BR><table class="table table-hover" >
             ...
             <tr>
              <th hidden="hidden"><input type="text" class="form-control"  id="subtotal" name="subtotal" value='0.00' readonly="readonly"> </th>
              <th hidden="hidden"><input type="text" class="form-control"  id="igv" name="igv" value='0.00' readonly="readonly"> </th>
             
              <th><input type="text" class="form-control"  id="total" name="total" value='0.00' readonly="readonly"> </th>
           ...
           <tr>
             <th><input type="number"  step="any" class="form-control"  value="0.00" id="efectivo1" name="efectivo1" placeholder="Efectivo"> </th>
         ...
         <BR> <table class="table ">
          <tr>
            <td colspan="2"><button type="button" id="btnRegComp" class=" btn btn-block btn-success btn-lg botones">REGISTRAR</button></td>
          </tr>
          <tr>
            <td><a href="/listallevar"><button type="button" class=" btn btn-block btn-danger btn-lg botones">SALIR</button></a></td>
          </tr>
        </table>
      </div>
      {!!Form::close()!!}
