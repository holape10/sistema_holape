  ...
  <div id="divpedido">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
              <div class="box">
                <div class="box-header" style="background-color:blue;">
                   <font color="white"><center><strong>{{$datos->tipo_negocio}}</strong></center></font>
                </div>
                 <div class="box-body">
                   ...
                   <table class="table table-hover" id="grdet">
                    ...
                    <tbody>
                        <tr>
                          ...
                          <td hidden="hidden"  width='1300px'><input type='text' class='form-control input-sm btn-block' name='pronom[]' value='VENTA GENERAL' ></td>
                          <td hidden="hidden" > <input type='number' step='any' min='0' value='1'  name='cant[]' onkeyup='Calcular(this);' onchange='Calcular(this);' class='cant form-control input-sm ' id='font-size' style='width:60px'> </td>
                          ...
                          <td hidden="hidden" ><input  type='number' step='any' min='0' class='form-control input-sm' name='propun[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='0.00' style='width:80px' ></td>
                          ...
                          <td ><input style="height:100px;width:350px;font-size:28pt;font-weight:bold;" id='venta_total'  type='text' class='form-control input-sm' name='itemtotal[]'  value='' onkeyup='CalcularItem(this);' style='width:80px' ></td>
                           <td hidden="hidden"><input  type="number" readonly="readonly" step="any" min="0" class="form-control input-sm" name="precio[]"  value="0" style="width:80px" ></td>
                          <td hidden='hidden'><input type='text' class='form-control' name='proid[]'  value='0' readonly='readonly' ></td>  
                          <td hidden='hidden' ><input type='text' class='form-control' name='id_almacen_pro[]'  value='' readonly='readonly' ></td>
                   ...
                   <table hidden="hidden"  class="table table-hover">
              <thead hidden="hidden">
...
<div style="display:none" class="col-lg-5">
  <div class="col-lg-12">
        <div class="box">
         ...
         <div style="display:none;"  class="box-body" id="divcliente">
