...
@include('empresas.puntosventas.modal_comprobante')
		...
		$("#btnRegistrar").on("click", function() {
			...
			$.ajax({
				...
				if(respuesta.estado =='error'){
					...
					window.location.href = "/ventacaja5/"+respuesta.codfact;
					...
					<div class="box" style="background-color:#F0F0F0;">
						<div class="box-header" style="background-color:#E8E8E8;" >
							...
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
								<div class="form-group form-group-sm">
									<div class="btn-group">
										<button type="button" class="btn btn-md btn btn-block" onclick="buscar_producto_categoria_img({{$cat->cat_id}});" style="width:200px;margin-bottom:-10px;background:{{$cat->color}};color:white;font-weight:bold;">{{$cat->cat_nom}}</button>
									</div>
								</div>
							</div>
							@endforeach
						...
						<div class="box-body" style="background-color:#F0F0F0;" >
							<div class="col-lg-12" style="padding:10px;" id="items_productos_img">
								...
								<div class="col-lg-3 col-md-4 col-sm-4 col-xs-6" onclick="elegir_acompanamiento('{{$p->IdProducto}}','{{$p->pronom}}','{{$p->precio}}','{{$p->cat_sig}}','{{$p->acom}}','{{$p->icbper}}')">
									<div class="info-box">
										<span class="info-box-icon bg-aqua" style="background-image:url('/imagenes/productos/{{$p->imagenproducto}}');background-repeat: no-repeat;background-size: 90px 90px;" ></span>
										<div class="info-box-content">
											<span class="info-box-text">{{$p->pronom}}</span>
											<span class="info-box-number">S/. {{number_format($p->precio,'2','.','')}}</span>
										</div>
									</div>
								</div> 
								@endforeach
									...
									<div class="form-group form-group-sm">
										<table class="table table-striped table-hover table-bordered table-condensed" id="tbl_detalle">
											...
											<thead style="background:orange;">
												<tr style="text-align:center;font-weight:bold;">
													<td colspan="5">
														<label style="text-align:center;">DETALLE</label>
								...
								<div class="col-lg-5">
									...
									<div class="form-group form-group-sm">
										<label>OPERACIONES</label>
										 <a  data-target="#modal-comprobante" data-toggle="modal"><button type="button"  class="btn btn-primary btn-lg btn-block botones">COMPROBANTE</button></a>
									</div>
