    ...
    $("#btnRegistrar").on("click", function() {
      ...
      $.ajax({
        ...
        if(respuesta.estado =='error'){
          ...
          window.location.href = "/consolacaja";
                ...
                <table class="table table-striped table-hover table-bordered table-condensed" id="tbl_detalle">
                  ...
                  <tbody id="items_pedidos">
                    ...
                    <tr>
                      ...
                      <td>{{$det->cdedes}}</td>
                      <td><input type="number" style="text-align:center;" step="any" class="form-control" name="txt_cantidad[]" onkeyup='calcular_total();' onChange='calcular_total();' value="{{$det->cdecan}}" min="1"></td>
                      <td style="text-align:right;" hidden="hidden">{{$det->cdepuni}}</td>
                      <td style="text-align:right;" ><input type="number" class="form-control" step="any" onkeyup='calcular_total();' onChange='calcular_total();' name="precios[]" id="precios[]" value="{{$det->cdepuni}}"></td>
              ...
              <table class="table table-responsive table-striped table-hover" id="tbl_med_pag">
                ...
                <tbody id="tbody_med_pag">
                  @foreach($ventas_medios as $vm)
                    ...
                    <td hidden="hidden"><input type="number"  style="text-align:center;width:400px;"  class="form-control" name="mon_med_pag[]" value="{{$vm->nom_med_pag}}"></td>
