   ...
   $(document).ready(function()
   {
    ...
    $("#buscardescripcion").keyup(function(){
      ...
      if(contarcarateres >4){
        $("#detmenu").html('<center><img src="/img/load.gif" width="120px" height="120px"></center>');
        $.ajax({
          type: "GET",
          dataType: 'json',
...
if(pago=='0.00' || pago=='0' || pago==''){
 ...
 function presentaciones(id){
   ...
   //  var suc = $('#sucursal').val();
       ...
       $("#presentaciones").html('<center><img src="/img/load.gif" width="120px" height="120px"></center>');
    ...
    @if($sucursal->ven_sin_sto =='0')
      ...
      @if($producto->stock>0)
            ...
            @if($producto->cont_pre > 1)
                ...
                <button type="button" id='pro<?php echo $i; ?>' onclick="presentaciones({{$producto->IdProducto}})" value='{{$producto->precio}}' style="background:#3f4aee  ;width: 120px; height: 120px; border-radius:10px">
            ...
            @else
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <button type="button" id='pro<?php echo $i; ?>'  onclick="agregaritem(this)" value='{{$producto->precio}}' style="background:#3f4aee  ;width: 120px; height: 120px; border-radius:10px">
                  <input type="hidden" name="pro_nom" id='pro<?php echo $i;?>nom' value='{{$producto->pronom}}'>
                  <input type="hidden" name="provun" id='pro<?php echo $i;?>id' value='{{$producto->IdProducto}}'>
            ...
            @if($producto->precio2 > 0)
                ...
                @if($producto->cont_pre > 0 )
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <button type="button" id='pro<?php echo $i; ?>' onclick="presentaciones({{$producto->IdProducto}})" value='{{$producto->precio}}' style="background:orange   ;width: 120px; height: 120px; border-radius:10px">
                      <input type="hidden" name="pro_nom" id='pro<?php echo $i;?>nom' value='{{$producto->pronom}}'>
                      <input type="hidden" name="provun" id='pro<?php echo $i;?>id' value='{{$producto->IdProducto}}'>
                ...
                @else
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <button type="button" id='pro<?php echo $i; ?>'  onclick="agregaritem(this)" value='{{$producto->precio}}' style="background:orange   ;width: 120px; height: 120px; border-radius:10px">
                      <input type="hidden" name="pro_nom" id='pro<?php echo $i;?>nom' value='{{$producto->pronom}}'>
                      <input type="hidden" name="provun" id='pro<?php echo $i;?>id' value='{{$producto->IdProducto}}'>
