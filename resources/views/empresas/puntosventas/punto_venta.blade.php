...
function agregar_item(id,producto,precio){
	...
	if (validar==true){
		...
		$('#items_pedidos').append('<tr><td hidden="hidden" id="'+id+'"><input type="text" readonly="readonly" class="form-control" name="txt_id_producto[]" value="'+id+'"></td>'+
			'<td>'+producto+'</td>'+
			'<td><input type="number" style="text-align:center;" step="any" class="form-control"  onkeyup="calcular_total();" onChange="calcular_total();"  name="txt_cantidad[]" value="1" min="1"></td>'+
			'<td style="text-align:right;" hidden="hidden">'+precio+'</td>'+
			'<td style="text-align:right;"><input type="number" step="any" class="form-control" onkeyup="calcular_total();" onChange="calcular_total();" name="precios[]" value="'+precio+'"></td>'+
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="box">
					...
					<strong><font style="font-size:10pt;font-weight:bold;">OPCIONES</font></strong>
		...
		<div class="col-lg-5">
			<div class="box">
				...
				<div class="box-header" style="background-color:#E8E8E8;">
					<strong><font style="font-size:10pt;font-weight:bold;">DATOS DEL COMPROBANTE</font></strong>
					<div class="box-tools pull-right">
						...
						<div class="col-lg-5">
							<div class="form-group">
								...
								<div class="input-group input-group-sm">
									...
									<input name="clinom" id="clinom" value="Varios" class="form-control" onkeypress="if(event.keyCode == 13) buscarclientenombre();">
									<span class="input-group-btn">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-lg-2">
						<div class="form-group form-group-sm">
							<label>TOTAL S/.</label>
							<input type="number" class="form-control input-lg" style="height:60px;width:180px;font-size:22pt;font-weight:bold;" step="any" readonly="readonly" name="total_venta" id="total_venta" value="0.00">
						</div>
