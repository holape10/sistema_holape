  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="box">
       <div class="box-header with-border" style="background:gray">
        <font size="2" color="white"><strong><center>GENERAR ORDEN DE PEDIDO</center></strong></font>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
           ...
           @foreach($condiciones as $condicion)
            ...
            <option value="{{$condicion->cond_id}}">{{$condicion->cond_nom}}</option>
    ...
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            <div class="form-group form-group-sm">
                <label for="contacto">Contacto</label>
                 <input type="text" name="contacto" value="{{old('contacto')}}" class="form-control" placeholder="">
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
            <div class="form-group form-group-sm">
                ...
                <input type="text" name="telefono" value="{{old('telefono')}}" class="form-control" placeholder="">
      ...
      <div class="box">
        ...
        <span id="btnRegComp"  class="btn btn-success btn-sm">REGISTRAR</span>
