                    ...
                    <tbody>
                      @foreach($detalle as $det)
                        <tr>
                          ...
                          <td hidden='hidden'>
                            <input type='text' class='form-control input-sm' name='provun[]'  value='' readonly='readonly' style='width:130px' >
                          </td>
                          <td>
                            <input type='text' class='form-control input-sm' readonly="readonly" name='propun[]'  value='{{$det->cdepuni}}'  style='width:80px' ></td>
                          <td>
                            <input type='text' class='form-control input-sm' readonly="readonly" name='itemtotal[]' onkeyup='CalcularItem(this);'  value='{{$det->cdevve}}'  style='width:80px' >
                          </td>
                          <td hidden='hidden'>
                            <input type='text' class='form-control input-sm' name='proid[]'  value='{{$det->IdProducto}}' readonly='readonly' style='width:80px' >
                          </td>
                           <td hidden='hidden'>
                            <input type='text' class='form-control' name='IdCpe_detalle[]'  value='{{$det->IdCpe_detalle}}' readonly='readonly' style='width:80px' >
                          </td>
                          <td>
        ...
        <div class="box-header" style="background-color:blue;">
          ...
          <div class="row">
            <div class="col-lg-12">
             ...
             <div class="col-lg-12">
              <a href="/cotizaciones"><button type="button" class=" btn btn-block btn-danger btn-lg botones">SALIR</button></a><br>
            </div>
          </div>
        </div>
