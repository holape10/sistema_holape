					...
					<div class="row">
						<div class="col-lg-2">
							<div class="form-group form-group-sm">
								...
								<input class="form-control"  type="number" step="any" name="fre_car" value="{{$historias->fre_car}}">
							</div>
						</div>
						...
						<div class="col-lg-2">
							<div class="form-group form-group-sm">
								...
								<input class="form-control" name="fre_res" type="number" step="any" value="{{$historias->fre_res}}">
							</div>
						</div>
						...
						<div class="col-lg-2">
							<div class="form-group form-group-sm">
								<label>Peso</label>
								<input class="form-control" name="peso" step="any" type="number" value="{{$historias->peso}}">
							</div>
						</div>
						...
						<div class="col-lg-2">
							<div class="form-group form-group-sm">
								<label>Talla</label>
								<input class="form-control" name="talla" type="number" step="any" value="{{$historias->talla}}">
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group form-group-sm">
								...
								<textarea class="form-control" rows="5" name="mot_con">{{$historias->mot_con}}</textarea>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-group-sm">
								<label>Antecedentes</label>
								<textarea class="form-control" rows="5" name="antecedente">{{$historias->antecedente}}</textarea>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-group-sm">
								<label>Alergías</label>
								<textarea class="form-control" rows="5" name="alergia">{{$historias->alergia}}</textarea>
							</div>
						</div>
						<div class="col-lg-12">
							<div class="form-group form-group-sm">
								<label>Intervenciones Quirúrgicas</label>
								<textarea class="form-control" rows="5" name="int_qui">{{$historias->int_qui}}</textarea>
							</div>
						</div>
						...
						<div class="col-lg-12">
							<div class="form-group form-group-sm">
								...
								<textarea class="form-control" rows="5" name="exa_fis">{{$historias->exa_fis}}</textarea>
							</div>
						</div>
						...
						<div class="col-lg-12">
							<div class="form-group form-group-sm">
								...
								<textarea class="form-control" rows="5" name="diagnostico">{{$historias->diagnostico}}</textarea>
							</div>
						</div>
							<div class="col-lg-12">
								<div class="form-group form-group-sm">
									<label>Tratamiento</label>
									<textarea class="form-control" rows="5" name="tratamiento">{{$historias->tratamiento}}</textarea>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-lg-2">
							<div class="form-group form-group-sm">
								...
								<input type="date" class="form-control" name="pro_cit" value="{{$historias->pro_cit}}">
							</div>
						</div>
					</div>
