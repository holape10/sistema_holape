...
{!! Form::model(Request::all(),['Route'=>'/salidasproductos','method'=>'GET','autocomplete'=>'off'])!!}
...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="btn-group">
				...
				<a href="/egresarproductos"><button type="button" class=" btn btn-success btn-sm">NUEVO VALE SALIDA</button></a>
