      ...
      $.ajax({
        ...
        if(respuesta.estado =='error'){
            ...
            if(respuesta.tdocod=='15'){
                ...
                window.location.href = "/salidasproductos";
            }
...
<div class="container-fluid" id="general">
   ...
   {!!Form::open(array('url'=>'/registrarsalidaproducto','autocomplete'=>'off','method'=>'POST','name'=>'formfact','id'=>'formfact','role'=>'form','files'=>'true'))!!}
            {{Form::token()}}
...
<div class="col-lg-5">
  <div class="col-lg-12">
        <div class="box">
         ...
         <div class="box-header" style="background-color:blue;">
              <font color="white"><center><strong>DATOS VALE SALIDA</strong></center></font>
         </div>
         <div class="box-body">
            ...
            <div hidden="hidden" class="col-lg-3">
               ...
               <div  class="col-lg-3">
                <div class="form-group form-group-sm">
                    ...
                    <select name="motivo_traslado" id="motivo_traslado" class="form-control">
                      @foreach($motivos as $mov)
                        <option value="{{$mov->IdMotivo}}">{{$mov->motivo}}</option>
                      @endforeach
                    </select>
                </div>
            </div>
              ...
              <div class="col-lg-5">
                <div class="form-group form-group-sm">
                  ...
                  <label hidden="hidden">
                    <input type="radio" name="tdocod" id="nota" value="85"  checked="checked"> VALE SALIDA
                  </label>
                  <label hidden="hidden" >
