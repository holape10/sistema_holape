...
<body>
 ...
 $("#btnRegCompAct").on("click", function() {
      ...
      $.ajax({
        type: "POST",
        dataType: 'json',
        url: '/actualizarvalesalidaproduccion',
        data: formulario,
      }).done(function(respuesta){
                ...
                <div class="box-header" style="background-color:blue;">
                 ...
                 <div class="box-body">
                   <table class="table table-hover" id="grdet">
                      ...
                      <th hidden=""><button type="button" onClick="agregarnota();" name="add" id="add" class="btn btn-success btn-sm add"><span class="glyphicon glyphicon-plus"></span></button></th>
                    </thead>

                    <tbody>
                      @foreach($detalle as $det)
                        <tr>
                        	<td width='900px'><input type='text' class='form-control' name='pronom[]' value='{{$det->cdedes}}'></td>
                        	...
                        	<td hidden="hidden"><input  type='number' step='any' min='0' class='form-control input-sm' name='propun[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='{{$det->cdepuni}}' style='width:80px' ></td>
                        	...
                        	<td hidden="hidden"><input  type='text' class='form-control' name='itemtotal[]'  value='{{$det->cdevve}}' onkeyup='CalcularItem(this);' style='width:80px' ></td><td hidden="hidden"><input  type="number" readonly="readonly" step="any" min="0" class="form-control input-sm" name="precio[]"  value="{{$det->cdepuni}}" style="width:80px" ></td>
                        	<td hidden='hidden'><input type='text' class='form-control' name='proid[]'  value='@if(empty($det->IdProducto))  0 @else {{$det->IdProducto}} @endif' readonly='readonly' ></td>
                        	<td hidden='hidden' ><input type='text' class='form-control' name='id_almacen_pro[]'  value='{{$det->id_almacen_pro}}' readonly='readonly' ></td>
                        	<td><button type='button' onClick='deleteRow(this);' class='btn btn-danger btn-sm remove'><span class='glyphicon glyphicon-minus'></span></button></td><td hidden="hidden"><input type="hidden" readonly="readonly" name="IdCpe_detalle[]" value="{{$det->IdCpe_detalle}}"></td></tr>
                      @endforeach
                    </tbody>
                  </table>
  ...
  <div class="col-lg-12">
              ...
              <div class="col-lg-5">
                <div class="form-group form-group-sm">
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                     ...
                     <label hidden="hidden">
                    <input type="radio" name="tdocod" id="nota" value="86" checked="checked" > VI
                  </label>
       ...
       <!-- <div class="box-header" style="background-color:blue;">
          ...
          <div class="row">
             ...
             <div class="col-lg-6">
              <a href="/indexingresos"><button type="button" class=" btn btn-block btn-danger btn-lg botones">SALIR</button></a><br>
            </div>
          </div>
        </div>
