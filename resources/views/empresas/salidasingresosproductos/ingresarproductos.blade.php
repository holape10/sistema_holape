      ...
      $.ajax({
        ...
        if(respuesta.estado =='error'){
            ...
            if(respuesta.tdocod=='15'){
                ...
                window.location.href = "/ingresosproductos";
            }
...
<div class="container-fluid" id="general">
   ...
   {!!Form::open(array('url'=>'/registraringresoproducto','autocomplete'=>'off','method'=>'POST','name'=>'formfact','id'=>'formfact','role'=>'form','files'=>'true'))!!}
            {{Form::token()}}
...
<div class="col-lg-5">
  <div class="col-lg-12">
        <div class="box">
         ...
         <div class="box-header" style="background-color:blue;">
              <font color="white"><center><strong>DATOS VALE INGRESO</strong></center></font>
         </div>
         <div class="box-body">
