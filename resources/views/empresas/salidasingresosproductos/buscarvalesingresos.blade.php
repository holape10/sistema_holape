...
{!! Form::model(Request::all(),['Route'=>'/ingresosproductos','method'=>'GET','autocomplete'=>'off'])!!}
	...
	<div class="col-lg-12">
		...
		<div class="btn-group">
			...
			<div class="btn-group">
				...
				<a href="/ingresarproductos"><button type="button" class=" btn btn-success btn-sm">NUEVO VALE INGRESO</button></a>
