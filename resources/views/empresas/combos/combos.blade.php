								...
								<tbody >
									@foreach($combos as $rec)
										<tr>
											...
											<td width='60'> 
												<input type='text' value='{{$rec->umenom}}' name='unidadmedida[]' class='form-control input-sm' readonly='readonly' id='font-size' style='width:150px'>
											</td>
											<td width='80'> 
												<input type='text' value='{{$rec->costo}}' name='costo[]' class='form-control input-sm' readonly='readonly'  id='font-size' style='width:80px'>
											</td>
											<td width='80'> 
												<input type='text' value='{{$rec->propun}}' name='precio[]' class='form-control input-sm' readonly='readonly' id='font-size' style='width:80px'>
											</td>
											<td>
