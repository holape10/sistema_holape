...
<script>
    ...
    {       
      ...
      $('#addpre').click(function() {
            ...
            // Añadir caja de texto.
        $('#detpre').append('<tr><td><div class="input-group input-group-sm"><span class="input-group-btn"><button type="button" class="btn btn-default"><span class="fa fa-barcode"></span></button></span> <input type="text" class="form-control input-sm"  name="codigo_barra_pre[]" value=""></div></td>'+
            '<td width="15%"><select name="presentacion[]" class="form-control input-sm">@foreach($unidades as $unidad) <option value="{{$unidad->umecod}}">{{$unidad->umenom}}</option> @endforeach</select></td><td><input name="descripcion[]" class="form-control input-sm"></td>'+
            ...
            '<td width="10%"><div class="input-group input-group-sm"><span class="input-group-btn"><button type="button" class="btn btn-default"><span class="fa fa-money"></span></button></span><input type="number" min="0" value="0" step="any" name="precio2[]" class="form-control input-sm"></div></td>'+
...
<section class="content">
    {!!Form::open(array('url'=>'combos','method'=>'POST','autocomplete'=>'off','files'=>'true','id'=>'frmProducto'))!!}
    {{Form::token()}}   
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
