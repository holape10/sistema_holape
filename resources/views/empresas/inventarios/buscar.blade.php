{!! Form::open(array('url'=>'/inventarios','method'=>'GET','autocomplete'=>'off','role'=>'search','id'=>'formstock'))!!}
<div class="row">
	<div class="col-lg-2">
	...
	<div class="form-group form-group-sm">
		...
		<select name="almacen" id="almacen" class="form-control">
 		...
 		<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            <div class="form-group form-group-sm">
                <label>DESDE</labeL>
                <input type="date" class="form-control" name="fecha" value="{{$fec_ini}}">
           </div>
        </div>  
        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
            <div class="form-group form-group-sm">
                <label>HASTA</labeL>
                <input type="date" class="form-control" name="fecha" value="{{$fec_fin}}">
           </div>
        </div>  
</div>
...
<div>
	...
	<div class="col-lg-12">
		...
		<div class="btn-group" >
			<a href="" data-target="#modal-nuevo-inventario" data-toggle="modal"><button type="button" id="inventario" class=" btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Nuevo Inventario</button></a>
		</div>
		<!--<div  class="btn-group" >
			<button type="button" id="inventario"  onclick="exportarinventario();" class=" btn btn-warning btn-sm"><span class="glyphicon glyphicon-plus"></span> Exportar Formato</button>
		</div>	-->
		<div  class="btn-group" >
