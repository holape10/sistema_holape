      ...
      $.ajax({
        ...
        if(respuesta.estado =='error'){
            ...
            if(respuesta.tdocod=='15'){
                ...
                window.location.href = "/salidasproduccion/"+respuesta.codfact;
            }
                    ...
                    <tbody>
                      @foreach($detalle as $det)
                        <tr>
                        	...
                        	<td hidden="hidden"><input type="hidden" readonly="readonly" name="IdCpe_detalle[]" value="{{$det->IdCpe_detalle}}"></td></tr>
                      @endforeach
                    </tbody>
                  </table>
              ...
              <div class="col-lg-5">
                <div class="form-group form-group-sm">
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                     ...
                     <label hidden="hidden">
                    <input type="radio" name="tdocod" id="nota" value="85" checked="checked" > VS
                  </label>
