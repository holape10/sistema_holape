        	...
        	<div class="col-xs-12">
          		<div class="box">
          			<div class="box-header" style="background-color:blue;">
          				<font color="white"><center><strong>REGISTRO DE VALES INGRESOS PRODUCCION</strong></center></font>
          			</div>
	            	<div class="box-body">
	            		@include('empresas.produccion.buscarvalesingresos')
	            	</div>
	            </div>
	        </div>
	</div> 
								...
								<tr>
									...
									<td><a href="/descargar/{{$comp->IdCpe_cabecera}}/pdf"><center><i class="fa fa-file-excel-o fa-lg"></i></center></a></td>
										...
										@endif
											...
											<td>
												<a href="/editarvaleingresoproduccion/{{$comp->IdCpe_cabecera}}"><center><button class="btn btn-primary btn-sm">EDITAR</button></center></a>
											</td>
