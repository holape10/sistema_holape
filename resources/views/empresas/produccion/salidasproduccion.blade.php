...
<div class="container-fluid" id="general">
   ...
   {!!Form::open(array('url'=>'/registrarvalesalida','autocomplete'=>'off','method'=>'POST','name'=>'formfact','id'=>'formfact','role'=>'form','files'=>'true'))!!}
            {{Form::token()}}
...
<div class="col-lg-5">
  <div class="col-lg-12">
        <div class="box">
         ...
         <div class="box-header" style="background-color:blue;">
              <font color="white"><center><strong>DATOS VALE SALIDA PRODUCCION</strong></center></font>
         </div>
         <div class="box-body">
