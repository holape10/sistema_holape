            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header with-border" style="background-color:blue;">
                        <center><font color="white"><strong>REGISTRAR SUBFAMILIA</strong></font></center>
                    </div>
                    <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                            <div class="form-group form-group-sm">
                                ...
                                <input type="text" name="subcat_nom" value="{{old('subcat_nom')}}" class="form-control" placeholder="Nombre de subfamilia..." required>
                            </div>
                        </div>
                        ...
                        <div hidden="hidden" class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                            <div class="form-group form-group-sm">
                                ...
                                <input type="color" name="color" value="#3f4aee" class="form-control">
                            </div>
                        </div>
