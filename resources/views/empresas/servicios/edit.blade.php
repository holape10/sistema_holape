...
function calcular_costo_total(){
 ...
 {!!Form::model($productos,['method'=>'PATCH','route'=>['servicios.update',$productos->IdProducto],'files'=>'true'])!!}
                    {{Form::token()}}
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header with-border" style="background-color:blue;">
                    <center><font color="white"><strong>EDITAR SERVICIO</strong></font></center>
                </div>
                <div class="box-body">
                      ...
                      <div  hidden="hidden" class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                        <div class="form-group form-group-sm">
                            ...
                            <select class="form-control"  name="promocion" id="promocion">
                                <option selected="selected" value="6">Servicio</option>   
                            </select>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                        <div class="form-group form-group-sm">
                            <label for="txt_pronom">Nombre del Servicio</label>
  ...
  <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-6">
       <div class="form-group form-group-sm">
        ...
        <a href="{{config('global.ruta')}}/productos"><button class="btn btn-danger btn-close" type="button">Cancelar</button></a>
    </div>
</div>
</div>
