        	...
        	<div class="col-xs-12">
          		<div class="box">
          			<div class="box-header" style="background-color:blue;">
          				<font color="white"><center><strong>CONSULTAR SERVICIOS</strong></center></font>
          				<div class="box-tools pull-right">
                			<a href="servicios/create"><button  class="btn btn-success btn-sm"> Nuevo</button></a>
              			</div>
          			</div>
	            	<div class="box-body">
				...
				@include('empresas.servicios.search')
			</div>
				     	</div>
	            </div>
	        </div>
...
<div class="row">
    <div class="col-xs-12">
    	<div class="box">
    		<div class="box-header" style="background-color:blue;">
          				<font color="white"><center><strong>Servicios - {{$data_suc->IdEmpresa}} - {{$data_suc->tipo_negocio}}</strong></center></font>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<tr>
					...
					<td>
							...
							<a href="/editarservicio/{{$pro->IdProducto}}/{{$data_suc->id_empresa_negocio}}"><img src="/icon/editar.png" title="EDITAR" height="30px" width="30px"></a>
				...
				@include('empresas.servicios.modal')
				@include('empresas.servicios.modalimagen')
