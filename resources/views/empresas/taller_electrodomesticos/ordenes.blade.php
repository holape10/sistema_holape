					...
					<table id=""  class="table table-bordered table-hover" style="font-size:8pt;">
						<thead style="background-color:blue;color:white;">
							<tr >
								...
								<th style="vertical-align:middle">Cobrar</th>
						...
						<tbody>
							...
							<tr>
								...
								<td style="vertical-align:middle;"><a href="/editarordent/{{$comp->IdCpe_cabecera}}"><button type="button" class="btn btn-sm btn-warning btn-block">Editar</button></a></td>
