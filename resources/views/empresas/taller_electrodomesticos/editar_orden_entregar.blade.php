   ...
   $(document).ready(function()
   {
    ...
    $("#btnRegComp").on("click", function() {
      ...
      $.ajax({
        ...
        window.location.href = "/ordeneselectro";
  ...
  <div class="row"> 
      ...
      <div class="form-group form-group-sm">
        <label for="equipo">Equipos</label>
          <div class="input-group input-group-sm">
            ...
            <span class="input-group-btn">
              <button type="button" disabled="disabled" class="btn btn-primary btn-flat" onclick="seleccionarequipos();">BUSCAR EQUIPO</button>
            </span>
          </div>
        ...
        <div class="col-lg-2">
          <div class="form-group form-group-sm">
            ...
            <input  type="text" id="equi_ser" readonly="readonly" name="equi_ser" value="{{$cotizacion->equi_ser}}" class="form-control">
          </div>
        </div>
       ...
       <div class="col-lg-2">
            <div class="form-group form-group-sm">
              ...
              <input  type="date" id="fecha" name="fecha"  readonly="readonly" value="{{$cotizacion->fechacot}}" class="form-control">
            </div>
          </div>
             <div class="col-lg-2">
            <div class="form-group form-group-sm">
              <label>Fecha Compra </label>
              <input  type="date" id="fec_doc_gar" readonly="readonly" name="fec_doc_gar" value="{{$cotizacion->fec_doc_gar}}" class="form-control">
            </div>
          </div>
           <div class="col-lg-3">
         <label>Documento Garantía</label>
         <select class="form-control selectpicker" disabled="disabled" data-show-subtext="true" data-live-search="true" name="tdocod_gar" >
        ...
        <div class="col-lg-2">
          <div class="form-group form-group-sm">
            ...
            <input  type="text" id="doc_gar" readonly="readonly" name="doc_gar" value="{{$cotizacion->doc_gar}}" class="form-control">
          </div>
        </div>
    ...
    <div class="box-body">
      ...
      <div class="row">
       <div class="col-lg-2 col-md-3 col-sm-12 col-xs-12">
            <div class="form-group form-group-sm">
              ...
              <select disabled="disabled" name="tdicod" id="tdicod" class="form-control">
      ...
      <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
        <div class="form-group form-group-sm">
          ...
          <input type="text"  name="clinum" id="clinum" readonly="readonly" value="{{$cotizacion->clinum}}" onKeypress="if(event.keyCode == 13) buscarcliente();" placeholder="" class="form-control" >
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
        <div class="form-group form-group-sm">
          ...
          <input type="text" name="clinom" id="clinom" readonly="readonly" value="{{$cotizacion->clinom}}" class="form-control">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="form-group form-group-sm">
          ...
          <input name="clidir" id="clidir" readonly="readonly" value="{{$cotizacion->clidir}}" class="form-control">
       ...
       <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="form-group form-group-sm">
          ...
          <input name="telefono" id="telefono" readonly="readonly" value="{{$cotizacion->telefono}}" class="form-control">
      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
        <div class="form-group form-group-sm">
          ...
          <input name="clicor" id="clicor" readonly="readonly" value="{{$cotizacion->clicor}}" class="form-control">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group form-group-sm">
                <label for="clicon">Contacto</label>
                 <input type="text" name="clicon" readonly="readonly" value="{{$cotizacion->clicon}}" class="form-control" placeholder="">
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
            <div class="form-group form-group-sm">
                ...
                <input type="text" name="clicontel" readonly="readonly" value="{{$cotizacion->clicontel}}" class="form-control" placeholder="">
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="form-group form-group-sm">
             ...
             @else
 					<textarea type="text" class="form-control" readonly="readonly" name="observaciones" rows="4">{{$cotizacion->observaciones}}</textarea> 
             @endif
            </div>
          </div>
    ...
    <div class="col-lg-12">
      <div class="form-group form-group-sm">
        ...
        <textarea type="text" name="obs_act" readonly="readonly" class="form-control" rows="4">{{$cotizacion->obs_act}}</textarea> 
      </div>
    </div>
    ...
    <div class="col-lg-12">
      <div class="form-group form-group-sm">
        <label>Observaci&oacute;n Entrega </label>
        <textarea type="text" name="obs_ent"  class="form-control" rows="4">{{$cotizacion->obs_ent}}</textarea> 
      </div>
    </div>
      ...
      <div class="row">
             ...
             <div class="col-lg-3">
              <button type="button" id="btnRegComp" class=" btn btn-block btn-primary btn-sm botones">Entregar</button><br>
            </div>
              <div class="col-lg-3">
              <a href="/ordeneselectro"><button type="button" class=" btn btn-block btn-danger btn-sm botones">SALIR</button></a><br>
            </div>
          </div>
