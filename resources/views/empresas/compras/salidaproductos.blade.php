      ...
      $('#menor').focus();
        ...
        $("#menor").keyup(function () {
                          ...
                          if ($('#detFact >tbody >tr').length > 0){
                              ...
                              $("#detFact tbody tr").each(function(){
                                 ...
                                 if( valor == codigo){
                                    ...
                                    totalitem = parseFloat($(this).find("td:eq(6) > input").val())*cantidad;
                                  ...
                                  if(cont >0){
                                      ...
                                      $(this).find("td:eq(8) > input").val(subtotalitem.toFixed(2));
                                      $(this).find("td:eq(9) > input").val(totalitem.toFixed(2));
                                      calculartotal();
                               ...
                               // alert(cont);
                                 if(cont == 0){
                                      ...
                                      var igvitem = data[0].propun -data[0].provun;
                                       ...
                                       $('#detFact').append('<tr><td><input  type="number"  step=".00001" id="cant" size="10" value="1" name="cant[]"   OnKeyUp="Calcular(this);" onKeypress="if(event.keyCode == 45) deleteRow(this);" class="cant form-control input-sm" />@if ($errors->has("cant"))<span class="help-block"><strong><font color="red">{{ $errors->first("cant") }}</font></strong></span>@endif</td><td><select style="width:100px" name="unid[]"  class="form-control input-sm"> @foreach($unidades as $und) @if($und->umecod == "UNI") <option  selected="selected" value="{{$und->umecod}}">{{$und->umenom}}</option> @else <option  value="{{$und->umecod}}">{{$und->umenom}}</option> @endif @endforeach </select></td><td><input type="text"  name="codpro[]" id="codpro" value="'+data[0].value+'" style="background-color:#ABEBC6"  onFocus="Calcular(this);" onBlur="Calcular(this);" onClick="Calcular(this);" onChange="Calcular(this);" OnKeyUp="Calcular(this)"; onKeypress="if(event.keyCode == 45) deleteRow(this);"  placeholder=""  class="codpro form-control input-sm"></td><td><input onkeypress="if (event.keyCode == 13) enviar_formulario();" class="detpro form-control input-sm" name="detpro[]" onFocus="Calcular(this);" onBlur="Calcular(this);" onClick="Calcular(this);" onChange="Calcular(this);" OnKeyUp="Calcular(this)"; value="'+data[0].pronom+'" id="detpro" size="100" onfocus="Calcular(this)"; ></td><td hidden="hidden"><select onChange="Calcular(this);" id="tigv" name="tigv[]" class="form-control input-sm">@foreach ($igv as $tigv)<option value="{{$tigv->tigcod}}">{{$tigv->tigdes}}</option>@endforeach</select></td><td hidden="hidden"><input type="number"  id="vunit" name="vunit[]" style="text-align:right;" value="'+data[0].provuncom+'" min="0"  readonly="readonly" class="vunit form-control input-sm" /></td><td ><input readonly="readonly" type="text" class="form-control input-sm propun" size="20px" id="propuncom" value="'+data[0].propuncom+'" onFocus="Calcular(this);" onBlur="Calcular(this);" onClick="Calcular(this);" onChange="Calcular(this);" OnKeyUp="Calcular(this)"; onKeypress="if(event.keyCode == 45) deleteRow(this);"  style="text-align:right;" name="propuncom[]"/></td><td hidden="hidden" ><input type="text"  class="form-control input-sm" size="20px" id="vigv" readonly value="0" style="text-align:right;" name="vigv[]"/></td><td hidden="hidden"><input type="text" class="form-control input-sm" size="20px" id="vsub" readonly value="0" style="text-align:right;" name="vsub[]"/></td><td><input type="text" readonly="readonly" value="'+data[0].propuncom+'" id="vtot" style="text-align:right;" name="vtot[]" class="form-control input-sm" /></td><td><input readonly="readonly" type="text" value="'+data[0].propun+'" id="propun" style="text-align:right;" name="propun[]" class="form-control input-sm" /></td><td><input readonly="readonly" type="text" value="'+data[0].preciosugerido+'" id="propunsug" style="text-align:right;" name="propunsug[]" class="form-control input-sm" /></td><td><input type="text" value="'+data[0].lote+'" id="lote" style="text-align:right;" readonly="readonly" name="lote[]" class="form-control input-sm" /></td></tr>');
                                    ...
                                    var igvitem = data[0].propun -data[0].provun;
                                     ...
                                     $('#detFact').append('<tr><td><input  type="number"  step=".00001" id="cant" size="10" value="1" name="cant[]"   OnKeyUp="Calcular(this);" onKeypress="if(event.keyCode == 45) deleteRow(this);" class="cant form-control input-sm" />@if ($errors->has("cant"))<span class="help-block"><strong><font color="red">{{ $errors->first("cant") }}</font></strong></span>@endif</td><td><select style="width:100px" name="unid[]"  class="form-control input-sm"> @foreach($unidades as $und) @if($und->umecod == "UNI") <option  selected="selected" value="{{$und->umecod}}">{{$und->umenom}}</option> @else <option  value="{{$und->umecod}}">{{$und->umenom}}</option> @endif @endforeach </select></td><td><input type="text"  name="codpro[]" id="codpro" value="'+data[0].value+'" style="background-color:#ABEBC6"  onFocus="Calcular(this);" onBlur="Calcular(this);" onClick="Calcular(this);" onChange="Calcular(this);" OnKeyUp="Calcular(this)"; onKeypress="if(event.keyCode == 45) deleteRow(this);"  placeholder=""  class="codpro form-control input-sm"></td><td><input onkeypress="if (event.keyCode == 13) enviar_formulario();" class="detpro form-control input-sm" name="detpro[]" onFocus="Calcular(this);" onBlur="Calcular(this);" onClick="Calcular(this);" onChange="Calcular(this);" OnKeyUp="Calcular(this)"; value="'+data[0].pronom+'" id="detpro" size="100" onfocus="Calcular(this)"; ></td><td hidden="hidden"><select onChange="Calcular(this);" id="tigv" name="tigv[]" class="form-control input-sm">@foreach ($igv as $tigv)<option value="{{$tigv->tigcod}}">{{$tigv->tigdes}}</option>@endforeach</select></td><td hidden="hidden"><input type="number"  id="vunit" name="vunit[]" style="text-align:right;" value="'+data[0].provuncom+'" min="0"  readonly="readonly" class="vunit form-control input-sm" /></td><td ><input readonly="readonly" type="text" class="form-control input-sm propun" size="20px" id="propuncom" value="'+data[0].propuncom+'" onFocus="Calcular(this);" onBlur="Calcular(this);" onClick="Calcular(this);" onChange="Calcular(this);" OnKeyUp="Calcular(this)"; onKeypress="if(event.keyCode == 45) deleteRow(this);"  style="text-align:right;" name="propuncom[]"/></td><td hidden="hidden" ><input type="text"  class="form-control input-sm" size="20px" id="vigv" readonly value="0" style="text-align:right;" name="vigv[]"/></td><td hidden="hidden"><input type="text" class="form-control input-sm" size="20px" id="vsub" readonly value="0" style="text-align:right;" name="vsub[]"/></td><td><input type="text" readonly value="'+data[0].propuncom+'" id="vtot" style="text-align:right;" name="vtot[]" class="form-control input-sm" /></td><td><input readonly="readonly" type="text" value="'+data[0].propun+'" id="propun" style="text-align:right;" name="propun[]" class="form-control input-sm" /></td><td><input readonly="readonly" type="text" value="'+data[0].preciosugerido+'" id="propunsug" style="text-align:right;" name="propunsug[]" class="form-control input-sm" /></td><td><input type="text" value="'+data[0].lote+'" id="lote" style="text-align:right;" readonly="readonly" name="lote[]" class="form-control input-sm" /></td></tr>');
                                }
          ...
          $('.codpro').on('change',function () {
               ...
               $(".codpro").autocomplete({
                  source: '{!!URL::route('consultargasto')!!}',
                  dataType: "json",
                  minLength: 2,
                  autoFocus:true,
                  select: function(event,ui) {
				 ...
				 $(".detpro").autocomplete({
                  ...
                  select: function(event,ui) {   
                     ...
                     $(this).closest('tr').find("td:eq(5) > input").val('0');
                     $(this).closest('tr').find("td:eq(6) > input").val('0');
                      $(this).closest('tr').find("td:eq(10) > input").val(ui.item.propun);
                     $(this).closest('tr').find("td:eq(11) > input").val(ui.item.preciosugerido);
           $(this).closest('tr').find("td:eq(9) > input").val(ui.item.propun);
                     $(this).closest('tr').find("td:eq(1) > select").val(ui.item.umecod).attr('selected', 'selected');
                     $(this).closest('tr').find("td:eq(2) > input").prop("readonly",true);
                     $(this).closest('tr').find("td:eq(3) > input").prop("readonly",false);
...
function agregarlinea(){
            ...
            $('#detFact').append('<tr><td><input  type="number"  step=".00001" id="cant" size="10" value="1" name="cant[]"   OnKeyUp="Calcular(this);" onKeypress="if(event.keyCode == 45) deleteRow(this);" class="cant form-control input-sm" />@if ($errors->has("cant"))<span class="help-block"><strong><font color="red">{{ $errors->first("cant") }}</font></strong></span>@endif</td><td><select style="width:100px" name="unid[]"  class="form-control input-sm"> @foreach($unidades as $und) @if($und->umecod == "UNI") <option  selected="selected" value="{{$und->umecod}}">{{$und->umenom}}</option> @else <option  value="{{$und->umecod}}">{{$und->umenom}}</option> @endif @endforeach </select></td><td><input type="text"  name="codpro[]" id="codpro" style="background-color:#ABEBC6"  onFocus="Calcular(this);" onBlur="Calcular(this);" onClick="Calcular(this);" onChange="Calcular(this);" OnKeyUp="Calcular(this)"; onKeypress="if(event.keyCode == 45) deleteRow(this);"  placeholder=""  class="codpro form-control input-sm"></td><td><input onkeypress="if (event.keyCode == 13) enviar_formulario();" class="detpro form-control input-sm" name="detpro[]" onFocus="Calcular(this);" onBlur="Calcular(this);" onClick="Calcular(this);" onChange="Calcular(this);" OnKeyUp="Calcular(this)"; value="" id="detpro" size="100" onfocus="Calcular(this)"; ></td><td hidden="hidden"><select onChange="Calcular(this);" id="tigv" name="tigv[]" class="form-control input-sm">@foreach ($igv as $tigv)<option value="{{$tigv->tigcod}}">{{$tigv->tigdes}}</option>@endforeach</select></td><td hidden="hidden"><input type="number"  id="vunit" name="vunit[]" style="text-align:right;" value="0" min="0"  readonly="readonly" class="vunit form-control input-sm" /></td><td ><input type="text" class="form-control input-sm propun" size="20px" id="propuncom" value="0" onFocus="Calcular(this);" onBlur="Calcular(this);" onClick="Calcular(this);" onChange="Calcular(this);" OnKeyUp="Calcular(this)"; onKeypress="if(event.keyCode == 45) deleteRow(this);"  style="text-align:right;" name="propuncom[]"/>@if ($errors->has("vigv"))<span class="help-block"><strong><font color="red">{{ $errors->first("vigv") }}</font></strong></span>@endif</td><td hidden="hidden" ><input type="text"  class="form-control input-sm" size="20px" id="vigv" readonly value="0" style="text-align:right;" name="vigv[]"/></td><td hidden="hidden"><input type="text" class="form-control input-sm" size="20px" id="vsub" readonly value="0" style="text-align:right;" name="vsub[]"/></td><td><input type="text" readonly value="0" id="vtot" style="text-align:right;" name="vtot[]" class="form-control input-sm" /></td><td><input type="text" value="0" id="propun" style="text-align:right;" name="propun[]" class="form-control input-sm" /></td><td><input type="text" value="0" id="propunsug" style="text-align:right;" name="propunsug[]" class="form-control input-sm" /></td><td><input type="text" value="0" id="lote" style="text-align:right;" name="lote[]" class="form-control input-sm" /></td><td><button type="button" onClick="deleteRow(this);" class="btn btn-danger btn-sm remove"><span class="glyphicon glyphicon-minus"></span></button></td></tr>');
...
function calculardescuento(){
  ...
  $('#totdesc').val(totdesc.toFixed(2));
        ...
        <div class="col-lg-12">
            <div class="btn-toolbar" role="toolbar" aria-label="...">
                <div class="btn-group" >
                        ...
                        <a href="/compras"><button type="button"  class=" btn btn-success btn-sm"><span class="glyphicon glyphicon-search"></span> Consultar Comprobantes</button></a>
                </div>
               	<div class="btn-group" >
	
				<a href="/compras/create"><button type="button"  class=" btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Nuevo Registro</button></a>
		</div>
    ...
    {!!Form::open(array('url'=>'/salidasproductos','autocomplete'=>'off','method'=>'POST','id'=>'formfact','role'=>'form','files'=>'true'))!!}
    {{Form::token()}}
        ...
        <div class="container-fluid detalle">
            <div class="row">
                    ...
                    <div  class="panel-body">
                       <div class="row">
                        <div class="col-lg-2">
                            ...
                            <input name="menor" id="menor" value="" class="form-control input-sm">
                        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <a href="{{config('global.ruta')}}/compras"><button type="button" class="btn btn-danger"><strong>CANCELAR</strong></button></a>
                </div>
