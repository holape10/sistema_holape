             ...
             <div class="col-lg-12">
                 <div class="box box-info">
                    <div class="box-header" style="background-color:blue;">
                        <font color="white" ><center><strong>REGISTRAR NOTA CREDITO COMPRA</strong></center></font>
                    ...
                    <div class="row">
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" id="divfecVen">
                            <div class="form-group form-group-sm">
                              <label>Fecha</label>
                              <input type="date" name="fec_ref" id="fec_ref" value=""  class="form-control"> 
                            </div>
                          </div>
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" id="divfecVen">
                            <div class="form-group form-group-sm">
                              <label>Serie</label>
                              <input type="text" name="serie_ref" id="serie_ref" value=""  class="form-control"> 
                            </div>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" id="divfecVen">
                            <div class="form-group form-group-sm">
                              <label>N&uacute;mero</label>
                              <input type="text" name="num_ref" id="num_ref" value=""  class="form-control"> 
                            </div>
                          </div>
