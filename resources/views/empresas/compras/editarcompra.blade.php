      ...
      $("#buscardescripcion").keyup(function() {
        ...
        if(contarcarateres >0){
          ...
          $.ajax({
            type: "GET",
            dataType: 'json',
            url: "/busquedaproductocompra/"+val+"/"+sucursal,
...
function mostrar(comp){
  ...
  $.ajax({
    type: "GET",
    dataType: 'json',
    url: "/consultarmenucompra/"+val+"/"+sucursal,
                 ...
                 <div class="box box-info">
                    ...
                    <div  class="panel-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-1">
                            <div class="form-group form-group-sm">
                              <label>O.C</label>
                              <input readonly="readonly" class="form-control" type="text" value="{{$cabecera->com_doc_ser}}-{{$cabecera->com_doc_num}}">
                              <input type="hidden" name="ser_oc" value="{{$cabecera->com_doc_ser}}">
                              <input type="hidden" name="num_oc" value="{{$cabecera->com_doc_num}}">
                            </div>
                          </div>
                          <div class="col-lg-2">
                            <div class="form-group form-group-sm">
                    ...
                    <div class="form-group form-group-sm">
                        <select style=" font-weight: bold;" class="form-control selectpicker input-sm" onkeypress="if(event.keyCode == 13) agregaritem();" onchange="agregaritem();" data-show-subtext="true" data-live-search="true" name="producto" id="producto">
                          ...
                          <option style="font-weight:bold;color:black;font-size:14pt;" value="{{$pro->IdProducto}}" data-idproducto="{{$pro->IdProducto}}" data-pronom="{{$pro->pronom}}" data-marca="{{$pro->marca}}" data-propun="{{$pro->costo}}" data-presentacion="{{$pro->cont_pre}}">{{$pro->pronom}} {{$pro->marca}} | PRECIO:{{$pro->costo}} |Stock: {{$pro->stock}}</option>
                          @endforeach
                     </select>
                    </div>
                      ...
                      <div class="row">
                         <table id="detFact" class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td width='900px'>
                                  <input type='text' class='form-control' name='detpro[]' value='{{$det->pronom}}' readonly='readonly'>
                                </td>
                                <td> 
                                ...
                                <td>
                                  <input type='text' class='form-control' name='vtot[]'  value='{{$det->total}}' onkeyup='CalcularItem(this);' style='width:80px'>
                                </td>
                                <td hidden='hidden'>
