  ...
  $(tr).each(function(){
      ...
      var presigv=0;
        ...
        if(gravado=='1'){
          ...
          total = parseFloat($(this).find("td:eq(2) > input").val()) * parseFloat($(this).find("td:eq(6) > input").val());
          precsigv = parseFloat($(this).find("td:eq(6) > input").val())/1.1055;

        }else{

          total = parseFloat($(this).find("td:eq(2) > input").val() * $(this).find("td:eq(6) > input").val());
          precsigv = parseFloat($(this).find("td:eq(6) > input").val());
        ...
        $(this).find("td:eq(5) > input").val(precsigv.toFixed(2));
  ...
  $(tr).each(function(){
      ...
      var precigv=0;
        if(gravado=='1'){
          ...
          precigv = parseFloat($(this).find("td:eq(5) > input").val()*1.18);
          $(this).find("td:eq(6) > input").val(precigv.toFixed(2));
          total = $(this).find("td:eq(2) > input").val() * $(this).find("td:eq(6) > input").val();
          
        }else{

          precigv = parseFloat($(this).find("td:eq(5) > input").val());
          $(this).find("td:eq(6) > input").val(precigv.toFixed(2));
          total = $(this).find("td:eq(2) > input").val() * $(this).find("td:eq(6) > input").val();
...
function CalcularItem(ele) {
  ...
  totitemgrav = $(this).find("td:eq(8) > input").val() / $(this).find("td:eq(2) > input").val();

      if(gravado=='1'){
          
           total = parseFloat($(this).find("td:eq(8) > input").val())/1.1055;

          $(this).find("td:eq(6) > input").val(totitemgrav.toFixed(2));
           $(this).find("td:eq(7) > input").val(total.toFixed(2));
          $(this).find("td:eq(5) > input").val((totitemgrav/1.1055).toFixed(2));
      }else{
...
function CalcularSubTotal(ele) {
  ...
  $(tr).each(function() {
    ...
    var  totitemgrav=0,total=0;
    totitemgrav = $(this).find("td:eq(7) > input").val() / $(this).find("td:eq(2) > input").val();

      if(gravado=='1'){
          
          total = parseFloat($(this).find("td:eq(7) > input").val())*1.18;

          $(this).find("td:eq(5) > input").val(totitemgrav.toFixed(2));
          $(this).find("td:eq(8) > input").val(total.toFixed(2));
          $(this).find("td:eq(6) > input").val((totitemgrav*1.18).toFixed(2));
      }else{
           total = parseFloat($(this).find("td:eq(7) > input").val());
            $(this).find("td:eq(6) > input").val(totitemgrav.toFixed(2));
             $(this).find("td:eq(8) > input").val(total.toFixed(2));
          $(this).find("td:eq(5) > input").val(totitemgrav.toFixed(2));
      } 
  ...
  function agregaritem(){
    ...
    if(gravado=='1'){
      ...
      subtotal=costo;
         ...
         $('#detFact').append("<tr><td><input style='width:100px' type='text' class='form-control input-sm' name='codigo[]' value='"+codigo+"' readonly='readonly'></td><td width='900px'><input type='text' class='form-control input-sm' name='detpro[]' value='"+producto+"' readonly='readonly'></td><td> <input type='number' step='any' min='0' value='"+cantidad+"' name='cant[]' onkeyup='Calcular(this);' onchange='Calcular(this);' class='form-control input-sm ' id='font-size' style='width:60px'> </td><td hidden='hidden'><select style='width:100px' name='unid[]'  class='form-control input-sm'> @foreach($unidades as $und) @if($und->umecod == 'UNI') <option  selected='selected' value='{{$und->umecod}}'>{{$und->umenom}}</option> @else <option  value='{{$und->umecod}}'>{{$und->umenom}}</option> @endif @endforeach </select></td><td hidden='hidden'><input type='text' class='form-control' name='provun[]'  value='' readonly='readonly' style='width:130px' ></td><td><input  type='number' step='any' min='0' class='form-control input-sm' name=costosigv[]' onChange='CalcularSinIgv(this);'  onkeyup='CalcularSinIgv(this);' value='"+precsigv+"' style='background-color:#9ACD32;;width:60px;' ></td><td><input style='background-color:#F0E68C;;width:60px;'  type='number' step='any' min='0' class='form-control input-sm' name=preuni[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='"+costo+"' style='width:80px' ></td><td><input type='text' class='form-control input-sm' name='subtot[]'  value='"+subtotal+"' style='background-color:#9ACD32;;width:60px;' onkeyup='CalcularSubTotal(this);' style='width:80px'></td><td><input type='text' style='background-color:#F0E68C;width:60px' class='form-control input-sm' name='vtot[]'  value='"+total+"' onkeyup='CalcularItem(this);' style='width:80px'></td><td><input  type='number' step='any' min='0' class='form-control input-sm' name=flete[]' onChange='Calcular_flete(this);'  onkeyup='Calcular_flete(this);' value='0' style='width:80px' ></td><td><input  type='number' step='any' min='0' class='form-control input-sm' name=fleteund[]' readonly='readonly' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='0' style='width:80px' ></td><td><input  type='number' step='any' min='0' class='form-control input-sm' name=preciocosto[]' readonly='readonly' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='"+total+"' style='width:80px' ></td><td hidden='hidden'><input type='text' class='form-control' name='pro_id[]'  value='"+proid+"' readonly='readonly' style='width:130px' ></td><td style='width:100px;'><input class='form-control input-sm' type='text' name='lote[]'></td><td><input class='form-control input-sm' type='date' name='vencimiento[]'></td><td ><select class='form-control input-sm' name='laboratorio[]'><option></option>@foreach($laboratorios as $lab) @if($lab->lab_id=='"+laboratorio+"') <option selected='selected' value='{{$lab->lab_id}}'>{{$lab->lab_nom}} </option> @else <option  value='{{$lab->lab_id}}'>{{$lab->lab_nom}} </option> @endif  @endforeach</select></td><td hidden=='hidden'><button type='button' id='"+proid+"' onclick='costeo(this)'   class='btncosteo btn btn-primary btn-sm btn-block'>COSTEO</button></td><td hidden='hidden'><select name='id_almacen_pro[]' class='form-contro input-sm'>@foreach($almacenes as $almacen) @if($almacen->id_almacen=='"+id_almacen_pro+"') <option selected='selected' value='{{$almacen->id_almacen}}'>{{$almacen->descripcion}}</option> @else <option value='{{$almacen->id_almacen}}'>{{$almacen->descripcion}}</option> @endif @endforeach</select></td><td><button type='button' onClick='deleteRow(this);' class='btn btn-danger btn-sm remove'><span class='glyphicon glyphicon-minus'></span></button></td></tr>");
           $("#can_producto").val('1');
   ...
   var inc_igv = $("#inc_igv").val();
    ...
    $("#detFact tbody tr").each(function(){
      ...
      if(gravado=='1'){
        ...
        subtot = subtot + parseFloat($(this).find("td:eq(8)  > input").val()/1.1055);
        igv = totgrav - subtot;
      }else{
        totgrav = totgrav + parseFloat($(this).find("td:eq(8)  > input").val());
        subtot = subtot + parseFloat($(this).find("td:eq(8)  > input").val());
        igv = totgrav - subtot;
      }
...
function Calcular_flete(ele) {
  ...
  $(tr).each(function() {
      ...
      total = $(this).find("td:eq(9) > input").val()/$(this).find("td:eq(2) > input").val();
 
      $(this).find("td:eq(10) > input").val(total.toFixed(2));

      precio_costo = parseFloat($(this).find("td:eq(6) > input").val())+parseFloat($(this).find("td:eq(10) > input").val());


      $(this).find("td:eq(11) > input").val(precio_costo.toFixed(2));
             ...
             <div class="col-lg-12">
                 <div class="box box-info">
                    <div class="box-header" style="background-color:blue;">
                        <font color="white" ><center><strong>GENERAR NOTA CREDITO COMPRA</strong></center></font>
                    ...
                    <div  class="panel-body">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-2">
                            ...
                            <div class="col-lg-3">
                         <div class="form-group form-group-sm">
                              <label>MERCADER&Iacute;A EN TRANSITO</label>
                       ...
                       <div  class="col-lg-2">
                        ...
                        <div class="row">
                          <div class="col-lg-2">
                              <div class="form-group form-group-sm">
                                  <LABEL>T/Doc Sustentatorio</LABEL>
                                  <select name="tdocod_ref" id="tdocod_ref" class="form-control"  onchange="calculartotal();">
                                    <option></option>
                                    @foreach($doccomprobante as $tdn)
                                      @if($tdn->tdocod == $cabecera->tdocod_ref)
                                        <option selected="selected" value="{{$tdn->tdocod}}">{{$tdn->tdodes}}</option>
                                      @else
                                         <option value="{{$tdn->tdocod}}">{{$tdn->tdodes}}</option>
                                      @endif
                                    @endforeach
                            ...
                            <div class="col-lg-2">
                              <div class="form-group form-group-sm">
                                  ...
                                  <select name="nccod" id="nccod" class="form-control" >
                                    <option></option>
                                    @foreach($tipos_notas as $tnc)
                                      @if($tnc->nccod == $cabecera->nccod)
                                        <option selected="selected" value="{{$tnc->nccod}}">{{$tnc->ncdes}}</option>
                                      @else
                                         <option value="{{$tnc->nccod}}">{{$tnc->ncdes}}</option>
                                      @endif
                                    @endforeach
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" id="divfecVen">
                            <div class="form-group form-group-sm">
                              <label>Fecha</label>
                              <input type="date" name="fec_ref" id="fec_ref" value="{{$cabecera->fec_ref}}"  class="form-control"> 
                            </div>
                          </div>
                          ...
                          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" id="divfecVen">
                            <div class="form-group form-group-sm">
                              <label>Serie</label>
                              <input type="text" name="serie_ref" id="serie_ref" value="{{$cabecera->serie_ref}}"  class="form-control"> 
                            </div>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" id="divfecVen">
                            <div class="form-group form-group-sm">
                              <label>N&uacute;mero</label>
                              <input type="text" name="num_ref" id="num_ref" value="{{$cabecera->num_ref}}"  class="form-control"> 
                            </div>
                          </div>
                         ...
                         <table id="detFact" class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td ><select class='form-control input-sm' name='laboratorio[]'>
                                  <option></option>
                                  @foreach($laboratorios as $lab) 
                                    @if($lab->lab_id== $det->lab_id) 
