           ...
           if(data[0].contar =='1'){
             ...
             if ($('#detFact >tbody >tr').length > 0){
              ...
              $("#detFact tbody tr").each(function(){
               var codigo = $(this).find("td:eq(7) > input").val();
              ...
              if(cont >0){
                ...
                $(this).find("td:eq(4) > input").val(presigv.toFixed(2));

                $(this).find("td:eq(6) > input").val(totalitem.toFixed(2));
                calculartotal();
            ...
            if(e.keyCode == 43) {
                ...
                $(".detpro").autocomplete({
                  ...
                  select: function(event,ui) {   
                    ...
                    $(this).closest('tr').find("td:eq(5) > input").val(ui.item.propun);
                    $(this).closest('tr').find("td:eq(2) > input").val(ui.item.pro_id);
                    $(this).closest('tr').find("td:eq(2) > input").prop("readonly",true);
                    $(this).closest('tr').find("td:eq(5) > input").prop("readonly",true);
                    $(this).closest('tr').find("td:eq(6) > input").val(ui.item.propun*$(this).closest('tr').find("td:eq(1) > input").val());
...
function validaralfanumerico(){
    ...
    if ($('#detFact >tbody >tr').length == 0){
     $('#detFact >tbody >tr').each(function(){
        ...
        serdr = $(this).find("td:eq(2) > input").val();
...
function validarexistente(){
    ...
    var tempser,tempnum,tempdocr;
     ...
     if ($('#detFact >tbody >tr').length == 0){
     $('#detFact >tbody >tr').each(function(){
        var docr = $(this).find("td:eq(1) > select").val();
        var ser = $(this).find("td:eq(2) > input").val();
             ...
             <div class="col-lg-12">
                 <div class="box box-info">
                    <div class="box-header" style="background-color:#337ab7;">
                        <font color="white" ><center><strong>REGISTRAR NUEVA COMPRA</strong></center></font>
                    ...
                    <div  class="panel-body">
                        ...
                        <div class="row">
                         ...
                         <div class="col-lg-2" hidden='hidden'>
                            <div class="form-group form-group-sm">
                              ...
                              <select class="form-control" name="sucursal" id="sucursal">
                                @foreach($negocios as $negocio)
                                  @if($negocio->id_empresa_negocio == $sucursal->id_empresa_negocio)
                            ...
                            <div class="col-lg-2" id="divalmacen" hidden='hidden'>
                            <div class="form-group form-group-sm">
                       ...
                       <div class="col-lg-2" hidden='hidden'>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" hidden='hidden'>
                            <div class="form-group form-group-sm">
                              ...
                              <input type="text"  id="orden_compra" name="orden_compra"  class="form-control" >      
                            </div>
                        </div>
                        ...
                        <div class="col-lg-1 col-md-2 col-sm-12 col-xs-12">
                            <div class="form-group form-group-sm">
                                      <label>T.C.</label>
                                      <input type="number"  id="tip_cam" name="tip_cam"  class="form-control" > 
                            </div>
                        </div>
                         ...
                         <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                          ...
                          <div hidden="hidden" class="col-lg-2">
                              <div class="form-group form-group-sm">
                                  ...
                                  <select name="gravado" id="gravado" class="form-control"  onchange="calculartotal();">
                    ...
                    <div  class="panel-body">
                        ...
                        <div  class="col-lg-3 col-md-2 col-sm-12 col-xs-12" hidden='hidden'>
                            <div class="form-group form-group-sm">
                      ...
                      <div class="row">
                         ...
                         <div class="col-lg-1 col-md-2 col-sm-3 col-xs-3 form-group form-group-sm">
                             <label>Subtotal</label>
                              <input class="form-control input-sm" type="number" min="0"  step="any" min="1" style="text-align:right;" id="subtotal" name="subtotal" value='0.00' readonly="readonly">
                        </div>

                         <div class="col-lg-1 col-md-2 col-sm-3 col-xs-3 form-group form-group-sm">
                             <label>Gravada</label>
                              <input class="form-control input-sm" type="number" min="0"  step="any" min="1" style="text-align:right;" id="gravada" name="gravada" value='0.00' readonly="readonly">
                        </div>
                         <div class="col-lg-1 col-md-2 col-sm-3 col-xs-3 form-group form-group-sm">
                             <label>Exonerada</label>
                              <input class="form-control input-sm" type="number" min="0"  step="any" min="1" style="text-align:right;" id="exonerada" name="exonerada" value='0.00' readonly="readonly">
                        </div>
                         <div class="col-lg-1 col-md-2 col-sm-3 col-xs-3 form-group form-group-sm">
                             <label>Inafecta</label>
                              <input class="form-control input-sm" type="number" min="0"  step="any" min="1" style="text-align:right;" id="inafecta" name="inafecta" value='0.00' readonly="readonly">
                        </div>
                         <div class="col-lg-1 col-md-2 col-sm-3 col-xs-3 form-group form-group-sm">
                             <label>IGV</label>
                              <input class="form-control input-sm" type="number" min="0"  step="any" min="1" style="text-align:right;" id="igv" name="igv" value='0.00' readonly="readonly">
                        </div>

                         <div class="col-lg-1 col-md-2 col-sm-3 col-xs-3 form-group form-group-sm">
                             <label>Total</label>
                              <input class="form-control input-sm" type="number" min="0"  step="any" min="1" style="text-align:right;" id="total" name="total" value='0.00' readonly="readonly">
                        </div>
