          ...
          $('.codpro').on('change',function () {
               ...
               $(".codpro").autocomplete({
                  ...
                  select: function(event,ui) {   
                     ...
                     $(this).closest('tr').find("td:eq(5) > input").val(ui.item.provunmin);
                     $(this).closest('tr').find("td:eq(6) > input").val(ui.item.propunmin);
                     $(this).closest('tr').find("td:eq(10) > input").val(ui.item.provunmay);
