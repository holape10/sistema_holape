        ...
        $('.detalle').keypress(function(e) {
          ...
          $('.codpro').on('change',function () {
               ...
               $(".codpro").autocomplete({
                ...
                $(".detpro").autocomplete({
                  source: '{!!URL::route('consultarinsumonomsinstock')!!}',
                  dataType: "json",
                  minLength: 2,
                  autoFocus:true,
                  select: function(event,ui) {   
                    ...
                    <div class="panel-body">
                     ...
                     <div  class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="form-group form-group-sm">
                                <label for="cmbCatId">TIPO MOVIMIENTO</label>
                      ...
                      <input type='hidden' name='tipoinsumo' value='insumo'>
                       ...
                       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                          <div class="form-group form-group-sm">
                              <label for="cmbDist">Distribuidor</label>
                              <select class="form-control input-sm"  name="cmbDist" id="cmbDist">
                                  @foreach($distribuidor as $ds)
                                      <option value="{{$ds->IdDistribuidor}}">{{$ds->NomDistribuidor}}</option>
                                  @endforeach
                              </select>
                            ...
                            <tbody id="">
                                <tr>
                                  ...
                                  <td>
                                   ...
                                   <td hidden="hidden">
                                        <input type="text"  name="presentacion[]" id="presentacion" placeholder="" value="" class="pro_id form-control input-sm">
                                    </td>
                                 <td>
                                  ...
                                  <td>
                                   ...
                                   <td>
                                    <input type="text"  name="totalfactura[]" id="totalfactura" class="codpro form-control input-sm">
                                  </td>
