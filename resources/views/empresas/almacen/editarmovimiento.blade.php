 ...
 <div class="box-body" >
   <div class="row form-group form-group-sm">
	...
	@endif
        ...
        <input type="hidden" readonly="readonly" name="clinom" id="clinom" value="{{$movimiento->nomcliente}}">
      </div>
    </div>
    ...
    <div class="col-lg-4">
      <div class="form-group form-group-sm">
        ...
        <input name="clidir" id="clidir" value="{{$movimiento->direccionllegada}}" class="form-control">
      </div>
    </div>
       ...
       <table class="table table-hover" id="grdet">
        ...
        <tbody>
			@foreach($detalle as $det)
				<tr>
					<td width='900px'><input type='text' class='form-control input-sm' name='pronom[]' value='{{$det->pronom}}'></td>
					<td> <input type='number' step='any' min='0' value='{{$det->cantidad}}' name='cant[]' onkeyup='Calcular(this);' onchange='Calcular(this);' class='form-control input-sm ' id='font-size' style='width:70px'> </td>
					...
					<td hidden='hidden'><input readonly='readonly' type='text' class='form-control' name='itemtotal[]'  value='"+precio+"' onkeyup='CalcularItem(this);' style='width:80px' ></td>
