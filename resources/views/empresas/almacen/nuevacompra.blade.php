...
function calculardescuento(){
  ...
  $('#totdesc').val(totdesc.toFixed(2));
    ...
    {!!Form::open(array('url'=>'/SisFact','autocomplete'=>'off','method'=>'POST','id'=>'formfact','role'=>'form','files'=>'true'))!!}
    {{Form::token()}}
        ...
        <div class="container-fluid detalle">
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <button type="submit" id="btn" name="btn"  class="btn btn-primary"><strong>REGISTRAR FACTURA</strong></button>
