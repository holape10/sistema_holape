...
function agregaritem_pre(button){
  ...
  function agregaritem(){
    ...
    var total = cantidad*costo;
        ...
        $('#grdet').append("<tr><td width='50px'><input type='text' class='form-control input-sm' name='codigo[]' value='"+codigo+"' readonly='readonly'></td><td width='900px'><input type='text' class='form-control input-sm' name='detpro[]' value='"+producto+"' readonly='readonly'></td><td> <input type='number' step='any' min='0' value='"+cantidad+"' name='cant[]' onkeyup='Calcular(this);' onchange='Calcular(this);' class='form-control input-sm ' id='font-size' style='width:60px'> </td><td style='display:none;'><select style='width:100px' name='unid[]'  class='form-control input-sm'> @foreach($unidades as $und) @if($und->umecod == 'UNI') <option  selected='selected' value='{{$und->umecod}}'>{{$und->umenom}}</option> @else <option  value='{{$und->umecod}}'>{{$und->umenom}}</option> @endif @endforeach </select></td><td style='display:none;'><input type='text' class='form-control' name='provun[]'  value='' readonly='readonly' style='width:130px' ></td><td style='display:none;'><input  type='number' step='any' min='0' class='form-control input-sm' name=preuni[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='"+costo+"' style='width:80px' ></td><td style='display:none;'><input type='text' class='form-control input-sm' name='vtot[]'  value='"+total+"' onkeyup='CalcularItem(this);' style='width:80px' ></td><td style='display:none;'><input type='text' class='form-control' name='proid[]'  value='"+proid+"' readonly='readonly' style='width:130px' ></td><td><button type='button' onClick='deleteRow(this);' class='btn btn-danger btn-sm remove'><span class='glyphicon glyphicon-minus'></span></button></td></tr>");
