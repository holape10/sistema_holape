...
function agregaritem_pre(button){
  ...
  $('#grdet').append("<tr>"+
    ...
    "<td hidden='hidden'><input  type='number' step='any' min='0' class='form-control input-sm' name=preuni[]' onChange='Calcular(this);'  onkeyup='Calcular(this);' value='"+precio+"' style='width:80px' ></td>"+
    "<td hidden='hidden'><input type='text' class='form-control input-sm' name='vtot[]'  value='"+total+"' onkeyup='CalcularItem(this);' style='width:80px' ></td>"+
    "<td hidden='hidden'><input type='text' class='form-control' name='proid[]'  value='"+proid+"' readonly='readonly' style='width:130px' ></td>"+
...
<div class="row">
  <div class="col-lg-12">
    <div class="box">
     <div class="box-header" style="background-color:#337ab7;">
       <font color="white"><strong><center>DETALLE - BUSCAR PRODUCTOS</center></strong></font>
     </div>
     ...
     <div class="box-body">
      ...
      <div class="box-footer">
       ...
       <div class="col-lg-2">
        <button type="button" id="btnRegCompReg" class=" btn btn-block btn-primary btn-md botones">REGISTRAR</button><br>
      </div>
      <div class="col-lg-2">
        <a href="/almacen"><button type="button" class=" btn btn-block btn-danger btn-md botones">SALIR</button></a><br>
      </div>
    </div>
     <div class="row">           
