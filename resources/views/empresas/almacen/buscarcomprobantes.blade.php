...
<div class="row">
	...
	<div class="col-lg-5">
		<div class="form-group">
			...
			{!!Form::text('searchText',null,['class'=>'form-control input-sm','id'=>'searchText']);!!}
		</div>
	</div>
</div>
<div class="row">
	<div class="col-lg-12">
		...
		<div class="btn-group" >
			<a href="/ingreso/almacen"><button type="button"  class=" btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Ingreso Productos</button></a>
		</div>
	</div>
	</div>
	<div class="col-lg-2">
