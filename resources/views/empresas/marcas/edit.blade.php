...
@section ('contenido')
    ...
    {!!Form::model($marcas,['method'=>'PATCH','route'=>['marcas.update',$marcas->mar_id],'files'=>'true'])!!}
    {{Form::token()}}
     <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
            <div class="form-group form-group-sm">
                ...
                <input type="text" name="mar_nom" value="{{$marcas->mar_nom}}" class="form-control" placeholder="">
