<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-maquinas-{{$pro->proc_comp_id}}">
	   {!!Form::open(array('url'=>'/actualizarmaquinas','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
    {{Form::token()}}
