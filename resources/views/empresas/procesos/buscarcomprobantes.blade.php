...
{!! Form::model(Request::all(),['Route'=>'/operaciones','method'=>'GET','autocomplete'=>'off'])!!}
...
<div class="row">
	...
	<div class="col-lg-2">
		<div class="form-group-sm form-group-sm">
			<label>SERVICIOS</label>
			<select class="form-control" name="servicio">
				@foreach($servicios as $servicio)
				  <option value="{{$servicio->proc_id}}">{{$servicio->proc_nom}}</option>
				@endforeach
			</select>
		</div>
	</div>
	<div class="col-lg-2">
		<div class="form-group form-group-sm">
			...
			<input type="date" name="fec_ini" class="form-control" value="{{$fec_ini}}">
	...
	<div class="col-lg-2">
		<div class="form-group form-group-sm">
		 	...
		 	<input type="date" name="fec_fin" class="form-control" value="{{$fec_fin}}">
