<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-baja-{{$comp->IdCpe_cabecera}}">
	    ...
	    {{Form::token()}}
			<div class="modal-content">
				...
				<div class="modal-body">
						  ...
						  <strong>Alerta!</strong> LA ANULACIÓN DEL COMPROBANTE SE DEBE REALIZAR ANTES DE ENVIAR A SUNAT.
						</div>
					...
					<div class="row">
				    	<div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
				    		<div class="form-group form-group-sm">
						        ...
						        <input type="text" id="motivo{{$comp->IdCpe_cabecera}}" value="ERROR DE DIGITACION" class="form-control input-sm" placeholder="">
