      ...
      <div class="col-lg-12">
        <div class="panel panel-default">
          <div class="panel-heading">
            <cetner><font><strong>COMUNICACION DE BAJA</strong></font></cetner>
          </div>
            ...
            <div class="row">
              <!--<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <div class="form-group form-group-sm">
                  <label>Número</label>
                  <input type="text"  name="numbaj" id="numbaj" value="" class="form-control" readonly="readonly">
                </div>
              </div>-->
              <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                <div class="form-group form-group-sm">
          ...
          <div class="panel-body">
             ...
             <table id="detbaja" class="table">
                ...
                <tbody>
                	<tr>
                		<td>
                			<input type="text"  name="serdocbaja" id="serdocbaja" value="{{$cabecera->serdoc}}-{{$cabecera->numdoc}}" placeholder="" class="serdocbaja form-control" readonly="readonly">
                		</td>
                		<td>
                			<input type="date"  name="fecemi" id="fecemi" value="{{Carbon::parse($cabecera->ccafem)->format('Y-m-d')}}"  class="form-control" readonly="readonly">
                		</td>
                		<td>
                			<input name="tdomod" id="tdomod" value="{{$cabecera->tdodes}}" class="form-control" readonly="readonly">
                		</td>
                		<td>
                			<input class="obser form-control"  name="obser" id="obser">
                		</td>
                    <td>
                      <input class="monom form-control"  name="monnom" id="monnom"  value="{{$cabecera->monnom}}" readonly="readonly">
                    </td>
                    <td>
                      <input type="number" class="ccaitv form-control"  name="ccaitv" id="ccaitv" value="{{$cabecera->ccaitv}}" readonly="readonly">
                      <input type="hidden" name="comprobante" value="{{$cabecera->IdCpe_cabecera}}">
                    </td>
                </tr>
                </tbody>
              </table>
