        	...
        	<div class="col-xs-12">
          		<div class="box">
          			<div class="box-header" style="background:blue;">
          				<font color="white"><center><STRONG>HISTORIAL ORDENES DE SERVICIOS</STRONG></center></font>
          			</div>
	            	<div class="box-body">
	            		@include('empresas.comprobantes.buscarordenesclientes')
	            	</div>
	            </div>
	        </div>
	</div> 
	            	...
	            	<div class="box-body">
							...
							<thead>
								...
								<tr>
									...
									<th style="background:blue"><font color="white"><center>Tecnico</center></font></th>
								</tr>
							</thead>
