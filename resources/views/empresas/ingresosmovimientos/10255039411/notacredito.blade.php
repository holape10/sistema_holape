...
<body>
  <div class="ticket">
    ...
    <br><p class="centrado"><font size="2"><strong>CONTRERAS ANCALLA RAUL</strong></font><br><font size="2"></font><font size="2"><BR><br>R.U.C: 10310441258  <br>Nota de Crédito Electrónica<br>{{$cabecera->serdoc}}-{{$cabecera->numdoc}}<br></p>
		<br> <table id="table">
		<tr id="table">
