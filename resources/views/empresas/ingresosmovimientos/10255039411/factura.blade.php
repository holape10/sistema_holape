...
<body>
  <div class="ticket">
    ...
    <br><p class="centrado"><font size="2"><strong> LUQUE UTURUNCO LOLI PILAR</strong></font><br><font size="2"></font><font size="2"><BR><br>R.U.C: 10255039411<br>Factura Electrónica<br>{{$cabecera->serdoc}}-{{$cabecera->numdoc}}<br></p>
		 <br><table id="table">
		<tr id="table">
