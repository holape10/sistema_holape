...
<body>
  <div style="margin-top:-45px" class="ticket">
    ...
    <br><p class="centrado"><font size="2"><strong> LUQUE UTURUNCO LOLI PILAR</strong></font><br><font size="2"></font><font size="2"><BR><br>R.U.C: 10255039411<br>Boleta de Venta Electr&oacute;nica<br>{{$cabecera->serdoc}}-{{$cabecera->numdoc}}<br></p>
    ...
    <p class="centrado" style="margin-top:160px;">Representaci&oacute;n Impresa de la BOLETA ELECTR&Oacute;NICA<br>
	Para ver el documento visita https://econosystemsperu.pse.pe/10255039411<br>
	Emitido mediante un PROVEEDOR Autorizado por la SUNAT<br>
	Mediante Resoluci&oacute;n de Intendencia No. 034-005-0005315<br>
	</p><br>
