  ...
  <div class="row">
  	...
  	<div class="col-lg-12">
    		<button id="btnCategorias" name="btnCategorias" class="btn btn-block btn-success btn-lg" style="background:#D6EAF8 ">CATEGORÍAS</button>
  	</div>
  </div><br><br>
  ...
  <div class="row">
    ...
    <div class="col-sm-2 col-xs-4">
      <button id='pro<?php echo $i; ?>' onclick="agregaritem(this)" value='{{$producto->provun}}' style="background:#D6EAF8  ;width: 120px; height: 120px; border-radius:10px">
