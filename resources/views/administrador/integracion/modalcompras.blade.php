<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-compras">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="background:blue;">
					...
					<font color="white"><center><strong>MIGRAR COMPRAS</strong></center></font>
				</div>
				...
				<div class="modal-footer" id="divcompras">
					<button type="button" id="btncompras" class="btn btn-primary">Confirmar</button>
