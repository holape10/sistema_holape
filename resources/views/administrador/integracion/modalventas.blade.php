<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-ventas">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="background:blue;">
					...
					<font color="white"><center><strong>MIGRAR VENTAS</strong></center></font>
				</div>
				...
				<div class="modal-footer" id="divventas">
					<button type="button" id="btnventas" class="btn btn-primary">Confirmar</button>
