...
<section class="content">
    ...
    {!!Form::open(array('url'=>'/impresoras/actualizarimpresora','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
    {{Form::token()}}
	<div class="row">
        	<div class="col-lg-12">
          		<div class="box">
                        ...
                        <div class="row">
                        	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                        		<div class="form-group form-group-sm">
                    		        ...
                    		        <input type="text" name="impresora" id="impresora" value="{{$impresora->descripcion}}" class="form-control" >
                               </div>
                        	</div>
                        	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        		<div class="form-group form-group-sm">
                    		       	<label for="ruta">RUTA</label><font color="red">*</font>
                    		        <input type="text" name="ruta" id="ruta" value="{{$impresora->ruta}}" class="form-control" >
