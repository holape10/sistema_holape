...
<section class="content">
   <!-- Reemplazo de Form::open por HTML nativo con enctype para archivos -->
   <form action="/administrador/empresas" method="POST" id="formfact" autocomplete="off" enctype="multipart/form-data">
    @csrf <!-- Reemplazo de Form::token() -->
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-3">
                            <div class="form-group form-group-sm">
                                <label for="rucEmpresa">RUC</label><font color="red">*</font>
                                <img style="display:none;" width="50px" height="50px" src="/img/load.gif" name="imgload" id="imgload">
