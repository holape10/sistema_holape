...
class RepuestosController extends Controller
{
      ...
      public function __construct()
    {
        ...
        return  view('empresas.repuestos.historial',compact('detalle','producto'));
    ...
    public function actualizarpro(Request $request, $tipo){
       ...
       if($tipo=='venta'){
         $vista = view('empresas.repuestos.actualizarpro')->render();
       }elseif($tipo=='compra'){
        $vista = view('empresas.repuestos.actualizarprocompra')->render();
       }
    ...
    public function index(Request $request)
    {
        ...
        ->select('ma.mar_nom','p.procod','p.pronom','m.monnom','u.umenom','p.propun','p.proest','p.IdProducto','p.propun','modelo','cat_nom','imagenproducto','promocion','subcat_nom','tip_pro_nom','precio')
      ...
      $data_suc = DB::tABLE('empresa_negocios')->where('id_empresa_negocio',$sucursal)->first();
        ...
        return view('empresas.repuestos.index',compact('productos','buspro','categorias','tipos_productos','tipos','subcategorias','subcategoria','tip_pro_id','categoria','sucursales','sucursal','data_suc'));
      ...
      return view('empresas.repuestos.recetas',compact('insumos','prod_id','producto','receta'));
    ...
    public function asignarcombo($prod_id){
      ...
      return view('empresas.repuestos.combos',compact('insumos','prod_id','producto','combos'));
  ...
  public function actualizarproductostock(){
    ...
    public function create()
    {
        ...
        return view('empresas.repuestos.create',compact('modelos','programas','unidades','categorias','monedas','proveedores','tipoigv','subcategorias','tipos','servicios','marcas','laboratorios'));
     ...
     public function busquedaproductocomanda(Request $request, $valor){
        ...
        $vista = view('empresas.repuestos.menucomanda',compact('productos','unidades'))->render();
   ...
   public function store(Request $request)
    {
        ...
        if(empty($request->get('txt_procod'))){
            ...
            $buscarproducto->procod = $productos->IdProducto;
    ...
    public function buscarcategorias($producto,Request $request){
        ...
        $vista = view('empresas.repuestos.divcategorias',compact('categorias'))->render();
     ...
     public function buscarsubcategorias($producto,Request $request){
        ...
        $vista = view('empresas.repuestos.divsubcategorias',compact('subcategorias'))->render();
    ...
    public function buscartipos($producto,Request $request){
        ...
        $vista = view('empresas.repuestos.divtipos',compact('tipos'))->render();
    ...
    public function edit($id,$sucursal)
    {
        ...
        return view('empresas.repuestos.edit',compact('modelos','productos','unidades','categorias','monedas','tipoigv','codigos','presentaciones','subcategorias','tipos','sucursal','servicios','marcas','programas','laboratorios'));
    }
    ...
    public function presentaciones($id){
       ...
       $rucemp = trim(Auth::user()->IdEmpresa);
        ...
        return view('empresas.repuestos.presentaciones',compact('productos','unidades','categorias','monedas','tipoigv','codigos','presentaciones','id'));

    }


    public function actualizarpresentaciones($id,$idprod,$presentacion,$descripcion,$costo,$precio,$factor,$sucursal,$precio2)
    {
    ...
    public function update(Request $request, $id)
    {
       ...
       // $productos->color = $request->get('color');
        ...
        self::actualizarpresentaciones($id,$idprod,$presentacion,$descripcion,$costo_pre,$precio,$factor,$sucursal,$precio2);
  ...
  //----------------------------------------CONSULTAS PARA PUNTO DE VENTA-------------------------------------------->
   ...
   public function consultarmenu(Request $request, $cat_id){
      ...
      $contar = count($productos);
        ...
        $vista = view('empresas.repuestos.menu',compact('productos','unidades','sucursal'))->render();
...
//------------------------------------------consultar productos compra --------------------------//
     ...
     public function consultarmenucompra(Request $request, $cat_id,$sucursal,$almacen){
        ...
        $vista = view('empresas.repuestos.menucompra',compact('productos','unidades'))->render();
...
//------------------------------------------consultar productos inventarios --------------------------//
    ...
    public function presentacionesproductoinventario(Request $request, $id, $sucursal,$almacen){
     ...
     public function consultarmenuinventario(Request $request, $cat_id,$sucursal,$almacen){
        ...
        $vista = view('empresas.repuestos.menuinventario',compact('productos','unidades'))->render();
...
//---------------------------------------fin consultar inventarios-----------------------------//
    ...
    public function consultarmenualm(Request $request, $cat_id, $almacen,$sucursal){
       ...
       $rucemp = trim(Auth::user()->IdEmpresa);
        ...
        $vista = view('empresas.repuestos.menualm',compact('productos','unidades'))->render();
     ...
     public function consultarmenucobrar(Request $request, $cat_id){
        ...
        $vista = view('empresas.repuestos.menucobrar',compact('productos','unidades'))->render();
    ...
    {   
          ...
          $datosalm ="";
            ...
            if(empty($sucursal)){
              ...
              $productos = DB::tABLE('productos as p')
                ->select('producto_stock.stock_inicial','producto_stock.stock','p.procod','p.pronom','m.monnom','u.umenom','p.propun','p.proest','producto_stock.IdProducto','p.costo','p.propun','mar.mar_nom as marca','modelo')
                ->leftjoin('moneda as m','p.moncod','=','m.moncod')
         ...
         ->leftjoin('marcas as mar','mar.mar_id','=','p.marca')
            ...
            return view('empresas.repuestos.stockproducto',compact('productos','buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm'));
         ...
         ->leftjoin('marcas as mar','mar.mar_id','=','p.marca')
             ...
             $nompdffile='STOCK_PRODUCTOS_'.$datos->IdEmpresa.'.pdf'; 
              ...
              $rutapdf = public_path().'/reporte_cuentas_cobrar/';
                ...
                $view = \View::make('formatos_reportes.reporte_pdf_stock_productos', compact('productos','buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm','empresa'));
    ...
    public function actualizarinventario(Request $request){
     ...
     public function editarinventario($id){
        ...
        ->get();
          ...
          return view('empresas.repuestos.inventarioseditar',compact('buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm','fecha','unidades','productoslista','id'));
    ...
    {   
         ...
         // $almacen = $request->get('almacen');
          ...
          if(empty($fecha)){
            ...
            return view('empresas.repuestos.inventarios',compact('buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm','fecha','productos'));
    ...
    public function ajustar_stock($id_almacen,$IdProducto){
        ...
        return view('empresas.repuestos.ajustar_stock',compact('productos','almacen','sucursal'));
    ...
    public function consultarcategorias(Request $request){
        ...
        $vista = view('empresas.repuestos.listacategorias',compact('categorias'))->render();
 ...
 public function calcular_stock(){
      ...
      /*---------------------------------------------RESTAURANTE------------------------------------------------------*/
         public function buscarcarta(Request $request, $id=0,$cat=0){
            ...
            $vista = view('empresas.repuestos.items_productos',compact('productos'))->render();
