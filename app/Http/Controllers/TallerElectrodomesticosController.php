...
class TallerElectrodomesticosController extends Controller
{
   ...
   public function __construct()
    ...
    public function ordenes(Request $request,$codfact=0)
    {
        ...
        $num_ord = $request->get('num_ord');
         ...
         $comprobantes = DB::tABLE('cpe_cabecera as cpe_c')->select('fechacot','cpe_c.estadocobrar','ccacodsun','ccafem','tdodes','cpe_c.serdoc','cpe_c.numdoc','tdides','cpe_c.ccandi','cpe_c.ccanom','monnom','cpe_c.ccaitv','cpe_c.tdocod','cpe_c.IdCpe_cabecera','cpe_c.ccanot','cpe_c.ccabaj','cpe_c.codhash','estadopago','estado','referencia','ccadessun','cliente.telefono','mod_nom','mar_nom','pronom','equi_ser','equi_id','observaciones','coordinadores.name as nom_coor','coordinadores.apeusu as ape_coor','tecnicos.name as nom_tec','tecnicos.apeusu as ape_tec','est_ord_cod','supervisor.name as nom_sup','supervisor.apeusu as ape_sup')
          ...
          ->where(function ($query) use ($num_ord){
            if(!empty(trim($num_ord))){
             $query->where('numdoc',$num_ord);
            }
           
        
            })
             ->where('cpe_c.estado','REGISTRADO')
           ->where('cpe_c.tdocod','70')
           ->orderby('IdCpe_cabecera','desc')
          ->paginate(1000);
      	
      	$coordinadores = DB::tABLE('users')->join('role_user','role_user.user_IdUsuario','users.IdUsuario')->where('role_id','12')->get();
      	$tecnicos = DB::tABLE('users')->join('role_user','role_user.user_IdUsuario','users.IdUsuario')->where('role_id','11')->get();
      	$evaluaciones = DB::tABLE('evaluaciones')->orderby('eval_nom','asc')->get();
      	$fallas = DB::tABLE('fallas')->orderby('fall_nom','asc')->get();

      
      		 return view('empresas.taller_electrodomesticos.ordenes',compact('datos','evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
      
       
    }


     public function pedidos_repuestos_ordenes_trabajo(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_electrodomesticos.ordenes_almacen',compact('datos','evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
      
       
    }

        public function consultar_ordenes(Request $request,$codfact=0)
    {
        ...
        $fallas = DB::tABLE('fallas')->orderby('fall_nom','asc')->get();
             ...
             return view('empresas.taller_electrodomesticos.consultar_ordenes',compact('datos','evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
      ...
      public function equipos_entregar(Request $request,$codfact=0)
    {
        ...
        $num_ord = $request->get('num_ord');
         ...
         $comprobantes = DB::tABLE('cpe_cabecera as cpe_c')->select('fechacot','cpe_c.estadocobrar','ccacodsun','ccafem','tdodes','cpe_c.serdoc','cpe_c.numdoc','tdides','cpe_c.ccandi','cpe_c.ccanom','monnom','cpe_c.ccaitv','cpe_c.tdocod','cpe_c.IdCpe_cabecera','cpe_c.ccanot','cpe_c.ccabaj','cpe_c.codhash','estadopago','estado','referencia','ccadessun','cliente.telefono','mod_nom','mar_nom','pronom','equi_ser','equi_id','observaciones','coordinadores.name as nom_coor','coordinadores.apeusu as ape_coor','tecnicos.name as nom_tec','tecnicos.apeusu as ape_tec','est_ord_cod','supervisor.name as nom_sup','supervisor.apeusu as ape_sup')
      	...
      	$fallas = DB::tABLE('fallas')->orderby('fall_nom','asc')->get();
      		 ...
      		 return view('empresas.taller_electrodomesticos.equipos_entregar',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
  ...
  public function equipos_entregados(Request $request,$codfact=0)
    {
         ...
         $comprobantes = DB::tABLE('cpe_cabecera as cpe_c')->select('fechacot','cpe_c.estadocobrar','ccacodsun','ccafem','tdodes','cpe_c.serdoc','cpe_c.numdoc','tdides','cpe_c.ccandi','cpe_c.ccanom','monnom','cpe_c.ccaitv','cpe_c.tdocod','cpe_c.IdCpe_cabecera','cpe_c.ccanot','cpe_c.ccabaj','cpe_c.codhash','estadopago','estado','referencia','ccadessun','cliente.telefono','mod_nom','mar_nom','pronom','equi_ser','equi_id','observaciones','coordinadores.name as nom_coor','coordinadores.apeusu as ape_coor','tecnicos.name as nom_tec','tecnicos.apeusu as ape_tec','est_ord_cod','supervisor.name as nom_sup','supervisor.apeusu as ape_sup')
          ...
          ->paginate(1000);
	      	...
	      	$fallas = DB::tABLE('fallas')->orderby('fall_nom','asc')->get();
      		 ...
      		 return view('empresas.taller_electrodomesticos.equipos_entregados',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
      
       
    }


        public function ordenes_supervisor(Request $request,$codfact=0)
    {
        ...
        $num_ord = $request->get('num_ord');
         ...
         $comprobantes = DB::tABLE('cpe_cabecera as cpe_c')->select('fechacot','cpe_c.estadocobrar','ccacodsun','ccafem','tdodes','cpe_c.serdoc','cpe_c.numdoc','tdides','cpe_c.ccandi','cpe_c.ccanom','monnom','cpe_c.ccaitv','cpe_c.tdocod','cpe_c.IdCpe_cabecera','cpe_c.ccanot','cpe_c.ccabaj','cpe_c.codhash','estadopago','estado','referencia','ccadessun','cliente.telefono','mod_nom','mar_nom','pronom','equi_ser','equi_id','observaciones','coordinadores.name as nom_coor','coordinadores.apeusu as ape_coor','tecnicos.name as nom_tec','tecnicos.apeusu as ape_tec','supervisor.name as nom_sup','supervisor.apeusu as ape_sup','est_ord_cod')
         	->leftjoin('cliente','cpe_c.clicod','=','cliente.clicod')
         	->leftjoin('tipo_documento as tip_d','cpe_c.tdocod','=','tip_d.tdocod')
          	->leftjoin('tipo_documento_identidad as tdi','cpe_c.tdicod','=','tdi.tdicod')
          	->leftjoin('moneda as mon','cpe_c.moncod','=','mon.moncod')
            ...
            ->where('cpe_c.estado','REGISTRADO')
          ->where('cpe_c.tdocod','70')
           ->where('est_ord_cod','AS')
           ->orwhere('est_ord_cod','RS')
        ...
        return view('empresas.taller_electrodomesticos.ordenes_supervisor',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }

     public function ordenes_coordinador(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_electrodomesticos.ordenes_coordinador',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }

	 public function ordenes_atencion(Request $request,$codfact=0)
	    {
	        ...
	        $num_ord = $request->get('num_ord');
	         ...
	         $comprobantes = DB::tABLE('cpe_cabecera as cpe_c')->select('fechacot','cpe_c.estadocobrar','ccacodsun','ccafem','tdodes','cpe_c.serdoc','cpe_c.numdoc','tdides','cpe_c.ccandi','cpe_c.ccanom','monnom','cpe_c.ccaitv','cpe_c.tdocod','cpe_c.IdCpe_cabecera','cpe_c.ccanot','cpe_c.ccabaj','cpe_c.codhash','estadopago','estado','referencia','ccadessun','cliente.telefono','mod_nom','mar_nom','pronom','equi_ser','equi_id','observaciones','coordinadores.name as nom_coor','coordinadores.apeusu as ape_coor','tecnicos.name as nom_tec','tecnicos.apeusu as ape_tec','supervisor.name as nom_sup','supervisor.apeusu as ape_sup','est_ord_cod')
	            ...
	            ->leftjoin('users as supervisor','supervisor.IdUsuario','cpe_c.supervisor')
	          ->where('cpe_c.id_empresa_negocio',Auth::user()->id_empresa_negocio)
	          ->where('cpe_c.tecnico',Auth::user()->IdUsuario)
	          ->where('cpe_c.tdocod','70')
               ->where(function ($query) use ($num_ord){
                if(!empty(trim($num_ord))){
                 $query->where('numdoc',$num_ord);
             ...
             $query->where('est_ord_cod','OCC')
                ->ORwhere('est_ord_cod','RAT')
                    ->ORwhere('est_ord_cod','AT');
	        ...
	        return view('empresas.taller_electrodomesticos.ordenes_atencion',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
	    }



	 public function ordenes_control_calidad(Request $request,$codfact=0)
	    {
	        ...
	        return view('empresas.taller_electrodomesticos.ordenes_control_calidad',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
	    }



     public function ordenes_tecnico(Request $request,$codfact=0)
    {
        ...
        $num_ord = $request->get('num_ord');
         ...
         $comprobantes = DB::tABLE('cpe_cabecera as cpe_c')->select('fechacot','cpe_c.estadocobrar','ccacodsun','ccafem','tdodes','cpe_c.serdoc','cpe_c.numdoc','tdides','cpe_c.ccandi','cpe_c.ccanom','monnom','cpe_c.ccaitv','cpe_c.tdocod','cpe_c.IdCpe_cabecera','cpe_c.ccanot','cpe_c.ccabaj','cpe_c.codhash','estadopago','estado','referencia','ccadessun','cliente.telefono','mod_nom','mar_nom','pronom','equi_ser','equi_id','observaciones','coordinadores.name as nom_coor','coordinadores.apeusu as ape_coor','tecnicos.name as nom_tec','tecnicos.apeusu as ape_tec','supervisor.name as nom_sup','supervisor.apeusu as ape_sup','est_ord_cod')
            ...
            ->leftjoin('users as supervisor','supervisor.IdUsuario','cpe_c.supervisor')
          ->where('cpe_c.id_empresa_negocio',Auth::user()->id_empresa_negocio)
         //  ->where('cpe_c.supervisor',Auth::user()->IdUsuario)
              ->where(function ($query) use ($num_ord){
                if(!empty(trim($num_ord))){
                 $query->where('numdoc',$num_ord);
                }
         ...
         //  ->where('est_ord_cod','ACL')
           ->where(function ($query){
        
             $query->where('est_ord_cod','RS')
                    ->ORwhere('est_ord_cod','RAT')
                    ->ORwhere('est_ord_cod','AT');
        ...
        return view('empresas.taller_electrodomesticos.ordenes_tecnico',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }


      public function ordenes_reasignar_tecnico(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_electrodomesticos.ordenes_reasignar_tecnico',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }



        public function ordenes_aprobadas(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_electrodomesticos.ordenes_aprobadas',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }

         public function ordenes_observadas(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_electrodomesticos.ordenes_observadas',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }


    public function nueva_orden_trabajo(Request $request){
        ...
        $tipo_equipo = DB::tABLE('tipo_equipo')->get();
        $marcas = DB::tABLE('marcas')->get();

        return view('empresas.taller_electrodomesticos.nuevaorden',compact('evaluaciones','fallas','almacenes','categorias','comprobantes','tipodocumento','igv','unidades','unidades','marcas','modelos','clientes','combustible','tecnicos','condiciones','monedas','tipo_equipo','marcas'));
    ...
    public function recepcionar_supervisor(Request $request){

    	$items = $request->get('items');
    	$supervisor = Auth::user()->IdUsuario;

    	if(empty($items)){
    		return response()->json(['estado'=>'error','mensaje'=>'Seleccionar Órdenes']);
    	}

    	
    	foreach($items as $item){
    		DB::tABLE('cpe_cabecera')->where('IdCpe_cabecera',$item)->update(['supervisor'=>$supervisor,'est_ord_cod'=>'RS']);
    	}

     	return response()->json(['estado'=>'success','mensaje'=>'Asignado']);
    }


    public function asignar_coordinador(Request $request){
    	...
    	if(empty($coordinador)){
    		return response()->json(['estado'=>'error','mensaje'=>'Seleccionar Coordinador']);
    	}

    	foreach($items as $item){
    		DB::tABLE('cpe_cabecera')->where('IdCpe_cabecera',$item)->update(['coordinador'=>$coordinador,'est_ord_cod'=>'ACL']);
    	}
    ...
    public function asignar_tecnico(Request $request){
    	...
    	if(empty($items)){
    		return response()->json(['estado'=>'error','mensaje'=>'Seleccionar Ordenes']);
    	}

    	if(empty($tecnico)){
    		return response()->json(['estado'=>'error','mensaje'=>'Seleccionar Técnico']);
    	}

    	foreach($items as $item){
    		DB::tABLE('cpe_cabecera')->where('IdCpe_cabecera',$item)->update(['tecnico'=>$tecnico,'est_ord_cod'=>'AT']);
    	}

    	return response()->json(['estado'=>'success','mensaje'=>'Asignado']);
    }

        public function reasignar_tecnico(Request $request){
        ...
        foreach($items as $item){
            DB::tABLE('cpe_cabecera')->where('IdCpe_cabecera',$item)->update(['tecnico'=>$tecnico,'est_ord_cod'=>'RAT']);
        }
        ...
        public function editar_orden_trabajo($id)
    {
        ...
        $cotizacion = DB::tABLE('cpe_cabecera as cpe_c')
        ->select('cpe_c.id_empresa_negocio','cpe_c.id_almacen','serdoc','numdoc','est_ord_nom','fechacot','mar_nom','mod_nom','equi_ser','ccanom','tdides','ccandi','clidir','clicon','cliente.telefono','clicor','doc_gar','fec_doc_gar','cpe_c.cre_dia_id','cpe_c.moncod','name','apeusu','observaciones','est_fis','cpe_c.eval_id','cpe_c.fall_id','obs_diag','obs_act','ccaitv','obs_tec','obs_cal','obs_cli','equi_id','tdocod_gar','cpe_c.tdicod','clinum','clinom','clicon','clicontel','pronom','fec_ult_est')
        ->leftjoin('cliente','cpe_c.clicod','cliente.clicod')
        ->leftjoin('users','users.IdUsuario','cpe_c.tecnico')
        ->leftjoin('productos as pro','cpe_c.equi_id','=','pro.IdProducto')
        ->leftjoin('modelos as mod','mod.mod_id','=','pro.modelo')
        ->leftjoin('marcas as mar','mar.mar_id','=','pro.marca')
        ...
        $sucursal = DB::tABLE('empresa_negocios')->where('id_empresa_negocio',$cotizacion->id_empresa_negocio)->first();


        $almacenes = DB::tABLE('almacenes')->where('id_empresa_negocio',$cotizacion->id_empresa_negocio)->get();
        ...
        $bus_alm = DB::tABLE('almacenes')->where('id_empresa_negocio',$cotizacion->id_empresa_negocio)->where('predeterminado','1')->first();
        ...
        $sucursal = DB::tABLE('empresa_negocios')->where('id_empresa_negocio',$cotizacion->id_empresa_negocio)->first();
         ...
         $doc_gar = DB::tABLE('cpe_cabecera')
         ->leftjoin('tipo_documento','tipo_documento.tdocod','cpe_cabecera.tdocod_gar')
        ->where('IdCpe_cabecera',$id)
        ->first();
        ...
        ->get();
         ...
         if(Auth::user()->hasRole('tecnico') ){
         		 ...
         		 return view('empresas.taller_electrodomesticos.editar_orden_tecnico',compact('sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));

         }elseif(Auth::user()->hasRole('recepcion')){

         	 return view('empresas.taller_electrodomesticos.editar_orden',compact('sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));

         }elseif(Auth::user()->hasRole('calidad') || Auth::user()->hasRole('supervisor')){

         	 return view('empresas.taller_electrodomesticos.editar_control_calidad',compact('sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));

         }elseif(Auth::user()->hasRole('almacen')){

             return view('empresas.taller_electrodomesticos.editar_orden_almacen',compact('sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));
        ...
        public function visualizar_orden($id)
    {
        $rucemp = trim(Auth::user()->IdEmpresa);
        $categorias = DB::tABLE('categorias')->where('id_empresa_negocio',Auth::user()->id_empresa_negocio)->get();
        $comprobantes = DB::tABLE('tipo_documento')->get();
        ...
        ->get();
                 ...
                 return view('empresas.taller_electrodomesticos.visualizar_orden',compact('sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));
        ...
        public function editar_orden_entregar($id)
    {
        $rucemp = trim(Auth::user()->IdEmpresa);
        $categorias = DB::tABLE('categorias')->where('id_empresa_negocio',Auth::user()->id_empresa_negocio)->get();
        $comprobantes = DB::tABLE('tipo_documento')->get();
        ...
        $cotizacion = DB::tABLE('cpe_cabecera as cpe_c')
        ->select('cpe_c.id_empresa_negocio','cpe_c.id_almacen','serdoc','numdoc','est_ord_nom','fechacot','mar_nom','mod_nom','equi_ser','ccanom','tdides','ccandi','clidir','clicon','cliente.telefono','clicor','doc_gar','fec_doc_gar','cpe_c.cre_dia_id','cpe_c.moncod','name','apeusu','observaciones','est_fis','cpe_c.eval_id','cpe_c.fall_id','obs_diag','obs_act','ccaitv','obs_tec','obs_cal','obs_cli','equi_id','tdocod_gar','cpe_c.tdicod','clinum','clinom','clicon','clicontel','pronom','fec_ult_est','obs_ent')
        ->leftjoin('cliente','cpe_c.clicod','cliente.clicod')
        ->leftjoin('users','users.IdUsuario','cpe_c.tecnico')
        ->leftjoin('productos as pro','cpe_c.equi_id','=','pro.IdProducto')
        ->leftjoin('modelos as mod','mod.mod_id','=','pro.modelo')
        ...
        return view('empresas.taller_electrodomesticos.editar_orden_entregar',compact('sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));
         ...
         public function actualizar_orden_trabajo(Request $request){
        ...
        $cabecera->fec_doc_gar = $request->get('fec_doc_gar');
        ...
        $cabecera->est_ord_cod = 'AS';
        $cabecera->fec_ult_est = now()->format('Y-m-d');
        ...
        $cabecera->est_fis = $request->get('est_fis');
        $cabecera->obs_act = $request->get('obs_act');
        $cabecera->doc_gar = $request->get('doc_gar');
        $cabecera->tdocod_gar = $request->get('tdocod_gar');
        $cabecera->encargado = $request->get('encargado');
        $cabecera->equi_id = $request->get('equi_id');
        $cabecera->equi_ser = $request->get('equi_ser');
       ...
       public function actualizar_orden_trabajo_almacen(Request $request){
        ...
        $cant_dev = $request->get('cant_dev');
        $cant_dev_alm = $request->get('cant_dev_alm');
       ...
       if(!empty($proid)){
           foreach ($proid as $index => $producto) {
            ...
            $detalle->IdCpe_cabecera =  $cotid;
            $detalle->umecod = $codpro->umecod;
            $detalle->cpe_det_factor = $codpro->factor;
            $detalle->cdecan = $cantidades[$index];
            $detalle->cant_dev = $cant_dev[$index];
            $detalle->cant_dev_alm = $cant_dev_alm[$index];
         ...
         public function actualizar_orden_trabajo_tecnico(Request $request){
        ...
        $cabecera->obs_act = $request->get('obs_act');
        $cabecera->obs_diag = $request->get('obs_diag');
        $cabecera->obs_tec = $request->get('obs_tec');
        $cabecera->obs_cli = $request->get('obs_cli');
        $cabecera->eval_id = $request->get('eval_id');
        $cabecera->fall_id = $request->get('fall_id');
        $cabecera->est_ord_cod ='AT';
        $cabecera->fec_ult_est = now()->format('Y-m-d');
        $cabecera->obs_cal = $request->get('obs_cal');
      ...
      public function finalizar_orden_trabajo_tecnico(Request $request){
...
*/
  ...
  /*       public function registrar_entregar_equipo($id){

     

        		$cabecera =  cpe_cabecera::findOrFail($id);
        		$cabecera->est_ord_cod ='EC';
                $cabecera->fec_ult_est = now()->format('Y-m-d');
        		$cabecera->update();

        		return Redirect::to('/equiposentregar');
   	 }
*/



         public function registrar_entregar_equipo(Request $request){
        ...
        $cabecera =  cpe_cabecera::findOrFail($cotid);
        $cabecera->est_ord_cod ='EC';
        $cabecera->obs_ent = $request->get('obs_ent');
        $cabecera->fec_ult_est = now()->format('Y-m-d');
        $cabecera->update();
        ...
        return response()->json(['registrado']);
         ...
         public function observar_control_calidad(Request $request){
        ...
        $cabecera->update();
         ...
         public function aceptar_control_calidad(Request $request){
    ...
    { 
        ...
        return view('empresas.puntosventas.nuevaorden',compact('categorias','comprobantes','tipodocumento','igv','unidades','unidades','tdocod','cpe','mozos','creditos','mediospagos','equipos','tecnicos','documentos','clientes'));

    }


    public function seleccionarequipos(Request $request){

        $equipos = DB::tABLE('productos')
        ->select('IdProducto','mar_nom','mod_nom','pronom','dias_garantia')
        ->leftjoin('marcas','marcas.mar_id','productos.marca')
        ->leftjoin('modelos','modelos.mod_id','productos.modelo')
        ->where('promocion','8')
        ->get();

        $vista = view('empresas.taller_electrodomesticos.listaequipos',compact('equipos'))->render();
  ...
  return view('empresas.puntosventas.cobrar_orden',compact('comprobantes','ubigeos','docidentidad','senudoc','motivos','modalidades','documentos','categorias','comprobante','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','detalles','id','operaciones','mediospagos','gastos','datos','almacenes','vendedores','creditos'));
    ...
    public function registrarcotizacion(Request $request){
     ...
     public function registrar_orden_trabajo(Request $request){
