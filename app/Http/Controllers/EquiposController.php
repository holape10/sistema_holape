...
class EquiposController extends Controller
{
      ...
      public function __construct()
    {
        ...
        return  view('empresas.equipos.historial',compact('detalle','producto'));
    ...
    public function actualizarpro(Request $request, $tipo){
       ...
       if($tipo=='venta'){
         $vista = view('empresas.equipos.actualizarpro')->render();
       }elseif($tipo=='compra'){
        $vista = view('empresas.equipos.actualizarprocompra')->render();
       }
    ...
    public function index(Request $request)
    {
      ...
      $data_suc = DB::tABLE('empresa_negocios')->where('id_empresa_negocio',$sucursal)->first();
        ...
        return view('empresas.equipos.index',compact('productos','buspro','categorias','tipos_productos','tipos','subcategorias','subcategoria','tip_pro_id','categoria','sucursales','sucursal','data_suc'));
      ...
      return view('empresas.equipos.recetas',compact('insumos','prod_id','producto','receta'));
    ...
    public function asignarcombo($prod_id){
      ...
      return view('empresas.equipos.combos',compact('insumos','prod_id','producto','combos'));
  ...
  public function actualizarproductostock(){
    ...
    public function create()
    {
        ...
        return view('empresas.equipos.create',compact('modelos','programas','unidades','categorias','monedas','proveedores','tipoigv','subcategorias','tipos','servicios','marcas','laboratorios'));
     ...
     public function busquedaproductocomanda(Request $request, $valor){
        ...
        $vista = view('empresas.equipos.menucomanda',compact('productos','unidades'))->render();
   ...
   public function store(Request $request)
    ...
    public function buscarcategorias($producto,Request $request){
        ...
        $vista = view('empresas.equipos.divcategorias',compact('categorias'))->render();
     ...
     public function buscarsubcategorias($producto,Request $request){
        ...
        $vista = view('empresas.equipos.divsubcategorias',compact('subcategorias'))->render();
    ...
    public function buscartipos($producto,Request $request){
        ...
        $vista = view('empresas.equipos.divtipos',compact('tipos'))->render();
    ...
    public function edit($id,$sucursal)
    {
        ...
        return view('empresas.equipos.edit',compact('modelos','productos','unidades','categorias','monedas','tipoigv','codigos','presentaciones','subcategorias','tipos','sucursal','servicios','marcas','programas','laboratorios'));
    }
    ...
    public function presentaciones($id){
       ...
       $rucemp = trim(Auth::user()->IdEmpresa);
        ...
        return view('empresas.equipos.presentaciones',compact('productos','unidades','categorias','monedas','tipoigv','codigos','presentaciones','id'));
  ...
  //----------------------------------------CONSULTAS PARA PUNTO DE VENTA-------------------------------------------->
   ...
   public function consultarmenu(Request $request, $cat_id){
      ...
      $contar = count($productos);
        ...
        $vista = view('empresas.equipos.menu',compact('productos','unidades','sucursal'))->render();
...
//------------------------------------------consultar productos compra --------------------------//
     ...
     public function consultarmenucompra(Request $request, $cat_id,$sucursal,$almacen){
        ...
        $vista = view('empresas.equipos.menucompra',compact('productos','unidades'))->render();
...
//------------------------------------------consultar productos inventarios --------------------------//
    ...
    public function presentacionesproductoinventario(Request $request, $id, $sucursal,$almacen){
     ...
     public function consultarmenuinventario(Request $request, $cat_id,$sucursal,$almacen){
        ...
        $vista = view('empresas.equipos.menuinventario',compact('productos','unidades'))->render();
...
//---------------------------------------fin consultar inventarios-----------------------------//
    ...
    public function consultarmenualm(Request $request, $cat_id, $almacen,$sucursal){
       ...
       $rucemp = trim(Auth::user()->IdEmpresa);
        ...
        $vista = view('empresas.equipos.menualm',compact('productos','unidades'))->render();
     ...
     public function consultarmenucobrar(Request $request, $cat_id){
        ...
        $vista = view('empresas.equipos.menucobrar',compact('productos','unidades'))->render();
    ...
    {   
         ...
         ->leftjoin('marcas as mar','mar.mar_id','=','p.marca')
            ...
            return view('empresas.equipos.stockproducto',compact('productos','buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm'));
    ...
    public function actualizarinventario(Request $request){
     ...
     public function editarinventario($id){
        ...
        ->get();
          ...
          return view('empresas.equipos.inventarioseditar',compact('buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm','fecha','unidades','productoslista','id'));
    ...
    {   
         ...
         // $almacen = $request->get('almacen');
          ...
          if(empty($fecha)){
            ...
            return view('empresas.equipos.inventarios',compact('buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm','fecha','productos'));
    ...
    public function ajustar_stock($id_almacen,$IdProducto){
        ...
        return view('empresas.equipos.ajustar_stock',compact('productos','almacen','sucursal'));
    ...
    public function consultarcategorias(Request $request){
        ...
        $vista = view('empresas.equipos.listacategorias',compact('categorias'))->render();
 ...
 public function calcular_stock(){
      ...
      /*---------------------------------------------RESTAURANTE------------------------------------------------------*/
         public function buscarcarta(Request $request, $id=0,$cat=0){
            ...
            $vista = view('empresas.equipos.items_productos',compact('productos'))->render();
