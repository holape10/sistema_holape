...
class ClientesController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            ->leftjoin('users','users.idUsuario','cliente.vendedor')
            ...
            return view('empresas.clientes.index',["clientes"=>$clientes,"buscli"=>$buscli]);
    ...
    {   
        ...
        if(empty(trim($request->get('clinum')))){
            ...
            $clientenuevo = Cliente::Create([
                ...
                'rucemp'=>Auth::user()->IdEmpresa,
                'vendedor'=>$request->get('vendedores'),
            ...
            $clientenuevo = Cliente::UpdateOrCreate(['clinum'=>$request->get('clinum')],[
                'clinom'=>$request->get('clinom'),
                'clidir'=>$request->get('clidir'),
                'clicor'=>$request->get('clicor'),
                'clicor2'=>$request->get('clicor2'),
    ...
    {   
        ...
        $cliente->vendedor = $request->get('vendedores');
