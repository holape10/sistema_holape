...
class IngresosController extends Controller
{
   /**
    ...
    {   
        ...
        return view('empresas.ingresos.index',compact('gastos','codgast','negocios','sucursal','tipo'));
    }
    ...
    public function create()
    {
        ...
        return view('empresas.ingresos.nuevagasto',compact('negocios','igv','monedas','unidades','docidentidad','fecha','doccomprobante','codgast','gastos'));
       ...
       public function gastoproductos()
    {
        ...
        return view('empresas.ingresos.gasto',compact('gastos','igv','monedas','unidades','docidentidad','fecha','doccomprobante','negocios','colaboradores'));
      ...
      public function edit($id)
    {
        ...
        return view('empresas.ingresos.editar_ingreso',compact('gastos','igv','monedas','unidades','docidentidad','fecha','doccomprobante','negocios','colaboradores','gasto_cab','gasto_det'));
    ...
    public function detallegastos($id){
        ...
        return view('empresas.ingresos.detalles',compact('gasto'));
    }
