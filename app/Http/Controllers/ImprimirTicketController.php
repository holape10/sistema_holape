...
class ImprimirTicketController extends Controller
{
  ...
  public function imprimirpedido($pedido,$tipo){
    ...
    public function imprimir_cuenta_pantalla($pedido){
     ...
     //   $printer->text("OUT & PRIDE"."\n");
       ...
       $printer->text("\n");
       $printer->text("CONSUMO TOTAL:". $cab_pedido->total."\n");
        $printer->text("\n");
