...
class TallerComputadorasController extends Controller
{
   ...
   public function __construct()
        ...
        $num_ord = $request->get('num_ord');
         ...
         $comprobantes = DB::tABLE('cpe_cabecera as cpe_c')->select('fechacot','cpe_c.estadocobrar','ccacodsun','ccafem','tdodes','cpe_c.serdoc','cpe_c.numdoc','tdides','cpe_c.ccandi','cpe_c.ccanom','monnom','cpe_c.ccaitv','cpe_c.tdocod','cpe_c.IdCpe_cabecera','cpe_c.ccanot','cpe_c.ccabaj','cpe_c.codhash','estadopago','estado','referencia','ccadessun','cliente.telefono','mod_nom','mar_nom','pronom','equi_ser','equi_id','observaciones','coordinadores.name as nom_coor','coordinadores.apeusu as ape_coor','tecnicos.name as nom_tec','tecnicos.apeusu as ape_tec','est_ord_cod','supervisor.name as nom_sup','supervisor.apeusu as ape_sup')
      	...
      	$fallas = DB::tABLE('fallas')->orderby('fall_nom','asc')->get();
      		 ...
      		 return view('empresas.taller_computadoras.ordenes',compact('datos','evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
     ...
     public function pedidos_repuestos_ordenes_trabajo(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_computadoras.ordenes_almacen',compact('datos','evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
        ...
        public function consultar_ordenes(Request $request,$codfact=0)
    {
        ...
        $fallas = DB::tABLE('fallas')->orderby('fall_nom','asc')->get();
             ...
             return view('empresas.taller_computadoras.consultar_ordenes',compact('datos','evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
        ...
        $num_ord = $request->get('num_ord');
         ...
         $comprobantes = DB::tABLE('cpe_cabecera as cpe_c')->select('fechacot','cpe_c.estadocobrar','ccacodsun','ccafem','tdodes','cpe_c.serdoc','cpe_c.numdoc','tdides','cpe_c.ccandi','cpe_c.ccanom','monnom','cpe_c.ccaitv','cpe_c.tdocod','cpe_c.IdCpe_cabecera','cpe_c.ccanot','cpe_c.ccabaj','cpe_c.codhash','estadopago','estado','referencia','ccadessun','cliente.telefono','mod_nom','mar_nom','pronom','equi_ser','equi_id','observaciones','coordinadores.name as nom_coor','coordinadores.apeusu as ape_coor','tecnicos.name as nom_tec','tecnicos.apeusu as ape_tec','est_ord_cod','supervisor.name as nom_sup','supervisor.apeusu as ape_sup')
      	...
      	$fallas = DB::tABLE('fallas')->orderby('fall_nom','asc')->get();
      		 ...
      		 return view('empresas.taller_computadoras.equipos_entregar',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
  ...
  public function equipos_entregados(Request $request,$codfact=0)
         ...
         $comprobantes = DB::tABLE('cpe_cabecera as cpe_c')->select('fechacot','cpe_c.estadocobrar','ccacodsun','ccafem','tdodes','cpe_c.serdoc','cpe_c.numdoc','tdides','cpe_c.ccandi','cpe_c.ccanom','monnom','cpe_c.ccaitv','cpe_c.tdocod','cpe_c.IdCpe_cabecera','cpe_c.ccanot','cpe_c.ccabaj','cpe_c.codhash','estadopago','estado','referencia','ccadessun','cliente.telefono','mod_nom','mar_nom','pronom','equi_ser','equi_id','observaciones','coordinadores.name as nom_coor','coordinadores.apeusu as ape_coor','tecnicos.name as nom_tec','tecnicos.apeusu as ape_tec','est_ord_cod','supervisor.name as nom_sup','supervisor.apeusu as ape_sup')
          ...
          ->paginate(1000);
	      	...
	      	$fallas = DB::tABLE('fallas')->orderby('fall_nom','asc')->get();
      		 ...
      		 return view('empresas.taller_computadoras.equipos_entregados',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
        ...
        public function ordenes_supervisor(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_computadoras.ordenes_supervisor',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }
     ...
     public function ordenes_coordinador(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_computadoras.ordenes_coordinador',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }
	 ...
	 public function ordenes_atencion(Request $request,$codfact=0)
	    {
	        ...
	        return view('empresas.taller_computadoras.ordenes_atencion',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
	    }
	 ...
	 public function ordenes_control_calidad(Request $request,$codfact=0)
	    {
	        ...
	        return view('empresas.taller_computadoras.ordenes_control_calidad',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
	    }
     ...
     public function ordenes_tecnico(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_computadoras.ordenes_tecnico',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }
      ...
      public function ordenes_reasignar_tecnico(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_computadoras.ordenes_reasignar_tecnico',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }
        ...
        public function ordenes_aprobadas(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_computadoras.ordenes_aprobadas',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }
         ...
         public function ordenes_observadas(Request $request,$codfact=0)
    {
        ...
        return view('empresas.taller_computadoras.ordenes_observadas',compact('evaluaciones','fallas','comprobantes','fecin','fecfin','codfact','coordinadores','tecnicos'));
    }
    ...
    public function nueva_orden_trabajo(Request $request){
        ...
        return view('empresas.taller_computadoras.nuevaorden',compact('evaluaciones','fallas','almacenes','categorias','comprobantes','tipodocumento','igv','unidades','unidades','marcas','modelos','clientes','combustible','tecnicos','condiciones','monedas','tipo_equipo','marcas'));
        ...
        public function editar_orden_trabajo($id)
    {
        ...
        $lis_tip_equi = DB::tABLE('ordenes_equipo')->where('IdCpe_cabecera',$id)->get();

         if(Auth::user()->hasRole('tecnico') ){

         		 return view('empresas.taller_computadoras.editar_orden_tecnico',compact('tipo_equipo','marcas','lis_tip_equi','sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));

         }elseif(Auth::user()->hasRole('recepcion')){

         	 return view('empresas.taller_computadoras.editar_orden',compact('tipo_equipo','marcas','lis_tip_equi','sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));

         }elseif(Auth::user()->hasRole('calidad') || Auth::user()->hasRole('supervisor')){

         	 return view('empresas.taller_computadoras.editar_control_calidad',compact('tipo_equipo','marcas','lis_tip_equi','sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));

         }elseif(Auth::user()->hasRole('almacen')){

             return view('empresas.taller_computadoras.editar_orden_almacen',compact('tipo_equipo','marcas','lis_tip_equi','sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));
        ...
        public function visualizar_orden($id)
    {
        ...
        ->get();
                 ...
                 return view('empresas.taller_computadoras.visualizar_orden',compact('sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));
        ...
        public function editar_orden_entregar($id)
    {
        ...
        return view('empresas.taller_computadoras.editar_orden_entregar',compact('sucursal','doc_gar','evaluaciones','fallas','categorias','comprobantes','tipodocumento','igv','unidades','unidades','productos','marcas','modelos','clientes','combustible','tecnicos','condiciones','vehiculos','monedas','cotizacion','servicios','repuestos','id','almacenes'));
        ...
        DB::tABLE('ordenes_equipo')->where('IdCpe_cabecera',$cotid)->delete();
        
       	$id_tip_equi = $request->get('id_tip_equi');
    	$mar_id = $request->get('mar_id');
    	$modelo = $request->get('modelo');
    	$serie = $request->get('serie');
    	$obs_ord_equi = $request->get('obs_ord_equi');
    	$can_ord_equi = $request->get('can_ord_equi');

    	if(!empty($id_tip_equi)){
    		foreach($id_tip_equi as $indexi => $ite){
	    		DB::tABLE('ordenes_equipo')->insert([
	    			'id_tip_equi'=>$ite,
	    			'mar_id'=>$mar_id[$indexi],
	    			'modelo'=>$modelo[$indexi],
	    			'serie'=>$serie[$indexi],
	    			'obs_ord_equi'=>$obs_ord_equi[$indexi],
	    			'IdCpe_cabecera'=>$cabecera->IdCpe_cabecera,
	    			'can_ord_equi'=>$can_ord_equi[$indexi]
	    		]);
	    	}
    	}
...
*/
    ...
    public function seleccionarequipos(Request $request){
        ...
        $vista = view('empresas.taller_computadoras.listaequipos',compact('equipos'))->render();
