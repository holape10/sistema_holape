...
class ProduccionController extends Controller
{
    ...
    public function registrar(Request $request){
      ...
      //Registrar el cliente enviado a través del formulario si no existe
       ...
       if(empty($tdicod)){
        ...
        $cabecera->motivo_transferencia = 'PRODUCCION';
   ...
   //        $detalle->icbper = $codpro->icbper;
     ...
     public function salidasproduccion($codfact=0)
    { 
    ...
    { 
      ...
      //  ->where('id_empresa_negocio',Auth::user()->id_empresa_negocio)
        ...
        return view('empresas.produccion.ingresosproduccion',compact('codfact','categorias','comprobante','tipodocumento','unidades','unidades','vendedores','creditos','mediospagos','clientes','documentos','datos','monedas','senudoc','motivos','modalidades','docidentidad','doccomprobante','monedas','almacenes','gastos','combustible','marcas','modelos','tecnicos','tipos_igv'));
    }
  ...
  public function indexvalessalidas(Request $request)
    {
       ...
       /* $compro = DB::tABLE('cpe_detalle')->get();
        ...
        ->where('motivo_transferencia','PRODUCCION')
        ...
        ->paginate(10000);
          ...
          return view('empresas.produccion.indexvalessalidas',compact('negocios','sucursal','comprobantes','fecin','fecfin','razsoc','documento'));
      ...
      public function indexvalesingresos(Request $request)
    {
       ...
       /* $compro = DB::tABLE('cpe_detalle')->get();
        ...
        ->paginate(10000);
          ...
          return view('empresas.produccion.indexvalesingresos',compact('negocios','sucursal','comprobantes','fecin','fecfin','razsoc','documento'));
...
*/
 ...
 public function eliminarpedido(Request $request,$pedido,$idmesa="0"){
   ...
   //   dd($detpdf);
    ...
    public function cobrarcotizacion($id){
      ...
      //  ->where('id_empresa_negocio',Auth::user()->id_empresa_negocio)
        ...
        public function editarvaleingresoproduccion($id){
    ...
    public function editarvalesalidaproduccion($id){
       ...
       // ->where('role_id','5')
        ...
        return view('empresas.produccion.editarvalesalidaproduccion',compact('gastos','tipodocumento','creditos','documentos','almacen','cabecera','detalle','datos','almacenes','vendedores','clientes','mediospagos','unidades','datos','empresa','senudoc','rucemp','motivos','modalidades','docidentidad','marcas','modelos','tecnicos','combustible','comprobante','monedas'));
  ...
  public function actualizarvalesalidaproduccion(Request $request)
    {
   ...
   //        $detalle->icbper = $codpro->icbper;
      ...
      public function actualizarvaleingresoproduccion(Request $request)
    {
