...
class ServiciosController extends Controller
{
      ...
      public function __construct()
    {
        ...
        return  view('empresas.servicios.historial',compact('detalle','producto'));
    ...
    public function actualizarpro(Request $request, $tipo){
       ...
       if($tipo=='venta'){
         $vista = view('empresas.servicios.actualizarpro')->render();
       }elseif($tipo=='compra'){
        $vista = view('empresas.servicios.actualizarprocompra')->render();
       }
    ...
    public function index(Request $request)
    {
      ...
      $data_suc = DB::tABLE('empresa_negocios')->where('id_empresa_negocio',$sucursal)->first();
        ...
        return view('empresas.servicios.index',compact('productos','buspro','categorias','tipos_productos','tipos','subcategorias','subcategoria','tip_pro_id','categoria','sucursales','sucursal','data_suc'));
      ...
      return view('empresas.servicios.recetas',compact('insumos','prod_id','producto','receta'));
    ...
    public function asignarcombo($prod_id){
      ...
      return view('empresas.servicios.combos',compact('insumos','prod_id','producto','combos'));
  ...
  public function actualizarproductostock(){
    ...
    public function create()
    {
        ...
        return view('empresas.servicios.create',compact('modelos','programas','unidades','categorias','monedas','proveedores','tipoigv','subcategorias','tipos','servicios','marcas','laboratorios'));
     ...
     public function busquedaproductocomanda(Request $request, $valor){
        ...
        $vista = view('empresas.servicios.menucomanda',compact('productos','unidades'))->render();
   ...
   public function store(Request $request)
    ...
    public function buscarcategorias($producto,Request $request){
        ...
        $vista = view('empresas.servicios.divcategorias',compact('categorias'))->render();
     ...
     public function buscarsubcategorias($producto,Request $request){
        ...
        $vista = view('empresas.servicios.divsubcategorias',compact('subcategorias'))->render();
    ...
    public function buscartipos($producto,Request $request){
        ...
        $vista = view('empresas.servicios.divtipos',compact('tipos'))->render();
    ...
    public function edit($id,$sucursal)
    {
        ...
        return view('empresas.servicios.edit',compact('modelos','productos','unidades','categorias','monedas','tipoigv','codigos','presentaciones','subcategorias','tipos','sucursal','servicios','marcas','programas','laboratorios'));
    }
    ...
    public function presentaciones($id){
       ...
       $rucemp = trim(Auth::user()->IdEmpresa);
        ...
        return view('empresas.servicios.presentaciones',compact('productos','unidades','categorias','monedas','tipoigv','codigos','presentaciones','id'));
  ...
  //----------------------------------------CONSULTAS PARA PUNTO DE VENTA-------------------------------------------->
   ...
   public function consultarmenu(Request $request, $cat_id){
      ...
      $contar = count($productos);
        ...
        $vista = view('empresas.servicios.menu',compact('productos','unidades','sucursal'))->render();
...
//------------------------------------------consultar productos compra --------------------------//
     ...
     public function consultarmenucompra(Request $request, $cat_id,$sucursal,$almacen){
        ...
        $vista = view('empresas.servicios.menucompra',compact('productos','unidades'))->render();
...
//------------------------------------------consultar productos inventarios --------------------------//
    ...
    public function presentacionesproductoinventario(Request $request, $id, $sucursal,$almacen){
     ...
     public function consultarmenuinventario(Request $request, $cat_id,$sucursal,$almacen){
        ...
        $vista = view('empresas.servicios.menuinventario',compact('productos','unidades'))->render();
...
//---------------------------------------fin consultar inventarios-----------------------------//
    ...
    public function consultarmenualm(Request $request, $cat_id, $almacen,$sucursal){
       ...
       $rucemp = trim(Auth::user()->IdEmpresa);
        ...
        $vista = view('empresas.servicios.menualm',compact('productos','unidades'))->render();
     ...
     public function consultarmenucobrar(Request $request, $cat_id){
        ...
        $vista = view('empresas.servicios.menucobrar',compact('productos','unidades'))->render();
    ...
    {   
         ...
         ->leftjoin('marcas as mar','mar.mar_id','=','p.marca')
            ...
            return view('empresas.servicios.stockproducto',compact('productos','buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm'));
    ...
    public function actualizarinventario(Request $request){
     ...
     public function editarinventario($id){
        ...
        ->get();
          ...
          return view('empresas.servicios.inventarioseditar',compact('buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm','fecha','unidades','productoslista','id'));
    ...
    {   
         ...
         // $almacen = $request->get('almacen');
          ...
          if(empty($fecha)){
            ...
            return view('empresas.servicios.inventarios',compact('buspro','negocios','categorias','tipos_productos','categoria','tipo','sucursal','datos','almacenes','almacen','datosalm','fecha','productos'));
    ...
    public function ajustar_stock($id_almacen,$IdProducto){
        ...
        return view('empresas.servicios.ajustar_stock',compact('productos','almacen','sucursal'));
    ...
    public function consultarcategorias(Request $request){
        ...
        $vista = view('empresas.servicios.listacategorias',compact('categorias'))->render();
 ...
 public function calcular_stock(){
      ...
      /*---------------------------------------------RESTAURANTE------------------------------------------------------*/
         public function buscarcarta(Request $request, $id=0,$cat=0){
            ...
            $vista = view('empresas.servicios.items_productos',compact('productos'))->render();
