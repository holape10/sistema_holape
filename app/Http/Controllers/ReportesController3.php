...
class ReportesController extends Controller
{
 ...
 public function generararqueodiario(Request $request){
  ...
  public function kardex(Request $request){
    ...
    ->get();
      ...
      if($tipo=='2'){
            ...
            ini_set("pcre.backtrack_limit", "5000000");
             ...
             $pdf = PDF::loadView('formatos_reportes.kardexfisicopdf',compact('dat_alm','data_sucursal','movimientos','productos','negocios','almacenes','sucursal','almacen','data_sucursal','dat_alm','dat_emp','fecin','fecfin','productoslista','kardex','IdProducto','empresa'));
   ...
   //     return view('formatos_reportes.kardexfisicopdf',compact('dat_alm','data_sucursal','movimientos','productos','negocios','almacenes','sucursal','almacen','data_sucursal','dat_alm','dat_emp','fecin','fecfin','productoslista','kardex','IdProducto','empresa'));

        /* $view = \View::make('formatos_reportes.kardexfisicopdf',compact('dat_alm','data_sucursal','movimientos','productos','negocios','almacenes','sucursal','almacen','data_sucursal','dat_alm','dat_emp','fecin','fecfin','productoslista','IdProducto','empresa'));
 ...
 ini_set("pcre.backtrack_limit", "5000000");
             ...
             $pdf = PDF::loadView('formatos_reportes.kardexvalorizadopdf',compact('dat_alm','data_sucursal','movimientos','productos','negocios','almacenes','sucursal','almacen','data_sucursal','dat_alm','dat_emp','fecin','fecfin','productoslista','kardex','IdProducto','empresa'));
             return $pdf->stream('document.pdf');
       ...
       // return view('formatos_reportes.kardexvalorizadopdf',compact('dat_alm','data_sucursal','movimientos','productos','negocios','almacenes','sucursal','almacen','data_sucursal','dat_alm','dat_emp','fecin','fecfin','productoslista','kardex','IdProducto','empresa'));

         // $view = \View::make('formatos_reportes.kardexvalorizadopdf',compact('dat_alm','data_sucursal','movimientos','productos','negocios','almacenes','sucursal','almacen','data_sucursal','dat_alm','dat_emp','fecin','fecfin','productoslista','saldos_actuales','kardex','IdProducto','empresa'));
   ...
   public function generarkardexexcel(Request $request){
    ...
    ->get();
      ...
      if($tipo=='2'){
        ...
        Excel::create('kardex_fisico', function($excel) use ($dat_suc,$productos,$negocios,$almacenes,$sucursal,$almacen,$dat_alm,$dat_emp,$fecin,$fecfin,$productoslista,$IdProducto) {

                        $excel->sheet('kardex_fisico', function($sheet) use ($dat_suc,$productos,$negocios,$almacenes,$sucursal,$almacen,$dat_alm,$dat_emp,$fecin,$fecfin,$productoslista,$IdProducto) {

                       
                            
                                  $sheet->loadView('empresas.reportes.kardexfisicoexcel',compact('dat_alm','dat_suc','productos','negocios','almacenes','sucursal','almacen','dat_emp','fecin','fecfin','productoslista','IdProducto'));
        ...
        Excel::create('kardex_valorizado', function($excel) use ($dat_suc,$productos,$negocios,$almacenes,$sucursal,$almacen,$dat_alm,$dat_emp,$fecin,$fecfin,$productoslista,$IdProducto) {

                        $excel->sheet('kardex_valorizado', function($sheet) use ($dat_suc,$productos,$negocios,$almacenes,$sucursal,$almacen,$dat_alm,$dat_emp,$fecin,$fecfin,$productoslista,$IdProducto) {

                              
                                  $sheet->loadView('empresas.reportes.kardexvalorizadoexcel',compact('dat_alm','dat_suc','productos','negocios','almacenes','sucursal','almacen','dat_emp','fecin','fecfin','productoslista','IdProducto'));
 ...
 public function buscarkardex(Request $request){
    ...
    ->get();
      ...
      if($tipo=='2'){
         return view('empresas.reportes.kardexfisico',compact('dat_alm','dat_suc','movimientos','productos','negocios','almacenes','sucursal','almacen','dat_suc','dat_alm','dat_emp','fecin','fecfin','productoslista','saldos_actuales','kardex','IdProducto'));
      }elseif($tipo=='1'){
          return view('empresas.reportes.kardexvalorizado',compact('dat_alm','dat_suc','movimientos','productos','negocios','almacenes','sucursal','almacen','dat_suc','dat_alm','dat_emp','fecin','fecfin','productoslista','saldos_actuales','kardex','IdProducto'));
      }
