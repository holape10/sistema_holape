...
class ConsultarComprobantesController extends Controller
{
    /**
    ...
    public function index(Request $request){
        ...
        return view('empresas.listarcomprobantes');
    }
	...
	$empresas = DB::tABLE('empresa')->get();
        return view('empresas.listarcomprobantes',compact('empresas'));    
