...
class ProductoCreateFormRequest extends FormRequest
{
    /**
   ...
   public function authorize()
    ...
    public function rules()
    {
        ...
        return [
            ...
            'txt_procod'=>['required','max:20',Rule::unique('productos','procod')->where(function ($query) {
    ...
    {
        return [
            'txt_procod.required'=>'Código de producto es obligatorio',
